...
public final class CancellableContinuationKt {
    ...
    public static /* bridge */ /* synthetic */ Object suspendCancellableCoroutine$default(boolean z, Function1 function1, Continuation continuation, int i, Object obj) {
        ...
        i = new CancellableContinuationImpl(CoroutineIntrinsics.normalizeContinuation(continuation), true);
        if (!z) {
    ...
    @Nullable
    public static final <T> Object suspendCancellableCoroutine(boolean z, @NotNull Function1<? super CancellableContinuation<? super T>, Unit> function1, @NotNull Continuation<? super T> continuation) {
        Intrinsics.checkParameterIsNotNull(function1, "block");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
    ...
    @NotNull
    public static final DisposableHandle removeOnCancel(@NotNull CancellableContinuation<?> cancellableContinuation, @NotNull LockFreeLinkedListNode lockFreeLinkedListNode) {
