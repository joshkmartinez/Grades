...
public interface SelectBuilder<R> {
    ...
    <T> void onAwait(@NotNull Deferred<? extends T> deferred, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2);

    void onJoin(@NotNull Job job, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1);

    void onLock(@NotNull Mutex mutex, @Nullable Object obj, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1);

    <E> void onReceive(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Function2<? super E, ? super Continuation<? super R>, ? extends Object> function2);

    <E> void onReceiveOrNull(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Function2<? super E, ? super Continuation<? super R>, ? extends Object> function2);

    <E> void onSend(@NotNull SendChannel<? super E> sendChannel, E e, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1);

    void onTimeout(long j, @NotNull TimeUnit timeUnit, @NotNull Function1<? super Continuation<? super R>, ? extends Object> function1);
}
