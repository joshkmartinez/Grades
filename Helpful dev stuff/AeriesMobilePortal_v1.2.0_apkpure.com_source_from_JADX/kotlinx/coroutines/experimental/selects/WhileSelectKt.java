...
public final class WhileSelectKt {
    @Nullable
    public static final Object whileSelect(@NotNull Function1<? super SelectBuilder<? super Boolean>, Unit> function1, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(function1, "builder");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return new WhileSelectKt$whileSelect$1(function1, continuation).doResume(Unit.INSTANCE, null);
    }
}
