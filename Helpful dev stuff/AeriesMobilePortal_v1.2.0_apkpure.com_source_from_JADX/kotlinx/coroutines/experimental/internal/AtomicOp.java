...
public abstract class AtomicOp extends OpDescriptor {
    ...
    public static final class Companion {
        ...
        private final AtomicReferenceFieldUpdater<AtomicOp, Object> getCONSENSUS() {
    ...
    public abstract void complete(@Nullable Object obj, @Nullable Object obj2);

    @Nullable
    public abstract Object prepare();

    static {
        AtomicReferenceFieldUpdater newUpdater = AtomicReferenceFieldUpdater.newUpdater(AtomicOp.class, Object.class, "_consensus");
    ...
    public final boolean tryDecide(@Nullable Object obj) {
        if ((obj != Companion.getUNDECIDED() ? 1 : null) != null) {
