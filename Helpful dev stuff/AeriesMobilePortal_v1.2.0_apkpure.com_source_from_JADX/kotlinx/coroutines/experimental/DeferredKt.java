...
public final class DeferredKt {
    ...
    public static final <T> Deferred<T> async(@NotNull CoroutineContext coroutineContext, @NotNull CoroutineStart coroutineStart, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        lazyDeferredCoroutine.initParentJob((Job) coroutineContext.get(Job.Key));
    ...
    public static final <T> Deferred<T> async(@NotNull CoroutineContext coroutineContext, boolean z, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, "context");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        return async(coroutineContext, z ? CoroutineStart.DEFAULT : CoroutineStart.LAZY, (Function2) function2);
    }
    ...
    public static final <T> Deferred<T> defer(@NotNull CoroutineContext coroutineContext, @NotNull Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, "context");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        return async$default(coroutineContext, null, function2, 2, null);
    }
}
