...
public final class ExecutorsKt {
    ...
    public static final CoroutineDispatcher toCoroutineDispatcher(@NotNull Executor executor) {
        Intrinsics.checkParameterIsNotNull(executor, "$receiver");
        return new ExecutorCoroutineDispatcher(executor);
    }

    @NotNull
    public static final CoroutineDispatcher asCoroutineDispatcher(@NotNull Executor executor) {
        Intrinsics.checkParameterIsNotNull(executor, "$receiver");
        return new ExecutorCoroutineDispatcher(executor);
    }
}
