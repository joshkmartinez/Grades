...
public final class MutexKt {
    @Nullable
    public static final <T> Object withLock(@NotNull Mutex mutex, @NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        Intrinsics.checkParameterIsNotNull(mutex, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "action");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return new 1(mutex, function1, continuation).doResume(Unit.INSTANCE, null);
    }

    @Deprecated(message = "Use `withLock`", replaceWith = @ReplaceWith(expression = "withLock(action)", imports = {}))
    @Nullable
    public static final <T> Object withMutex(@NotNull Mutex mutex, @NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        Intrinsics.checkParameterIsNotNull(mutex, "$receiver");
        Intrinsics.checkParameterIsNotNull(function1, "action");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return new 1(mutex, function1, continuation).doResume(Unit.INSTANCE, null);
