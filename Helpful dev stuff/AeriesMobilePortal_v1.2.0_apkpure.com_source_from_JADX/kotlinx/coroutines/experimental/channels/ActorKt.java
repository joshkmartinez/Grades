...
public final class ActorKt {
    ...
    @NotNull
    public static final <E> ActorJob<E> actor(@NotNull CoroutineContext coroutineContext, int i, @NotNull CoroutineStart coroutineStart, @NotNull Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        i = Channel.Factory.invoke(i);
        if (coroutineStart.isLazy()) {
            lazyActorCoroutine = new LazyActorCoroutine(newCoroutineContext, i, function2);
        } else {
            lazyActorCoroutine = new ActorCoroutine(newCoroutineContext, i, true);
        }
        lazyActorCoroutine.initParentJob((Job) coroutineContext.get((CoroutineContext$Key) Job.Key));
