...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    protected void afterCompletion(@Nullable Object obj, int i) {
        ...
        JobSupport$CompletedExceptionally jobSupport$CompletedExceptionally = (JobSupport$CompletedExceptionally) obj;
        if (jobSupport$CompletedExceptionally != null) {
            th = jobSupport$CompletedExceptionally.cause;
        }
        if (getChannel().close(th) == null && th != null) {
