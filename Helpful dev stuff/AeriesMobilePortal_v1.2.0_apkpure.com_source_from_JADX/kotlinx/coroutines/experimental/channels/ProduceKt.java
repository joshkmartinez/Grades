...
public final class ProduceKt {
    ...
    @NotNull
    public static final <E> ProducerJob<E> produce(@NotNull CoroutineContext coroutineContext, int i, @NotNull Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        ...
        producerCoroutine.initParentJob((Job) coroutineContext.get((Key) Job.Key));
    ...
    @NotNull
    @Deprecated(message = "Renamed to `produce`", replaceWith = @ReplaceWith(expression = "produce(context, capacity, block)", imports = {}))
    public static final <E> ProducerJob<E> buildChannel(@NotNull CoroutineContext coroutineContext, int i, @NotNull Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> function2) {
        Intrinsics.checkParameterIsNotNull(coroutineContext, "context");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        return produce(coroutineContext, i, function2);
    }
