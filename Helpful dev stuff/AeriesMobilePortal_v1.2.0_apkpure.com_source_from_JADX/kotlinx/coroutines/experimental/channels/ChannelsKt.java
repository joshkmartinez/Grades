...
public final class ChannelsKt {
    ...
    @Nullable
    public static final <E> Object consumeEach(@NotNull BroadcastChannel<E> broadcastChannel, @NotNull Function2<? super E, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(broadcastChannel, "$receiver");
        Intrinsics.checkParameterIsNotNull(function2, "action");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return new ChannelsKt$consumeEach$2(broadcastChannel, function2, continuation).doResume(Unit.INSTANCE, null);
    }

    @Nullable
    public static final <E> Object consumeEach(@NotNull ReceiveChannel<? extends E> receiveChannel, @NotNull Function2<? super E, ? super Continuation<? super Unit>, ? extends Object> function2, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(receiveChannel, "$receiver");
        Intrinsics.checkParameterIsNotNull(function2, "action");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return new ChannelsKt$consumeEach$1(receiveChannel, function2, continuation).doResume(Unit.INSTANCE, null);
    }
}
