...
final class SelectAwaitOnCompletion<T, R> extends JobNode<DeferredCoroutine<T>> {
    ...
    public SelectAwaitOnCompletion(@NotNull DeferredCoroutine<T> deferredCoroutine, @NotNull SelectInstance<? super R> selectInstance, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
    ...
    public void invoke(@Nullable Throwable th) {
        DeferredCoroutine.selectAwaitCompletion$kotlinx_coroutines_core$default((DeferredCoroutine) this.job, this.select, this.block, null, 4, null);
    }

    @NotNull
    public String toString() {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("SelectAwaitOnCompletion[");
