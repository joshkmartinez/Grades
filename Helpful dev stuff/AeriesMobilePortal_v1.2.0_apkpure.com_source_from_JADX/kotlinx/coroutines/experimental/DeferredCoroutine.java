...
import kotlinx.coroutines.experimental.Deferred.DefaultImpls;
...
class DeferredCoroutine<T> extends AbstractCoroutine<T> implements Deferred<T> {
    ...
    public boolean isComputing() {
        return DefaultImpls.isComputing(this);
    }
    ...
    public Object await(@NotNull Continuation<? super T> continuation) {
        ...
        do {
            ...
            if (!(state instanceof Incomplete)) {
                if ((state instanceof JobSupport$CompletedExceptionally) == null) {
                    return state;
                }
    ...
    public <R> void registerSelectAwait(@NotNull SelectInstance<? super R> selectInstance, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
    ...
    public final <R> void selectAwaitCompletion$kotlinx_coroutines_core(@NotNull SelectInstance<? super R> selectInstance, @NotNull Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, @Nullable Object obj) {
        Intrinsics.checkParameterIsNotNull(selectInstance, "select");
        Intrinsics.checkParameterIsNotNull(function2, "block");
        if (!selectInstance.trySelect(null)) {
            return;
        ...
        if (obj instanceof JobSupport$CompletedExceptionally) {
            selectInstance.resumeSelectWithException(((JobSupport$CompletedExceptionally) obj).getException(), null);
        } else {
    ...
    public T getCompleted() {
        T state = getState();
        if ((!(state instanceof Incomplete) ? 1 : null) == null) {
    ...
    private final Object awaitSuspend(Continuation<? super T> continuation) {
        ...
        JobKt.disposeOnCompletion(cancellableContinuation, invokeOnCompletion(new C1101x996938ba(cancellableContinuation, this)));
