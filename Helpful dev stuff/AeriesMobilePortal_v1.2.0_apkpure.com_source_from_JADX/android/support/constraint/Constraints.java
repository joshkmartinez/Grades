    ...
    public static class LayoutParams extends android.support.constraint.ConstraintLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            while (i < attributeSet) {
                ...
                if (index == C0005R.styleable.ConstraintSet_android_alpha) {
                    this.alpha = context.getFloat(index, this.alpha);
                } else if (index == C0005R.styleable.ConstraintSet_android_elevation) {
                    this.elevation = context.getFloat(index, this.elevation);
                    this.applyElevation = true;
                } else if (index == C0005R.styleable.ConstraintSet_android_rotationX) {
                    this.rotationX = context.getFloat(index, this.rotationX);
                } else if (index == C0005R.styleable.ConstraintSet_android_rotationY) {
                    this.rotationY = context.getFloat(index, this.rotationY);
                } else if (index == C0005R.styleable.ConstraintSet_android_rotation) {
                    this.rotation = context.getFloat(index, this.rotation);
                } else if (index == C0005R.styleable.ConstraintSet_android_scaleX) {
                    this.scaleX = context.getFloat(index, this.scaleX);
                } else if (index == C0005R.styleable.ConstraintSet_android_scaleY) {
                    this.scaleY = context.getFloat(index, this.scaleY);
                } else if (index == C0005R.styleable.ConstraintSet_android_transformPivotX) {
                    this.transformPivotX = context.getFloat(index, this.transformPivotX);
                } else if (index == C0005R.styleable.ConstraintSet_android_transformPivotY) {
                    this.transformPivotY = context.getFloat(index, this.transformPivotY);
                } else if (index == C0005R.styleable.ConstraintSet_android_translationX) {
                    this.translationX = context.getFloat(index, this.translationX);
                } else if (index == C0005R.styleable.ConstraintSet_android_translationY) {
                    this.translationY = context.getFloat(index, this.translationY);
                } else if (index == C0005R.styleable.ConstraintSet_android_translationZ) {
