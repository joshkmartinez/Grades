...
public class ArrayRow implements Row {
    ...
    String toReadableString() {
                ...
                if (variableValue != 0.0f) {
                    ...
                    if (i == 0) {
                        if (variableValue < 0.0f) {
                            ...
                            stringBuilder.append("- ");
                            str = stringBuilder.toString();
                            variableValue *= Face.UNCOMPUTED_PROBABILITY;
                        }
        ...
        stringBuilder = new StringBuilder();
        stringBuilder.append(str);
        stringBuilder.append(IdManager.DEFAULT_VERSION_NAME);
    ...
    public ArrayRow createRowEquals(SolverVariable solverVariable, int i) {
        if (i < 0) {
            ...
            this.variables.put(solverVariable, Face.UNCOMPUTED_PROBABILITY);
        }
        return this;
    }
    ...
    public ArrayRow createRowEquals(SolverVariable solverVariable, SolverVariable solverVariable2, int i) {
        ...
        if (obj == null) {
            ...
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, Face.UNCOMPUTED_PROBABILITY);
        }
        return this;
    }
    ...
    public ArrayRow createRowGreaterThan(SolverVariable solverVariable, SolverVariable solverVariable2, SolverVariable solverVariable3, int i) {
        ...
        if (obj == null) {
            ...
            this.variables.put(solverVariable, 1.0f);
            this.variables.put(solverVariable2, Face.UNCOMPUTED_PROBABILITY);
            this.variables.put(solverVariable3, Face.UNCOMPUTED_PROBABILITY);
        }
        return this;
    }
    ...
    ArrayRow createRowCentering(SolverVariable solverVariable, SolverVariable solverVariable2, int i, float f, SolverVariable solverVariable3, SolverVariable solverVariable4, int i2) {
        ...
        if (f == 0.5f) {
            ...
            this.variables.put(solverVariable2, Face.UNCOMPUTED_PROBABILITY * f2);
            this.variables.put(solverVariable3, Face.UNCOMPUTED_PROBABILITY * f);
    ...
    void ensurePositiveConstant() {
        if (this.constantValue < 0.0f) {
            this.constantValue *= Face.UNCOMPUTED_PROBABILITY;
    ...
    void pivot(SolverVariable solverVariable) {
        if (this.variable != null) {
            this.variables.put(this.variable, Face.UNCOMPUTED_PROBABILITY);
            this.variable = null;
        }
        float remove = this.variables.remove(solverVariable, true) * Face.UNCOMPUTED_PROBABILITY;
        this.variable = solverVariable;
        if (remove != 1.0f) {
