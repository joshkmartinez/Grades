...
*/
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidget.mHorizontalResolution != 2) {
            ...
            applyConstraints(linearSystem, z, constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mLeft) : null, constraintWidget.mParent != null ? linearSystem2.createObjectVariable(constraintWidget.mParent.mRight) : null, constraintWidget.mListDimensionBehaviors[0], z11, constraintWidget.mLeft, constraintWidget.mRight, constraintWidget.mX, i, constraintWidget.mMinWidth, constraintWidget.mMaxDimension[0], constraintWidget.mHorizontalBiasPercent, z10, z4, constraintWidget.mMatchConstraintDefaultWidth, constraintWidget.mMatchConstraintMinWidth, constraintWidget.mMatchConstraintMaxWidth, constraintWidget.mMatchConstraintPercentWidth, isConnected);
        ...
        if (constraintWidget.mVerticalResolution != 2) {
            ...
            if (constraintWidget.mBaselineDistance <= 0) {
                ...
                if (constraintWidget.mBaseline.mTarget != null) {
                    ...
                    applyConstraints(linearSystem, z6, constraintWidget.mParent == null ? linearSystem3.createObjectVariable(constraintWidget.mParent.mTop) : null, constraintWidget.mParent == null ? linearSystem3.createObjectVariable(constraintWidget.mParent.mBottom) : null, constraintWidget.mListDimensionBehaviors[1], z11, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i6, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[1], constraintWidget.mVerticalBiasPercent, z4, z5, constraintWidget.mMatchConstraintDefaultHeight, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z12);
                    if (i3 != 0) {
                                ...
                                if (isConnected && r24) {
                                    if (obj3 == null) {
                                        ...
                                        if (obj4 == null) {
                                            ...
                                            linearSystem.addCentering(createObjectVariable, solverVariable3, constraintAnchor.getMargin(), f, solverVariable8, solverVariable4, constraintAnchor2.getMargin(), i16);
                                        } else {
                                            solverVariable10 = createObjectVariable;
                                        }
                                        if (obj6 == null) {
