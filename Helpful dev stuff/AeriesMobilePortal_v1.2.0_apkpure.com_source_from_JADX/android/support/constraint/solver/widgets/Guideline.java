...
public class Guideline extends ConstraintWidget {
    ...
    protected float mRelativePercent = Face.UNCOMPUTED_PROBABILITY;
    ...
    public int getRelativeBehaviour() {
        if (this.mRelativePercent != Face.UNCOMPUTED_PROBABILITY) {
            return 0;
        }
    ...
    public void setGuidePercent(float f) {
        if (f > Face.UNCOMPUTED_PROBABILITY) {
    ...
    public void setGuideBegin(int i) {
        if (i > -1) {
            this.mRelativePercent = Face.UNCOMPUTED_PROBABILITY;
    ...
    public void analyze(int i) {
        ...
        if (i != 0) {
            ...
            if (getOrientation() == 1) {
                ...
                } else if (this.mRelativePercent != Face.UNCOMPUTED_PROBABILITY && i.getHorizontalDimensionBehaviour() == DimensionBehaviour.FIXED) {
                ...
                } else if (this.mRelativePercent != Face.UNCOMPUTED_PROBABILITY && i.getVerticalDimensionBehaviour() == DimensionBehaviour.FIXED) {
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidgetContainer != null) {
            ...
            } else if (this.mRelativePercent != Face.UNCOMPUTED_PROBABILITY) {
