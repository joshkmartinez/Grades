...
*/
            ...
            r9.widget = r3;
            r9.helped = r1;
            r3 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout;
        ...
        public void validate() {
            ...
            if (this.guidePercent != Face.UNCOMPUTED_PROBABILITY || this.guideBegin != -1 || this.guideEnd != -1) {
            ...
            if ((1 == getLayoutDirection() ? 1 : null) != null) {
                if (this.startToEnd != -1) {
                    ...
                    if (this.isGuideline && this.orientation == 1) {
                        if (this.guidePercent != Face.UNCOMPUTED_PROBABILITY) {
                            ...
                            this.resolvedGuideBegin = -1;
                            this.resolvedGuidePercent = Face.UNCOMPUTED_PROBABILITY;
...
*/
    ...
    L_0x0013:
        r1 = r7.getContext();
        r2 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout;
    ...
    L_0x0025:
        r4 = r8.getIndex(r3);
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_android_minWidth;
    ...
    L_0x002d:
        ...
        goto L_0x0087;
    L_0x0036:
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_android_minHeight;
    ...
    L_0x003a:
        ...
        goto L_0x0087;
    L_0x0043:
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_android_maxWidth;
    ...
    L_0x0047:
        ...
        goto L_0x0087;
    L_0x0050:
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_android_maxHeight;
    ...
    L_0x0054:
        ...
        goto L_0x0087;
    L_0x005d:
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_layout_optimizationLevel;
    ...
    L_0x0061:
        ...
        goto L_0x0087;
    L_0x006a:
        r5 = android.support.constraint.C0005R.styleable.ConstraintLayout_Layout_constraintSet;
...
*/
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == ErrorDialogData.SUPPRESSED && mode2 == ErrorDialogData.SUPPRESSED && size == r0.mLastMeasureWidth) {
        ...
        if (z && mode == Integer.MIN_VALUE && mode2 == ErrorDialogData.SUPPRESSED && size >= r0.mLastMeasureWidth) {
            i3 = r0.mLastMeasureHeight;
        }
        if (z && mode == ErrorDialogData.SUPPRESSED && mode2 == Integer.MIN_VALUE && size == r0.mLastMeasureWidth) {
                            ...
                            if (view.getVisibility() != 8) {
                                if (!z || !constraintWidget.getResolutionWidth().isResolved() || !constraintWidget.getResolutionHeight().isResolved()) {
                                    if (layoutParams.width == -2 && layoutParams.horizontalDimensionFixed) {
                                        ...
                                        size2 = MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), ErrorDialogData.SUPPRESSED);
                                    }
                                    if (layoutParams.height == -2 && layoutParams.verticalDimensionFixed) {
                                        i5 = getChildMeasureSpec(i6, size, layoutParams.height);
                                    } else {
                                        i5 = MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), ErrorDialogData.SUPPRESSED);
                                    }
