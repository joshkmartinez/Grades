...
public class Placeholder extends View {
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            attributeSet = getContext().obtainStyledAttributes(attributeSet, C0005R.styleable.ConstraintLayout_placeholder);
            int indexCount = attributeSet.getIndexCount();
            for (int i = 0; i < indexCount; i++) {
                int index = attributeSet.getIndex(i);
                if (index == C0005R.styleable.ConstraintLayout_placeholder_content) {
                    this.mContentId = attributeSet.getResourceId(index, this.mContentId);
                } else if (index == C0005R.styleable.ConstraintLayout_placeholder_emptyVisibility) {
