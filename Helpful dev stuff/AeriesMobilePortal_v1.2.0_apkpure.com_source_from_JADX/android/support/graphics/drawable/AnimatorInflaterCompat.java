...
public class AnimatorInflaterCompat {
    ...
    private static int inferValueTypeOfKeyframe(Resources resources, Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        ...
        attributeSet = null;
        theme = TypedArrayUtils.peekNamedValue(resources, xmlPullParser, Param.VALUE, 0);
    ...
    private static Keyframe loadKeyframe(Context context, Resources resources, Theme theme, AttributeSet attributeSet, int i, XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        resources = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, AndroidResources.STYLEABLE_KEYFRAME);
        theme = TypedArrayUtils.getNamedFloat(resources, xmlPullParser, "fraction", 3, Face.UNCOMPUTED_PROBABILITY);
        TypedValue peekNamedValue = TypedArrayUtils.peekNamedValue(resources, xmlPullParser, Param.VALUE, 0);
        ...
        if (i2 != 0) {
            if (i != 3) {
                switch (i) {
                    case 0:
                        theme = Keyframe.ofFloat(theme, TypedArrayUtils.getNamedFloat(resources, xmlPullParser, Param.VALUE, 0, 0));
                        break;
                    case 1:
                        break;
                    default:
            ...
            theme = Keyframe.ofInt(theme, TypedArrayUtils.getNamedInt(resources, xmlPullParser, Param.VALUE, 0, 0));
        } else if (i == 0) {
