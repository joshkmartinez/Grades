...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C02451();

    static class C02451 implements Comparator<Snake> {
        C02451() {
        }
    ...
    public static class DiffResult {
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f9x + snake.size;
                int i7 = snake.f10y + snake.size;
                int i8 = 4;
                if (z) {
                    for (i4--; i4 >= i6; i4--) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (i3--; i3 >= 0; i3--) {
                    if ((this.mOldItemStatuses[snake.f9x + i3] & 31) == 2) {
                        listUpdateCallback.onChanged(snake.f9x + i3, 1, this.mCallback.getChangePayload(snake.f9x + i3, snake.f10y + i3));
                    }
                }
                i = snake.f9x;
                i2 = snake.f10y;
