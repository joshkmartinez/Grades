...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public MainThreadCallback<T> getMainThreadProxy(final MainThreadCallback<T> mainThreadCallback) {
        return new MainThreadCallback<T>() {
            ...
            private Runnable mMainThreadRunnable = new C02461();
            ...
            class C02461 implements Runnable {
                ...
                public void run() {
                    SyncQueueItem next = C05881.this.mQueue.next();
                    while (next != null) {
                        switch (next.what) {
                            case 1:
    ...
    public BackgroundCallback<T> getBackgroundProxy(final BackgroundCallback<T> backgroundCallback) {
        return new BackgroundCallback<T>() {
            ...
            private Runnable mBackgroundRunnable = new C02471();
            ...
            class C02471 implements Runnable {
                ...
                public void run() {
                    while (true) {
                        SyncQueueItem next = C05892.this.mQueue.next();
                        if (next != null) {
                            switch (next.what) {
                                case 1:
                                    C05892.this.mQueue.removeMessages(1);
                                    backgroundCallback.refresh(next.arg1);
                                    break;
                                case 2:
                                    C05892.this.mQueue.removeMessages(2);
                                    C05892.this.mQueue.removeMessages(3);
                        ...
                        C05892.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
