...
import android.support.v7.recyclerview.C0244R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static final Interpolator sQuinticInterpolator = new C02843();
    ...
    static class C02843 implements Interpolator {
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C06071();
        ...
        private final Callback mVerticalBoundCheckCallback = new C06082();
        private int mWidth;
        ...
        class C06071 implements Callback {
            C06071() {
            }
        ...
        class C06082 implements Callback {
            C06082() {
            }
        ...
        public static int chooseSize(int i, int i2, int i3) {
            ...
            if (mode != Integer.MIN_VALUE) {
                return mode != ErrorDialogData.SUPPRESSED ? Math.max(i2, i3) : i;
            } else {
        ...
        public static int getChildMeasureSpec(int i, int i2, int i3, int i4, boolean z) {
            ...
            if (z) {
                if (i4 < 0) {
                    if (i4 == -1) {
                        if (i2 == Integer.MIN_VALUE || (i2 != 0 && i2 == ErrorDialogData.SUPPRESSED)) {
                            i4 = i;
                        } else {
                            i2 = 0;
                            i4 = i2;
                ...
                if (i4 == -1) {
                    ...
                    if (i4 == -2) {
                        if (i2 == Integer.MIN_VALUE || i2 == ErrorDialogData.SUPPRESSED) {
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0244R.styleable.RecyclerView, i, i2);
            properties.orientation = context.getInt(C0244R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = context.getInt(C0244R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = context.getBoolean(C0244R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = context.getBoolean(C0244R.styleable.RecyclerView_stackFromEnd, false);
            context.recycle();
            return properties;
        }
    ...
    class C06044 implements ProcessCallback {
        C06044() {
        }
    ...
    class C06055 implements Callback {
        C06055() {
        }
    ...
    class C06066 implements Callback {
        C06066() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02851();
        Parcelable mLayoutState;

        static class C02851 implements ClassLoaderCreator<SavedState> {
            C02851() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        this.mUpdateChildViewsRunnable = new C02821();
        ...
        this.mItemAnimatorRunner = new C02832();
        this.mViewInfoProcessCallback = new C06044();
        ...
        if (attributeSet != null) {
            obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0244R.styleable.RecyclerView, i, 0);
            String string = obtainStyledAttributes.getString(C0244R.styleable.RecyclerView_layoutManager);
            if (obtainStyledAttributes.getInt(C0244R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
                setDescendantFocusability(262144);
            }
            this.mEnableFastScroller = obtainStyledAttributes.getBoolean(C0244R.styleable.RecyclerView_fastScrollEnabled, false);
            if (this.mEnableFastScroller) {
                initFastScroller((StateListDrawable) obtainStyledAttributes.getDrawable(C0244R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), obtainStyledAttributes.getDrawable(C0244R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) obtainStyledAttributes.getDrawable(C0244R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), obtainStyledAttributes.getDrawable(C0244R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
            }
            obtainStyledAttributes.recycle();
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C06055());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C06066());
    }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        FastScroller fastScroller = new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0244R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0244R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0244R.dimen.fastscroll_margin));
    }
