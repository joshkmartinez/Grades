...
class AppCompatTextViewAutoSizeHelper {
    ...
    void loadFromAttributes(AttributeSet attributeSet, int i) {
        attributeSet = this.mContext.obtainStyledAttributes(attributeSet, C0242R.styleable.AppCompatTextView, i, 0);
        if (attributeSet.hasValue(C0242R.styleable.AppCompatTextView_autoSizeTextType) != 0) {
            this.mAutoSizeTextType = attributeSet.getInt(C0242R.styleable.AppCompatTextView_autoSizeTextType, 0);
        }
        i = attributeSet.hasValue(C0242R.styleable.AppCompatTextView_autoSizeStepGranularity) != 0 ? attributeSet.getDimension(C0242R.styleable.AppCompatTextView_autoSizeStepGranularity, -1.0f) : -1082130432;
        float dimension = attributeSet.hasValue(C0242R.styleable.AppCompatTextView_autoSizeMinTextSize) ? attributeSet.getDimension(C0242R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0f) : -1.0f;
        float dimension2 = attributeSet.hasValue(C0242R.styleable.AppCompatTextView_autoSizeMaxTextSize) ? attributeSet.getDimension(C0242R.styleable.AppCompatTextView_autoSizeMaxTextSize, -1.0f) : -1.0f;
        if (attributeSet.hasValue(C0242R.styleable.AppCompatTextView_autoSizePresetSizes)) {
            int resourceId = attributeSet.getResourceId(C0242R.styleable.AppCompatTextView_autoSizePresetSizes, 0);
            if (resourceId > 0) {
