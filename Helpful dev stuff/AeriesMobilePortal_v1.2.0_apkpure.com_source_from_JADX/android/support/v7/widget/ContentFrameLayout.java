    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode == Integer.MIN_VALUE) {
            ...
            if (!(typedValue2 == null || typedValue2.type == 0)) {
                ...
                if (dimension > 0) {
                    dimension = MeasureSpec.makeMeasureSpec(Math.min(dimension - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(i)), ErrorDialogData.SUPPRESSED);
                    i = 1;
                    if (mode2 == Integer.MIN_VALUE) {
                        ...
                        if (!(typedValue == null || typedValue.type == 0)) {
                            ...
                            if (mode2 > 0) {
                                i2 = MeasureSpec.makeMeasureSpec(Math.min(mode2 - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(i2)), ErrorDialogData.SUPPRESSED);
                            }
                        }
                    }
                    ...
                    if (i == 0 && mode == Integer.MIN_VALUE) {
                        ...
                        if (!(i == 0 || i.type == 0)) {
                            ...
                            if (mode2 < i) {
                                dimension = MeasureSpec.makeMeasureSpec(i, ErrorDialogData.SUPPRESSED);
                                if (obj == null) {
                                    super.onMeasure(dimension, i2);
                                }
                            }
