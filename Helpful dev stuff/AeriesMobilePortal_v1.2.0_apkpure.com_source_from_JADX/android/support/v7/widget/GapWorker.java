...
final class GapWorker implements Runnable {
    ...
    static Comparator<Task> sTaskComparator = new C02771();
    long mFrameIntervalNs;
    long mPostTimeNs;
    ArrayList<RecyclerView> mRecyclerViews = new ArrayList();
    private ArrayList<Task> mTasks = new ArrayList();

    static class C02771 implements Comparator<Task> {
        C02771() {
        }
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        task = prefetchPositionWithDeadline(task.view, task.position, task.immediate ? LongCompanionObject.MAX_VALUE : j);
