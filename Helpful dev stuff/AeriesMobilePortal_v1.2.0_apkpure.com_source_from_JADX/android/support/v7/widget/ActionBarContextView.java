...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0242R.attr.actionModeStyle);
    }

    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0242R.styleable.ActionMode, i, 0);
        ViewCompat.setBackground(this, context.getDrawable(C0242R.styleable.ActionMode_background));
        this.mTitleStyleRes = context.getResourceId(C0242R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = context.getResourceId(C0242R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = context.getLayoutDimension(C0242R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = context.getResourceId(C0242R.styleable.ActionMode_closeItemLayout, C0242R.layout.abc_action_mode_close_item_material);
        context.recycle();
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            LayoutInflater.from(getContext()).inflate(C0242R.layout.abc_action_bar_title_item, this);
            this.mTitleLayout = (LinearLayout) getChildAt(getChildCount() - 1);
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0242R.id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0242R.id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0242R.id.action_mode_close_button).setOnClickListener(new OnClickListener() {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != ErrorDialogData.SUPPRESSED) {
            ...
            if (this.mCustomView != null) {
                ...
                i4 = layoutParams.width != -2 ? ErrorDialogData.SUPPRESSED : Integer.MIN_VALUE;
            ...
            if (this.mContentHeight <= 0) {
                ...
                i3 = 0;
                while (i6 < i2) {
                    paddingLeft = getChildAt(i6).getMeasuredHeight() + mode;
                    if (paddingLeft > i3) {
                        i3 = paddingLeft;
                    }
                    i6++;
