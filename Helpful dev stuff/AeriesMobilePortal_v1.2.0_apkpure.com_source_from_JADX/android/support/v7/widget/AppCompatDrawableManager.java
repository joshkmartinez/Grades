...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = new int[]{C0242R.drawable.abc_popup_background_mtrl_mult, C0242R.drawable.abc_cab_background_internal_bg, C0242R.drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = new int[]{C0242R.drawable.abc_textfield_activated_mtrl_alpha, C0242R.drawable.abc_textfield_search_activated_mtrl_alpha, C0242R.drawable.abc_cab_background_top_mtrl_alpha, C0242R.drawable.abc_text_cursor_material, C0242R.drawable.abc_text_select_handle_left_mtrl_dark, C0242R.drawable.abc_text_select_handle_middle_mtrl_dark, C0242R.drawable.abc_text_select_handle_right_mtrl_dark, C0242R.drawable.abc_text_select_handle_left_mtrl_light, C0242R.drawable.abc_text_select_handle_middle_mtrl_light, C0242R.drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = new int[]{C0242R.drawable.abc_textfield_search_default_mtrl_alpha, C0242R.drawable.abc_textfield_default_mtrl_alpha, C0242R.drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = new int[]{C0242R.drawable.abc_btn_check_material, C0242R.drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = new int[]{C0242R.drawable.abc_ic_commit_search_api_mtrl_alpha, C0242R.drawable.abc_seekbar_tick_mark_material, C0242R.drawable.abc_ic_menu_share_mtrl_alpha, C0242R.drawable.abc_ic_menu_copy_mtrl_am_alpha, C0242R.drawable.abc_ic_menu_cut_mtrl_alpha, C0242R.drawable.abc_ic_menu_selectall_mtrl_alpha, C0242R.drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = new int[]{C0242R.drawable.abc_tab_indicator_material, C0242R.drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(@NonNull Context context, @DrawableRes int i) {
        ...
        if (i == C0242R.drawable.abc_cab_background_top_material) {
            cachedDrawable = new LayerDrawable(new Drawable[]{getDrawable(context, C0242R.drawable.abc_cab_background_internal_bg), getDrawable(context, C0242R.drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (cachedDrawable != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable;
        } else if (i == C0242R.drawable.abc_seekbar_track_material) {
            r6 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else {
            if (!(i == C0242R.drawable.abc_ratingbar_material || i == C0242R.drawable.abc_ratingbar_indicator_material)) {
                if (i != C0242R.drawable.abc_ratingbar_small_material) {
            ...
            r6 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0242R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(r6.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        }
    }
    ...
    static boolean tintDrawableUsingColorFilter(@NonNull Context context, @DrawableRes int i, @NonNull Drawable drawable) {
        ...
        if (arrayContains(COLORFILTER_TINT_COLOR_CONTROL_NORMAL, i)) {
            i2 = C0242R.attr.colorControlNormal;
        } else if (arrayContains(COLORFILTER_COLOR_CONTROL_ACTIVATED, i)) {
            i2 = C0242R.attr.colorControlActivated;
        } else if (arrayContains(COLORFILTER_COLOR_BACKGROUND_MULTIPLY, i)) {
            mode = Mode.MULTIPLY;
        } else if (i == C0242R.drawable.abc_list_divider_mtrl_alpha) {
            i2 = 16842800;
            ...
            return true;
        } else if (i != C0242R.drawable.abc_dialog_material_background) {
            round = -1;
            i = 0;
            i2 = i;
            if (i != 0) {
    ...
    static Mode getTintMode(int i) {
        return i == C0242R.drawable.abc_switch_thumb_material ? Mode.MULTIPLY : 0;
    }
    ...
    ColorStateList getTintList(@NonNull Context context, @DrawableRes int i) {
        ...
        if (tintListFromCache == null) {
            if (i == C0242R.drawable.abc_edit_text_material) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_edittext);
            } else if (i == C0242R.drawable.abc_switch_track_mtrl_alpha) {
                tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_switch_track);
            } else if (i == C0242R.drawable.abc_switch_thumb_material) {
                tintListFromCache = createSwitchThumbColorStateList(context);
            } else if (i == C0242R.drawable.abc_btn_default_mtrl_shape) {
                tintListFromCache = createDefaultButtonColorStateList(context);
            } else if (i == C0242R.drawable.abc_btn_borderless_material) {
                tintListFromCache = createBorderlessButtonColorStateList(context);
            } else if (i == C0242R.drawable.abc_btn_colored_material) {
                tintListFromCache = createColoredButtonColorStateList(context);
            } else {
                if (i != C0242R.drawable.abc_spinner_mtrl_am_alpha) {
                    if (i != C0242R.drawable.abc_spinner_textfield_background_material) {
                        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, i)) {
                            tintListFromCache = ThemeUtils.getThemeAttrColorStateList(context, C0242R.attr.colorControlNormal);
                        } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, i)) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_default);
                        } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, i)) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_btn_checkable);
                        } else if (i == C0242R.drawable.abc_seekbar_thumb_material) {
                            tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_seek_thumb);
                        }
                    }
                }
                tintListFromCache = AppCompatResources.getColorStateList(context, C0242R.color.abc_tint_spinner);
            }
            if (tintListFromCache != null) {
    ...
    private ColorStateList createDefaultButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorButtonNormal));
    }
    ...
    private ColorStateList createColoredButtonColorStateList(@NonNull Context context) {
        return createButtonColorStateList(context, ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorAccent));
    }

    private ColorStateList createButtonColorStateList(@NonNull Context context, @ColorInt int i) {
        r1 = new int[4][];
        r0 = new int[4];
        int themeAttrColor = ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlHighlight);
        context = ThemeUtils.getDisabledThemeAttrColor(context, C0242R.attr.colorButtonNormal);
    ...
    private ColorStateList createSwitchThumbColorStateList(Context context) {
        int[][] iArr = new int[3][];
        int[] iArr2 = new int[3];
        ColorStateList themeAttrColorStateList = ThemeUtils.getThemeAttrColorStateList(context, C0242R.attr.colorSwitchThumbNormal);
        if (themeAttrColorStateList == null || !themeAttrColorStateList.isStateful()) {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
            iArr2[0] = ThemeUtils.getDisabledThemeAttrColor(context, C0242R.attr.colorSwitchThumbNormal);
            iArr[1] = ThemeUtils.CHECKED_STATE_SET;
            iArr2[1] = ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorControlActivated);
            iArr[2] = ThemeUtils.EMPTY_STATE_SET;
            iArr2[2] = ThemeUtils.getThemeAttrColor(context, C0242R.attr.colorSwitchThumbNormal);
        } else {
            iArr[0] = ThemeUtils.DISABLED_STATE_SET;
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            context = getDrawable(context, C0242R.drawable.abc_vector_test);
