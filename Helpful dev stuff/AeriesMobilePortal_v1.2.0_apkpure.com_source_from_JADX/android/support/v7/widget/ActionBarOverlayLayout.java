...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0242R.attr.actionBarSize, 16842841};
    ...
    class C02561 extends AnimatorListenerAdapter {
        C02561() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mTopAnimatorListener = new C02561();
        this.mRemoveActionBarHideOffset = new C02572();
        this.mAddActionBarHideOffset = new C02583();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0242R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0242R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0242R.id.action_bar));
        }
    }
