    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0242R.id.topPanel) {
                    view = childAt;
                } else if (id == C0242R.id.buttonPanel) {
                    view2 = childAt;
                } else {
                    if (id != C0242R.id.contentPanel) {
                        if (id != C0242R.id.customPanel) {
                            return false;
                        }
                    }
                    if (view3 != null) {
        ...
        if (view2 != null) {
            ...
            view2.measure(i5, MeasureSpec.makeMeasureSpec(resolveMinimumHeight, ErrorDialogData.SUPPRESSED));
