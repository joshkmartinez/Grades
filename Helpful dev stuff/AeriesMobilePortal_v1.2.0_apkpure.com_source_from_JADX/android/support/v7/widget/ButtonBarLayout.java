...
public class ButtonBarLayout extends LinearLayout {
    ...
    public ButtonBarLayout(Context context, AttributeSet attributeSet) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0242R.styleable.ButtonBarLayout);
        this.mAllowStacking = context.getBoolean(C0242R.styleable.ButtonBarLayout_allowStacking, z);
        context.recycle();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (isStacked() || MeasureSpec.getMode(i) != ErrorDialogData.SUPPRESSED) {
            size = i;
            z = false;
        } else {
    ...
    private void setStacked(boolean z) {
        setOrientation(z);
        setGravity(z ? 5 : 80);
        View findViewById = findViewById(C0242R.id.spacer);
