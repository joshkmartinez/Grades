...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public TabView(Context context, Tab tab, boolean z) {
            super(context, null, C0242R.attr.actionBarTabStyle);
            this.mTab = tab;
            ScrollingTabContainerView obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, this.BG_ATTRS, C0242R.attr.actionBarTabStyle, 0);
        ...
        public void update() {
            ...
            if (isEmpty != 0) {
                if (this.mTextView == null) {
                    View appCompatTextView = new AppCompatTextView(getContext(), null, C0242R.attr.actionBarTabTextStyle);
    ...
    public void onMeasure(int i, int i2) {
        ...
        int i3 = 1;
        boolean z = i2 == ErrorDialogData.SUPPRESSED;
        setFillViewport(z);
        int childCount = this.mTabLayout.getChildCount();
        if (childCount <= 1 || !(i2 == ErrorDialogData.SUPPRESSED || i2 == Integer.MIN_VALUE)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
        ...
        i2 = MeasureSpec.makeMeasureSpec(this.mContentHeight, ErrorDialogData.SUPPRESSED);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, C0242R.attr.actionBarTabBarStyle);
    ...
    private Spinner createSpinner() {
        Spinner appCompatSpinner = new AppCompatSpinner(getContext(), null, C0242R.attr.actionDropDownStyle);
