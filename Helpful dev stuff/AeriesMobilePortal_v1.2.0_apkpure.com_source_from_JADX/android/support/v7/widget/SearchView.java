...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02893 implements OnFocusChangeListener {
        C02893() {
        }
    ...
    class C02904 implements OnLayoutChangeListener {
        C02904() {
        }
    ...
    class C02915 implements OnClickListener {
        C02915() {
        }
    ...
    class C02926 implements OnKeyListener {
        C02926() {
        }
    ...
    class C02937 implements OnEditorActionListener {
        C02937() {
        }
    ...
    class C02948 implements OnItemClickListener {
        C02948() {
        }
    ...
    class C02959 implements OnItemSelectedListener {
...
*/
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C02961();
        boolean isIconified;

        static class C02961 implements ClassLoaderCreator<SavedState> {
            C02961() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet) {
            this(context, attributeSet, C0242R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attributeSet, int i) {
            super(context, attributeSet, i);
            this.mRunShowSoftInputIfNecessary = new C02971();
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i < SettingsJsonConstants.ANALYTICS_FLUSH_INTERVAL_SECS_DEFAULT) {
                if (i < DimensionsKt.XXXHDPI || i2 < DimensionsKt.XXHDPI) {
    ...
    public SearchView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0242R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mUpdateDrawableStateRunnable = new C02871();
        this.mReleaseCursorRunnable = new C02882();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02915();
        this.mTextKeyListener = new C02926();
        this.mOnEditorActionListener = new C02937();
        this.mOnItemClickListener = new C02948();
        this.mOnItemSelectedListener = new C02959();
        ...
        attributeSet = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0242R.styleable.SearchView, i, 0);
        LayoutInflater.from(context).inflate(attributeSet.getResourceId(C0242R.styleable.SearchView_layout, C0242R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0242R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0242R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0242R.id.search_plate);
        this.mSubmitArea = findViewById(C0242R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0242R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0242R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0242R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0242R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0242R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, attributeSet.getDrawable(C0242R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, attributeSet.getDrawable(C0242R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(attributeSet.getDrawable(C0242R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(attributeSet.getDrawable(C0242R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(attributeSet.getDrawable(C0242R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(attributeSet.getDrawable(C0242R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(attributeSet.getDrawable(C0242R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = attributeSet.getDrawable(C0242R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0242R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = attributeSet.getResourceId(C0242R.styleable.SearchView_suggestionRowLayout, C0242R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = attributeSet.getResourceId(C0242R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02893());
        setIconifiedByDefault(attributeSet.getBoolean(C0242R.styleable.SearchView_iconifiedByDefault, true));
        context = attributeSet.getDimensionPixelSize(C0242R.styleable.SearchView_android_maxWidth, -1);
        if (context != -1) {
            setMaxWidth(context);
        }
        this.mDefaultQueryHint = attributeSet.getText(C0242R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = attributeSet.getText(C0242R.styleable.SearchView_queryHint);
        context = attributeSet.getInt(C0242R.styleable.SearchView_android_imeOptions, -1);
        if (context != -1) {
            setImeOptions(context);
        }
        context = attributeSet.getInt(C0242R.styleable.SearchView_android_inputType, -1);
        if (context != -1) {
            setInputType(context);
        }
        setFocusable(attributeSet.getBoolean(C0242R.styleable.SearchView_android_focusable, true));
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C02904());
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(i, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(i2, ErrorDialogData.SUPPRESSED));
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0242R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0242R.dimen.abc_search_view_preferred_height);
    }
...
*/
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int dimensionPixelSize = this.mIconifiedByDefault ? resources.getDimensionPixelSize(C0242R.dimen.abc_dropdownitem_icon_width) + resources.getDimensionPixelSize(C0242R.dimen.abc_dropdownitem_text_padding_left) : 0;
