...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C02601 extends DataSetObserver {
        C02601() {
        }
    ...
    class C02623 extends AccessibilityDelegate {
        C02623() {
        }
    ...
    class C02635 extends DataSetObserver {
        C02635() {
        }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            switch (getItemViewType(i)) {
                case 0:
                    if (view == null || view.getId() != C0242R.id.list_item) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0242R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                    }
                    viewGroup = ActivityChooserView.this.getContext().getPackageManager();
                    ResolveInfo resolveInfo = (ResolveInfo) getItem(i);
                    ((ImageView) view.findViewById(C0242R.id.icon)).setImageDrawable(resolveInfo.loadIcon(viewGroup));
                    ((TextView) view.findViewById(C0242R.id.title)).setText(resolveInfo.loadLabel(viewGroup));
                ...
                case 1:
                    if (view == null || view.getId() != 1) {
                        view = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0242R.layout.abc_activity_chooser_view_list_item, viewGroup, false);
                        view.setId(1);
                        ((TextView) view.findViewById(C0242R.id.title)).setText(ActivityChooserView.this.getContext().getString(C0242R.string.abc_activity_chooser_view_see_all));
                    }
                    return view;
                default:
                    throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mModelDataSetObserver = new C02601();
        this.mOnGlobalLayoutListener = new C02612();
        this.mInitialActivityCount = 4;
        attributeSet = context.obtainStyledAttributes(attributeSet, C0242R.styleable.ActivityChooserView, i, 0);
        this.mInitialActivityCount = attributeSet.getInt(C0242R.styleable.ActivityChooserView_initialActivityCount, 4);
        i = attributeSet.getDrawable(C0242R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        attributeSet.recycle();
        LayoutInflater.from(getContext()).inflate(C0242R.layout.abc_activity_chooser_view, this, true);
        this.mCallbacks = new Callbacks();
        this.mActivityChooserContent = (LinearLayoutCompat) findViewById(C0242R.id.activity_chooser_view_content);
        this.mActivityChooserContentBackground = this.mActivityChooserContent.getBackground();
        this.mDefaultActivityButton = (FrameLayout) findViewById(C0242R.id.default_activity_button);
        this.mDefaultActivityButton.setOnClickListener(this.mCallbacks);
        this.mDefaultActivityButton.setOnLongClickListener(this.mCallbacks);
        this.mDefaultActivityButtonImage = (ImageView) this.mDefaultActivityButton.findViewById(C0242R.id.image);
        FrameLayout frameLayout = (FrameLayout) findViewById(C0242R.id.expand_activities_button);
        frameLayout.setOnClickListener(this.mCallbacks);
        frameLayout.setAccessibilityDelegate(new C02623());
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) frameLayout.findViewById(C0242R.id.image);
        this.mExpandActivityOverflowButtonImage.setImageDrawable(i);
        this.mAdapter = new ActivityChooserViewAdapter();
        this.mAdapter.registerDataSetObserver(new C02635());
        context = context.getResources();
        this.mListPopupMaxWidth = Math.max(context.getDisplayMetrics().widthPixels / 2, context.getDimensionPixelSize(C0242R.dimen.abc_config_prefDialogWidth));
    }
            ...
            if (!i.isShowing()) {
                if (!this.mIsSelectingDefaultActivity) {
                    if (z) {
                        ...
                        i.getListView().setContentDescription(getContext().getString(C0242R.string.abc_activitychooserview_choose_application));
