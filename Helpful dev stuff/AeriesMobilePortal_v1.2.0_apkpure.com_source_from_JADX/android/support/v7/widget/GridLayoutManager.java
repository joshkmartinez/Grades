...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        boolean z = modeInOther != ErrorDialogData.SUPPRESSED;
        ...
        float f = 0.0f;
        int i6 = i4;
        assignSpans(recycler, state, i4, i3, z2);
        int i7 = 0;
        for (i2 = 0; i2 < i6; i2++) {
            boolean z3;
        ...
        for (i2 = 0; i2 < i6; i2++) {
            ...
            if (r6.mOrientationHelper.getDecoratedMeasurement(view) != i7) {
                ...
                if (r6.mOrientation == 1) {
                    i5 = LayoutManager.getChildMeasureSpec(i3, ErrorDialogData.SUPPRESSED, modeInOther, layoutParams.width, false);
                    i3 = MeasureSpec.makeMeasureSpec(i7 - i4, ErrorDialogData.SUPPRESSED);
                    modeInOther = i5;
                } else {
                    modeInOther = MeasureSpec.makeMeasureSpec(i7 - modeInOther, ErrorDialogData.SUPPRESSED);
                    i3 = LayoutManager.getChildMeasureSpec(i3, ErrorDialogData.SUPPRESSED, i4, layoutParams.height, false);
                }
