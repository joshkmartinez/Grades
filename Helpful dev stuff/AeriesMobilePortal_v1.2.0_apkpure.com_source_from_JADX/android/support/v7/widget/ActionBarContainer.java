...
public class ActionBarContainer extends FrameLayout {
    ...
    L_0x0014:
        ...
        r0 = android.support.v7.appcompat.C0242R.styleable.ActionBar;
        r3 = r3.obtainStyledAttributes(r4, r0);
        r4 = android.support.v7.appcompat.C0242R.styleable.ActionBar_background;
        r4 = r3.getDrawable(r4);
        r2.mBackground = r4;
        r4 = android.support.v7.appcompat.C0242R.styleable.ActionBar_backgroundStacked;
        r4 = r3.getDrawable(r4);
        r2.mStackedBackground = r4;
        r4 = android.support.v7.appcompat.C0242R.styleable.ActionBar_height;
        r0 = -1;
        r4 = r3.getDimensionPixelSize(r4, r0);
        r2.mHeight = r4;
        r4 = r2.getId();
        r0 = android.support.v7.appcompat.C0242R.id.split_action_bar;
        r1 = 1;
        if (r4 != r0) goto L_0x0049;
    L_0x003f:
        r2.mIsSplit = r1;
        r4 = android.support.v7.appcompat.C0242R.styleable.ActionBar_backgroundSplit;
        r4 = r3.getDrawable(r4);
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0242R.id.action_bar);
        this.mContextView = findViewById(C0242R.id.action_context_bar);
    }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mActionBarView != 0) {
            ...
            if (!(this.mTabContainer == null || this.mTabContainer.getVisibility() == 8 || i == ErrorDialogData.SUPPRESSED)) {
