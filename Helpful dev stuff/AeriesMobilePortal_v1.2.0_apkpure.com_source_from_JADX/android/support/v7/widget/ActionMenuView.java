...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mFormatItems = MeasureSpec.getMode(i) == ErrorDialogData.SUPPRESSED;
    ...
    private void onMeasureExactFormat(int i, int i2) {
        ...
        while (i15 > 0 && i10 > 0) {
            ...
            while (size < i3) {
                ...
                if ((j3 & j4) != 0) {
                    boolean z6;
                    if (obj == null || !layoutParams3.preventEdgeOffset) {
                        z6 = true;
                    } else {
                        z6 = true;
                        if (i10 == 1) {
                ...
                if (z2) {
                    while (size2 < size) {
                        ...
                        if (layoutParams4.expanded) {
                            ...
                            i3 = i6;
                            childAt.measure(MeasureSpec.makeMeasureSpec((layoutParams4.cellsUsed * i9) + layoutParams4.extraPixels, ErrorDialogData.SUPPRESSED), i3);
                        }
                        size2++;
                        i6 = i3;
                    }
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(MeasureSpec.makeMeasureSpec(i * i5, ErrorDialogData.SUPPRESSED), i3);
        return i5;
    }
