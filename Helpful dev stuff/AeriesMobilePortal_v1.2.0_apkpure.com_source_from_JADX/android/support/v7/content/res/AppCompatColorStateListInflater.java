        ...
        while (true) {
            ...
            if (next == 2 && depth2 <= depth) {
                if (xmlPullParser.getName().equals("item")) {
                    TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet2, C0242R.styleable.ColorStateListItem);
                    int color = obtainAttributes.getColor(C0242R.styleable.ColorStateListItem_android_color, -65281);
                    float f = 1.0f;
                    if (obtainAttributes.hasValue(C0242R.styleable.ColorStateListItem_android_alpha)) {
                        f = obtainAttributes.getFloat(C0242R.styleable.ColorStateListItem_android_alpha, 1.0f);
                    } else if (obtainAttributes.hasValue(C0242R.styleable.ColorStateListItem_alpha)) {
                        f = obtainAttributes.getFloat(C0242R.styleable.ColorStateListItem_alpha, 1.0f);
                    }
                    ...
                    while (i3 < next) {
                        ...
                        if (!(attributeNameResource == 16843173 || attributeNameResource == 16843551 || attributeNameResource == C0242R.attr.alpha)) {
                            i = i4 + 1;
