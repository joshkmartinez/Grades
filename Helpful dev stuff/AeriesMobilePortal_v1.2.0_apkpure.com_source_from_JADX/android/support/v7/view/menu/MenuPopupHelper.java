...
public class MenuPopupHelper implements MenuHelper {
    ...
    class C02511 implements OnDismissListener {
        C02511() {
        }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, C0242R.attr.popupMenuStyle, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view) {
        this(context, menuBuilder, view, false, C0242R.attr.popupMenuStyle, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z, @AttrRes int i, @StyleRes int i2) {
        ...
        this.mInternalOnDismissListener = new C02511();
    ...
    private MenuPopup createPopup() {
        ...
        if ((Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(C0242R.dimen.abc_cascading_menus_min_smallest_width) ? 1 : null) != null) {
