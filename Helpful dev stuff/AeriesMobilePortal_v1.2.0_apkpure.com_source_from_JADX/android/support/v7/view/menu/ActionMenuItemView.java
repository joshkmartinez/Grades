...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, OnClickListener, ActionMenuChildView {
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0242R.styleable.ActionMenuItemView, i, 0);
        this.mMinWidth = context.getDimensionPixelSize(C0242R.styleable.ActionMenuItemView_android_minWidth, 0);
        context.recycle();
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        if (i < DimensionsKt.XXHDPI && (i < DimensionsKt.XXXHDPI || i2 < DimensionsKt.XXHDPI)) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != ErrorDialogData.SUPPRESSED && this.mMinWidth > 0 && measuredWidth < i) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(i, ErrorDialogData.SUPPRESSED), i2);
        }
