...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C09551();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C09562();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05843();

    class C05843 implements ViewPropertyAnimatorUpdateListener {
        C05843() {
        }
    ...
    class C09551 extends ViewPropertyAnimatorListenerAdapter {
        C09551() {
        }
    ...
    class C09562 extends ViewPropertyAnimatorListenerAdapter {
        C09562() {
        }
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0242R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0242R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0242R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0242R.id.action_bar_container);
        ...
        if (!actionBarPolicy.enableHomeButtonByDefault()) {
            if (view == null) {
                ...
                view = this.mContext.obtainStyledAttributes(null, C0242R.styleable.ActionBar, C0242R.attr.actionBarStyle, 0);
                if (view.getBoolean(C0242R.styleable.ActionBar_hideOnContentScroll, false)) {
                    setHideOnContentScrollEnabled(true);
                }
                dimensionPixelSize = view.getDimensionPixelSize(C0242R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0242R.attr.actionBarWidgetTheme, typedValue, true);
