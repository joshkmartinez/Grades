...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new C02381();
    ...
    class C02395 implements Runnable {
        ...
        class C09521 extends ViewPropertyAnimatorListenerAdapter {
            C09521() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09521());
                return;
            }
            AppCompatDelegateImplV9.this.mActionModeView.setAlpha(1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = new C02401();
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C02401 implements ClassLoaderCreator<SavedState> {
                C02401() {
                }
        ...
        void setStyle(Context context) {
            ...
            newTheme.resolveAttribute(C0242R.attr.actionBarPopupTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            }
            newTheme.resolveAttribute(C0242R.attr.panelMenuListTheme, typedValue, true);
            if (typedValue.resourceId != 0) {
                newTheme.applyStyle(typedValue.resourceId, true);
            } else {
                newTheme.applyStyle(C0242R.style.Theme_AppCompat_CompactMenu, true);
            }
            Context contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(newTheme);
            this.listPresenterContext = contextThemeWrapper;
            context = contextThemeWrapper.obtainStyledAttributes(C0242R.styleable.AppCompatTheme);
            this.background = context.getResourceId(C0242R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = context.getResourceId(C0242R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
            context.recycle();
        }
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0242R.layout.abc_list_menu_item_layout);
    ...
    class C05802 implements OnApplyWindowInsetsListener {
        C05802() {
        }
    ...
    class C05813 implements OnFitSystemWindowsListener {
        C05813() {
        }
    ...
    class C05824 implements OnAttachListener {
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C09541 extends ViewPropertyAnimatorListenerAdapter {
            C09541() {
            }
        ...
        public void onDestroyActionMode(ActionMode actionMode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C09541());
            }
    ...
    class C09536 extends ViewPropertyAnimatorListenerAdapter {
        C09536() {
        }
    ...
    private ViewGroup createSubDecor() {
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0242R.styleable.AppCompatTheme);
        if (obtainStyledAttributes.hasValue(C0242R.styleable.AppCompatTheme_windowActionBar)) {
            View view;
            if (obtainStyledAttributes.getBoolean(C0242R.styleable.AppCompatTheme_windowNoTitle, false)) {
                requestWindowFeature(1);
            } else if (obtainStyledAttributes.getBoolean(C0242R.styleable.AppCompatTheme_windowActionBar, false)) {
                requestWindowFeature(108);
            }
            if (obtainStyledAttributes.getBoolean(C0242R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(109);
            }
            if (obtainStyledAttributes.getBoolean(C0242R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(10);
            }
            this.mIsFloating = obtainStyledAttributes.getBoolean(C0242R.styleable.AppCompatTheme_android_windowIsFloating, false);
            obtainStyledAttributes.recycle();
            this.mWindow.getDecorView();
            LayoutInflater from = LayoutInflater.from(this.mContext);
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    view = (ViewGroup) from.inflate(C0242R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    view = (ViewGroup) from.inflate(C0242R.layout.abc_screen_simple, null);
                }
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view, new C05802());
                } else {
                    ((FitWindowsViewGroup) view).setOnFitSystemWindowsListener(new C05813());
                }
            } else if (this.mIsFloating) {
                view = (ViewGroup) from.inflate(C0242R.layout.abc_dialog_title_material, null);
                this.mOverlayActionBar = false;
                this.mHasActionBar = false;
            } else if (this.mHasActionBar) {
                Context contextThemeWrapper;
                TypedValue typedValue = new TypedValue();
                this.mContext.getTheme().resolveAttribute(C0242R.attr.actionBarTheme, typedValue, true);
                if (typedValue.resourceId != 0) {
                    contextThemeWrapper = new ContextThemeWrapper(this.mContext, typedValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                view = (ViewGroup) LayoutInflater.from(contextThemeWrapper).inflate(C0242R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) view.findViewById(C0242R.id.decor_content_parent);
            ...
            if (view != null) {
                if (this.mDecorContentParent == null) {
                    this.mTitleView = (TextView) view.findViewById(C0242R.id.title);
                }
                ViewUtils.makeOptionalFitsSystemWindows(view);
                ContentFrameLayout contentFrameLayout = (ContentFrameLayout) view.findViewById(C0242R.id.action_bar_activity_content);
                ...
                contentFrameLayout.setAttachListener(new C05824());
                return view;
            }
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(C0242R.styleable.AppCompatTheme);
        obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (obtainStyledAttributes.hasValue(C0242R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (obtainStyledAttributes.hasValue(C0242R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (obtainStyledAttributes.hasValue(C0242R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (obtainStyledAttributes.hasValue(C0242R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            obtainStyledAttributes.getValue(C0242R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        obtainStyledAttributes.recycle();
...
*/
    ...
    L_0x0039:
        ...
        r4 = r7.mContext;
        r4 = r4.getTheme();
        r5 = android.support.v7.appcompat.C0242R.attr.actionBarTheme;
    ...
    L_0x0070:
        ...
        r6 = android.support.v7.appcompat.C0242R.attr.actionModePopupWindowStyle;
        r5.<init>(r4, r1, r6);
        ...
        r5.setWidth(r6);
        r5 = r4.getTheme();
        r6 = android.support.v7.appcompat.C0242R.attr.actionBarSize;
    ...
    L_0x00bd:
        r0 = r7.mSubDecor;
        r4 = android.support.v7.appcompat.C0242R.id.action_mode_bar_stub;
                            ...
                            if (panelFeatureState.refreshDecorView == null) {
                                if (panelFeatureState.createdPanelView != null) {
                                    ...
                                    if (keyEvent != null && keyEvent.width == -1) {
                                        ...
                                        layoutParams = new WindowManager.LayoutParams(i, -2, panelFeatureState.f7x, panelFeatureState.f8y, 1002, 8519680, -3);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((panelFeatureState.featureId == 0 || panelFeatureState.featureId == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0242R.attr.actionBarTheme, typedValue, true);
            Theme theme2 = null;
            if (typedValue.resourceId != 0) {
                theme2 = context.getResources().newTheme();
                theme2.setTo(theme);
                theme2.applyStyle(typedValue.resourceId, true);
                theme2.resolveAttribute(C0242R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0242R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
                if (theme2 == null) {
                    theme2 = context.getResources().newTheme();
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (this.mStatusGuard == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0242R.color.abc_input_method_navigation_guard));
