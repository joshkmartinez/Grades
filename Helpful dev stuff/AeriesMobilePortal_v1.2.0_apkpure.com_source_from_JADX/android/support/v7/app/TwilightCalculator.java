...
class TwilightCalculator {
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double d3 = (double) f2;
        double sin = (((((0.03341960161924362d * Math.sin(d3)) + d3) + (3.4906598739326E-4d * Math.sin((double) (2.0f * f2)))) + (5.236000106378924E-6d * Math.sin((double) (3.0f * f2)))) + 1.796593063d) + MathKt.PI;
        double d4 = (-d2) / 360.0d;
