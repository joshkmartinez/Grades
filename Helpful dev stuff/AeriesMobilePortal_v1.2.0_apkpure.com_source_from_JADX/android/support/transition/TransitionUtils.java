...
class TransitionUtils {
    ...
    static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(MeasureSpec.makeMeasureSpec(round2 - view2, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(round3 - round, ErrorDialogData.SUPPRESSED));
