...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    private final OnPreDrawListener mOnPreDrawListener = new C00751();
    int mReferences;
    ViewGroup mStartParent;
    View mStartView;
    final View mView;

    class C00751 implements OnPreDrawListener {
        C00751() {
        }
    ...
    private static void setGhostView(@NonNull View view, GhostViewApi14 ghostViewApi14) {
        view.setTag(C0079R.id.ghost_view, ghostViewApi14);
    }

    static GhostViewApi14 getGhostView(@NonNull View view) {
        return (GhostViewApi14) view.getTag(C0079R.id.ghost_view);
    }
}
