...
public abstract class Transition implements Cloneable {
    ...
    private static final PathMotion STRAIGHT_PATH_MOTION = new C05471();
    ...
    class C00813 extends AnimatorListenerAdapter {
        C00813() {
        }
    ...
    static class C05471 extends PathMotion {
        C05471() {
        }
    ...
    protected void animate(Animator animator) {
        ...
        animator.addListener(new C00813());
        animator.start();
    }
