...
public class ChangeTransform extends Transition {
    ...
    private static class GhostListener extends TransitionListenerAdapter {
        ...
        public void onTransitionEnd(@NonNull Transition transition) {
            ...
            this.mView.setTag(C0079R.id.transition_transform, null);
            this.mView.setTag(C0079R.id.parent_matrix, null);
        }
            ...
            if (matrix2 != null) {
                if (!matrix2.isIdentity()) {
                    ...
                    if (this.mReparent) {
                        ...
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_MATRIX, view.getTag(C0079R.id.transition_transform));
                        transitionValues.values.put(PROPNAME_INTERMEDIATE_PARENT_MATRIX, view.getTag(C0079R.id.parent_matrix));
                    }
                }
            }
            matrix = null;
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues transitionValues, TransitionValues transitionValues2, boolean z) {
        ...
        final boolean z2 = z;
        TransitionValues c00743 = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (this.mIsCanceled == null) {
                    if (z2 == null || ChangeTransform.this.mUseOverlay == null) {
                        view.setTag(C0079R.id.transition_transform, null);
                        view.setTag(C0079R.id.parent_matrix, null);
                    } else {
            ...
            private void setCurrentMatrix(Matrix matrix) {
                ...
                view.setTag(C0079R.id.transition_transform, this.mTempMatrix);
                transforms.restore(view);
            }
        };
        transitionValues.addListener(c00743);
        AnimatorUtils.addPauseListener(transitionValues, c00743);
    ...
    private void setMatricesForParent(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        transitionValues2.view.setTag(C0079R.id.parent_matrix, matrix);
