...
public class ChangeImageTransform extends Transition {
    ...
    private static final TypeEvaluator<Matrix> NULL_MATRIX_EVALUATOR = new C00691();
    ...
    static class C00691 implements TypeEvaluator<Matrix> {
...
*/
    ...
    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C00713.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
