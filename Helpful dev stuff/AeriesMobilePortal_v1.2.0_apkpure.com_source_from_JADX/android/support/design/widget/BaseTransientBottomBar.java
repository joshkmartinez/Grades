...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C05333();
    ...
    static class SnackbarBaseLayout extends FrameLayout {
        ...
        SnackbarBaseLayout(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.SnackbarLayout);
            if (context.hasValue(C0012R.styleable.SnackbarLayout_elevation) != null) {
                ViewCompat.setElevation(this, (float) context.getDimensionPixelSize(C0012R.styleable.SnackbarLayout_elevation, 0));
            }
            context.recycle();
            setClickable(true);
        }
    ...
    class C05322 implements OnApplyWindowInsetsListener {
        C05322() {
        }
    ...
    class C05333 implements Callback {
        C05333() {
        }
    ...
    class C05344 implements OnDismissListener {
        C05344() {
        }
    ...
    class C05355 implements OnAttachStateChangeListener {
    ...
    class C05366 implements OnLayoutChangeListener {
        C05366() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull ContentViewCallback contentViewCallback) {
        if (viewGroup == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C05322());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (layoutParams instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C05344());
                layoutParams2.setBehavior(behavior);
                layoutParams2.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C05355());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C05366());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 12) {
            ...
            valueAnimator.addListener(new C00227());
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0012R.anim.design_snackbar_in);
        loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        loadAnimation.setDuration(250);
        loadAnimation.setAnimationListener(new C00249());
    ...
    private void animateViewOut(final int i) {
        ...
        Animation loadAnimation = AnimationUtils.loadAnimation(this.mView.getContext(), C0012R.anim.design_snackbar_out);
        loadAnimation.setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        loadAnimation.setDuration(250);
