...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C05382();
    boolean mHideable;
    ...
    class C05382 extends Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (BottomSheetBehavior.this.mViewRef == 0 || BottomSheetBehavior.this.mViewRef.get() != view) {
                z = false;
            }
            return z;
        }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0012R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = attributeSet.peekValue(C0012R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(attributeSet.getDimensionPixelSize(C0012R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(attributeSet.getBoolean(C0012R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setSkipCollapsed(attributeSet.getBoolean(C0012R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.mPeekHeightAuto != 0) {
            if (this.mPeekHeightMin == 0) {
                this.mPeekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C0012R.dimen.design_bottom_sheet_peek_height_min);
            }
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout coordinatorLayout, V v, MotionEvent motionEvent) {
        ...
        if (v.isShown()) {
            ...
            if (actionMasked == 2 && view2 != null && !this.mIgnoreEvents && this.mState != 1 && coordinatorLayout.isPointInChildBounds(view2, (int) motionEvent.getX(), (int) motionEvent.getY()) == null && Math.abs(((float) this.mInitialY) - motionEvent.getY()) > ((float) this.mViewDragHelper.getTouchSlop())) {
                z = true;
            }
            return z;
        }
