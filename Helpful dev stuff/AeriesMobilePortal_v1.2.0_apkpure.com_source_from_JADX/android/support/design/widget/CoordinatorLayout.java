...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0012R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0012R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0012R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0012R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0012R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0012R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0012R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0012R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0012R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
    ...
    class C05431 implements OnApplyWindowInsetsListener {
        C05431() {
        }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0012R.styleable.CoordinatorLayout, i, C0012R.style.Widget_Design_CoordinatorLayout);
        int i2 = 0;
        i = attributeSet.getResourceId(C0012R.styleable.CoordinatorLayout_keylines, 0);
        if (i != 0) {
        ...
        this.mStatusBarBackground = attributeSet.getDrawable(C0012R.styleable.CoordinatorLayout_statusBarBackground);
    ...
    protected void onMeasure(int i, int i2) {
                ...
                if (layoutParams.keyline < 0 || mode == 0) {
                    ...
                    if ((i6 == 3 && obj == null) || (i6 == 5 && obj != null)) {
                        ...
                        if (behavior != null) {
                            ...
                            i16 = i9;
                            i9 = i8;
                            onMeasureChild(view2, i12, max, i13, 0);
                        } else {
                            view3 = view;
                            i15 = i11;
                            view2 = view3;
                            ...
                            i9 = i8;
                            i10 = size3;
                            if (!behavior.onMeasureChild(this, view3, i12, max, i13, 0)) {
                                onMeasureChild(view2, i12, max, i13, 0);
                            }
                        }
                        view4 = view2;
                        paddingBottom = Math.max(i14, ((i3 + view4.getMeasuredWidth()) + layoutParams.leftMargin) + layoutParams.rightMargin);
                        i6 = Math.max(i15, ((i4 + view4.getMeasuredHeight()) + layoutParams.topMargin) + layoutParams.bottomMargin);
                        ...
                        if (obj2 != null || ViewCompat.getFitsSystemWindows(view)) {
                            ...
                            i12 = MeasureSpec.makeMeasureSpec(size - (coordinatorLayout.mLastInsets.getSystemWindowInsetLeft() + coordinatorLayout.mLastInsets.getSystemWindowInsetRight()), mode);
        ...
        int i17 = i7;
        setMeasuredDimension(View.resolveSizeAndState(i5, i, ViewCompat.MEASURED_STATE_MASK & i17), View.resolveSizeAndState(i6, i2, i17 << 16));
    }
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i3)) {
                    ...
                    if (behavior != null) {
                        ...
                        r8.mTempIntPair[1] = 0;
                        iArr2[0] = 0;
                        behavior.onNestedPreScroll(this, childAt, view, i, i2, r8.mTempIntPair, i3);
                        if (i > 0) {
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C05431();
                }
