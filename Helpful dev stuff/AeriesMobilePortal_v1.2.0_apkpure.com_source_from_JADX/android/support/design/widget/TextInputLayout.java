...
public class TextInputLayout extends LinearLayout {
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0012R.styleable.TextInputLayout, i, C0012R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = context.getBoolean(C0012R.styleable.TextInputLayout_hintEnabled, true);
        setHint(context.getText(C0012R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = context.getBoolean(C0012R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (context.hasValue(C0012R.styleable.TextInputLayout_android_textColorHint) != null) {
            attributeSet = context.getColorStateList(C0012R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = attributeSet;
            this.mDefaultTextColor = attributeSet;
        }
        if (context.getResourceId(C0012R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(context.getResourceId(C0012R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = context.getResourceId(C0012R.styleable.TextInputLayout_errorTextAppearance, 0);
        attributeSet = context.getBoolean(C0012R.styleable.TextInputLayout_errorEnabled, false);
        boolean z = context.getBoolean(C0012R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(context.getInt(C0012R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = context.getResourceId(C0012R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = context.getResourceId(C0012R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = context.getBoolean(C0012R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = context.getDrawable(C0012R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = context.getText(C0012R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (context.hasValue(C0012R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = context.getColorStateList(C0012R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (context.hasValue(C0012R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(context.getInt(C0012R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        context.recycle();
...
*/
    ...
    L_0x0014:
        ...
        r5.mErrorView = r1;
        r1 = r5.mErrorView;
        r2 = android.support.design.C0012R.id.textinput_error;
        r1.setId(r2);
        r1 = r5.mTypeface;
    ...
    L_0x0054:
        r2 = r5.mErrorView;
        r3 = android.support.v7.appcompat.C0242R.style.TextAppearance_AppCompat_Caption;
        android.support.v4.widget.TextViewCompat.setTextAppearance(r2, r3);
        r2 = r5.mErrorView;
        r3 = r5.getContext();
        r4 = android.support.v7.appcompat.C0242R.color.error_color_material;
...
*/
    ...
    L_0x0006:
        ...
        r3.mCounterView = r0;
        r0 = r3.mCounterView;
        r1 = android.support.design.C0012R.id.textinput_counter;
        r0.setId(r1);
        r0 = r3.mTypeface;
    ...
    L_0x0031:
        r0 = r3.mCounterView;
        r1 = android.support.v7.appcompat.C0242R.style.TextAppearance_AppCompat_Caption;
        android.support.v4.widget.TextViewCompat.setTextAppearance(r0, r1);
        r0 = r3.mCounterView;
        r1 = r3.getContext();
        r2 = android.support.v7.appcompat.C0242R.color.error_color_material;
    ...
    void updateCounter(int i) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0012R.string.character_counter_pattern, new Object[]{Integer.valueOf(i), Integer.valueOf(this.mCounterMaxLength)}));
        }
