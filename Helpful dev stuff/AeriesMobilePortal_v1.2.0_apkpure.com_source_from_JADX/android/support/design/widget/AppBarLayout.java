...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            attributeSet = context.obtainStyledAttributes(attributeSet, C0012R.styleable.AppBarLayout_Layout);
            this.mScrollFlags = attributeSet.getInt(C0012R.styleable.AppBarLayout_Layout_layout_scrollFlags, 0);
            if (attributeSet.hasValue(C0012R.styleable.AppBarLayout_Layout_layout_scrollInterpolator)) {
                this.mScrollInterpolator = AnimationUtils.loadInterpolator(context, attributeSet.getResourceId(C0012R.styleable.AppBarLayout_Layout_layout_scrollInterpolator, 0));
            }
    ...
    class C05311 implements OnApplyWindowInsetsListener {
        C05311() {
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        public ScrollingViewBehavior(Context context, AttributeSet attributeSet) {
            super(context, attributeSet);
            context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.ScrollingViewBehavior_Layout);
            setOverlayTop(context.getDimensionPixelSize(C0012R.styleable.ScrollingViewBehavior_Layout_behavior_overlapTop, 0));
            context.recycle();
        }
    ...
    public AppBarLayout(Context context, AttributeSet attributeSet) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ...
            ViewUtilsLollipop.setStateListAnimatorFromAttrs(this, attributeSet, 0, C0012R.style.Widget_Design_AppBarLayout);
        }
        context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.AppBarLayout, 0, C0012R.style.Widget_Design_AppBarLayout);
        ViewCompat.setBackground(this, context.getDrawable(C0012R.styleable.AppBarLayout_android_background));
        if (context.hasValue(C0012R.styleable.AppBarLayout_expanded) != null) {
            setExpanded(context.getBoolean(C0012R.styleable.AppBarLayout_expanded, false), false, false);
        }
        if (VERSION.SDK_INT >= 21 && context.hasValue(C0012R.styleable.AppBarLayout_elevation) != null) {
            ViewUtilsLollipop.setDefaultAppBarLayoutStateListAnimator(this, (float) context.getDimensionPixelSize(C0012R.styleable.AppBarLayout_elevation, 0));
        }
        if (VERSION.SDK_INT >= 26) {
            if (context.hasValue(C0012R.styleable.AppBarLayout_android_keyboardNavigationCluster) != null) {
                setKeyboardNavigationCluster(context.getBoolean(C0012R.styleable.AppBarLayout_android_keyboardNavigationCluster, false));
            }
            if (context.hasValue(C0012R.styleable.AppBarLayout_android_touchscreenBlocksFocus) != null) {
                setTouchscreenBlocksFocus(context.getBoolean(C0012R.styleable.AppBarLayout_android_touchscreenBlocksFocus, false));
            }
        }
        context.recycle();
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05311());
    }
    ...
    protected int[] onCreateDrawableState(int i) {
        ...
        iArr[0] = this.mCollapsible ? C0012R.attr.state_collapsible : -C0012R.attr.state_collapsible;
        int i2 = (this.mCollapsible && this.mCollapsed) ? C0012R.attr.state_collapsed : -C0012R.attr.state_collapsed;
        iArr[1] = i2;
