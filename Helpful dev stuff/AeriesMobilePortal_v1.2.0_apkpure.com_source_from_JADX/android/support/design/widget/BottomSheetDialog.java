...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C05392 extends AccessibilityDelegateCompat {
        C05392() {
        }
    ...
    class C05404 extends BottomSheetCallback {
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int i) {
        ...
        this.mBottomSheetCallback = new C05404();
    ...
    private View wrapInBottomSheet(int i, View view, LayoutParams layoutParams) {
        FrameLayout frameLayout = (FrameLayout) View.inflate(getContext(), C0012R.layout.design_bottom_sheet_dialog, null);
        CoordinatorLayout coordinatorLayout = (CoordinatorLayout) frameLayout.findViewById(C0012R.id.coordinator);
        if (i != 0 && view == null) {
            view = getLayoutInflater().inflate(i, coordinatorLayout, false);
        }
        FrameLayout frameLayout2 = (FrameLayout) coordinatorLayout.findViewById(C0012R.id.design_bottom_sheet);
        ...
        coordinatorLayout.findViewById(C0012R.id.touch_outside).setOnClickListener(new C00281());
        ViewCompat.setAccessibilityDelegate(frameLayout2, new C05392());
        frameLayout2.setOnTouchListener(new C00293());
        return frameLayout;
    }
    ...
    private static int getThemeResId(Context context, int i) {
        ...
        i = new TypedValue();
        if (context.getTheme().resolveAttribute(C0012R.attr.bottomSheetDialogTheme, i, true) != null) {
            return i.resourceId;
        }
