...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = context.getBoolean(C0012R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            context.recycle();
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.FloatingActionButton, i, C0012R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = context.getColorStateList(C0012R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(context.getInt(C0012R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = context.getColor(C0012R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = context.getInt(C0012R.styleable.FloatingActionButton_fabSize, -1);
        this.mBorderWidth = context.getDimensionPixelSize(C0012R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = context.getDimension(C0012R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = context.getDimension(C0012R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = context.getBoolean(C0012R.styleable.FloatingActionButton_useCompatPadding, false);
        context.recycle();
    ...
    private int getSizeDimension(int i) {
        ...
        if (i == -1) {
            ...
            return resources.getDimensionPixelSize(C0012R.dimen.design_fab_size_normal);
        } else {
            return resources.getDimensionPixelSize(C0012R.dimen.design_fab_size_mini);
        }
    }
    ...
    private static int resolveAdjustedSize(int i, int i2) {
        ...
        if (mode != 0) {
            return mode != ErrorDialogData.SUPPRESSED ? i : i2;
        } else {
            return i;
        }
    }
