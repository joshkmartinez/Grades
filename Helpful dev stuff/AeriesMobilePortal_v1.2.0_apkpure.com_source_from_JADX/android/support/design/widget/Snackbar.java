...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                ...
                if (childAt.getLayoutParams().width == -1) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(i2, ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec(childAt.getMeasuredHeight(), ErrorDialogData.SUPPRESSED));
                }
            }
        }
    }
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (view != null) {
            SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(view.getContext()).inflate(C0012R.layout.design_layout_snackbar_include, view, false);
