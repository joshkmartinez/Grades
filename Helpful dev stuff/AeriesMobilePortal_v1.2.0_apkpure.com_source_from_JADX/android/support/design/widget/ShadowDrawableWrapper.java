...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f7 = f5 / ((r0.mRawShadowSize - (r0.mRawShadowSize * SHADOW_HORIZ_SCALE)) + f5);
        ...
        if (obj != null) {
            ...
            i2 = save;
            f2 = f8;
            canvas.drawRect(0.0f, f4, r0.mContentBounds.width() - f6, -r0.mCornerRadius, r0.mEdgeShadowPaint);
        } else {
            i = save2;
            f = f9;
            i2 = save;
        ...
        if (obj != null) {
            ...
            f3 = f2;
            f2 = f8;
            canvas.drawRect(0.0f, f4, r0.mContentBounds.width() - f6, (-r0.mCornerRadius) + r0.mShadowSize, r0.mEdgeShadowPaint);
        } else {
            f3 = f2;
            f2 = f8;
        }
        ...
        if (obj2 != null) {
            ...
            canvas.drawRect(0.0f, f4, r0.mContentBounds.height() - f6, -r0.mCornerRadius, r0.mEdgeShadowPaint);
        }
    ...
    private void buildShadowCorners() {
        ...
        float f4 = rectF.top;
        paint2.setShader(new LinearGradient(0.0f, f4, 0.0f, rectF2.top, new int[]{r0.mShadowStartColor, r0.mShadowMiddleColor, r0.mShadowEndColor}, new float[]{0.0f, SHADOW_HORIZ_SCALE, SHADOW_BOTTOM_SCALE}, TileMode.CLAMP));
