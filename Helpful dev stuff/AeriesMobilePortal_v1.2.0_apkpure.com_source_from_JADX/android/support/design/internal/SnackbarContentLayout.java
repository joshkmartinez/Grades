...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mMaxWidth = context.getDimensionPixelSize(C0012R.styleable.SnackbarLayout_android_maxWidth, -1);
        this.mMaxInlineActionWidth = context.getDimensionPixelSize(C0012R.styleable.SnackbarLayout_maxActionInlineWidth, -1);
        context.recycle();
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C0012R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C0012R.dimen.design_snackbar_padding_vertical);
        int i3 = 1;
