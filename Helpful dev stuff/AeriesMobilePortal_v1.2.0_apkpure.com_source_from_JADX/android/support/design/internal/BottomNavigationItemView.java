...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        i = attributeSet.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize = attributeSet.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = attributeSet.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0012R.layout.design_bottom_navigation_item, this, 1);
