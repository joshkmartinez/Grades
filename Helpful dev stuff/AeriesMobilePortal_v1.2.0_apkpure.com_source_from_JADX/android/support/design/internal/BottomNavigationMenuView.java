...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public BottomNavigationMenuView(Context context, AttributeSet attributeSet) {
        ...
        this.mInactiveItemMaxWidth = resources.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_item_max_width);
        this.mInactiveItemMinWidth = resources.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_item_min_width);
        this.mActiveItemMaxWidth = resources.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_active_item_max_width);
        this.mItemHeight = resources.getDimensionPixelSize(C0012R.dimen.design_bottom_navigation_height);
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i < i2) {
            ...
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i], ErrorDialogData.SUPPRESSED), makeMeasureSpec);
                childAt.getLayoutParams().width = childAt.getMeasuredWidth();
                i3 += childAt.getMeasuredWidth();
            }
            i++;
        }
        setMeasuredDimension(View.resolveSizeAndState(i3, MeasureSpec.makeMeasureSpec(i3, ErrorDialogData.SUPPRESSED), 0), View.resolveSizeAndState(this.mItemHeight, makeMeasureSpec, 0));
    }
