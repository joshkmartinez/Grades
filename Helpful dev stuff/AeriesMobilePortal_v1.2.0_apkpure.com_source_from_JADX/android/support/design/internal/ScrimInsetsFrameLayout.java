...
public class ScrimInsetsFrameLayout extends FrameLayout {
    ...
    class C05301 implements OnApplyWindowInsetsListener {
        C05301() {
        }
    ...
    public ScrimInsetsFrameLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.ScrimInsetsFrameLayout, i, C0012R.style.Widget_Design_ScrimInsetsFrameLayout);
        this.mInsetForeground = context.getDrawable(C0012R.styleable.ScrimInsetsFrameLayout_insetForeground);
        context.recycle();
        setWillNotDraw(true);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05301());
    }
