...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0012R.styleable.ForegroundLinearLayout, i, 0);
        this.mForegroundGravity = context.getInt(C0012R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.mForegroundGravity);
        attributeSet = context.getDrawable(C0012R.styleable.ForegroundLinearLayout_android_foreground);
        if (attributeSet != null) {
            setForeground(attributeSet);
        }
        this.mForegroundInPadding = context.getBoolean(C0012R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
        context.recycle();
    }
