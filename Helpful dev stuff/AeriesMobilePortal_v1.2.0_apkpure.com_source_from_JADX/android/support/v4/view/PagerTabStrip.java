...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public PagerTabStrip(Context context, AttributeSet attributeSet) {
        ...
        this.mPrevText.setOnClickListener(new C01951());
        this.mNextText.setFocusable(true);
        this.mNextText.setOnClickListener(new C01962());
    ...
    void updateTextPositions(int i, float f, boolean z) {
        ...
        this.mTabAlpha = (int) ((Math.abs(f - 1056964608) * ErrorDialogData.SUPPRESSED) * 1132396544);
