...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01981();
    ...
    private static final Interpolator sInterpolator = new C01992();
    ...
    private final Runnable mEndScrollRunnable = new C02003();
    ...
    static class C01981 implements Comparator<ItemInfo> {
        C01981() {
        }
    ...
    static class C01992 implements Interpolator {
    ...
    class C05744 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C02011 implements ClassLoaderCreator<SavedState> {
            C02011() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05744());
    }
...
*/
    ...
    L_0x0219:
        return;
    L_0x021a:
        r1 = r18.getResources();	 Catch:{ NotFoundException -> 0x0227 }
        r2 = r18.getId();	 Catch:{ NotFoundException -> 0x0227 }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (true) {
            boolean z2 = true;
            int i5 = ErrorDialogData.SUPPRESSED;
                    ...
                    if (i9 != 48) {
                        if (i9 != 80) {
                            ...
                            if (i9 != 0) {
                                ...
                                i6 = z2 ? ErrorDialogData.SUPPRESSED : Integer.MIN_VALUE;
                            }
        ...
        r0.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(measuredHeight, ErrorDialogData.SUPPRESSED);
        r0.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(i4, ErrorDialogData.SUPPRESSED);
        r0.mInLayout = true;
        populate();
        i3 = 0;
        r0.mInLayout = false;
        ...
        while (i3 < measuredWidth) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) measuredHeight) * layoutParams2.widthFactor), ErrorDialogData.SUPPRESSED), r0.mChildHeightMeasureSpec);
                }
            }
            i3++;
        }
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams2.needsMeasure) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), ErrorDialogData.SUPPRESSED), MeasureSpec.makeMeasureSpec((i6 - paddingBottom) - i7, ErrorDialogData.SUPPRESSED));
                        }
