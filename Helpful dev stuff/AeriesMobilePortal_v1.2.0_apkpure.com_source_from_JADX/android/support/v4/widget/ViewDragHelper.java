...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C02251();
    ...
    private final Runnable mSetIdleRunnable = new C02262();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C02251 implements Interpolator {
