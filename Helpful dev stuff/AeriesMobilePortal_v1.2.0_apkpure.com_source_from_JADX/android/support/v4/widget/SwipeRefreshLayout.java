...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    class C02171 implements AnimationListener {
    ...
    class C02182 extends Animation {
        C02182() {
        }
    ...
    class C02193 extends Animation {
        C02193() {
        }
    ...
    class C02215 implements AnimationListener {
        public void onAnimationRepeat(Animation animation) {
        }
    ...
    class C02226 extends Animation {
        C02226() {
        }
    ...
    class C02237 extends Animation {
        C02237() {
        }
    ...
    class C02248 extends Animation {
        C02248() {
        }
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mRefreshListener = new C02171();
        this.mAnimateToCorrectPosition = new C02226();
        this.mAnimateToStartPosition = new C02237();
    ...
    private void startScaleUpAnimation(AnimationListener animationListener) {
        ...
        this.mScaleAnimation = new C02182();
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new C02193();
    ...
    private Animation startAlphaAnimation(final int i, final int i2) {
        Animation c02204 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.mProgress.setAlpha((int) (((float) i) + (((float) (i2 - i)) * f)));
            }
        };
        c02204.setDuration(ALPHA_ANIMATION_DURATION);
        this.mCircleView.setAnimationListener(0);
        this.mCircleView.clearAnimation();
        this.mCircleView.startAnimation(c02204);
        return c02204;
    }
    ...
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        ...
        this.mScaleDownToStartAnimation = new C02248();
