...
public class SlidingPaneLayout extends ViewGroup {
    ...
    static class SavedState extends AbsSavedState {
        ...
        static class C02161 implements ClassLoaderCreator<SavedState> {
            C02161() {
            }
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    mode = MeasureSpec.makeMeasureSpec(paddingLeft - i7, ErrorDialogData.SUPPRESSED);
                } else {
                ...
                if (layoutParams.height == -2) {
                    ...
                    i6 = MeasureSpec.makeMeasureSpec(i3, ErrorDialogData.SUPPRESSED);
                } else {
                        ...
                        if (!z2 || childAt2 == slidingPaneLayout.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (layoutParams2.width != 0) {
                                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), ErrorDialogData.SUPPRESSED);
                                } else if (layoutParams2.height == -2) {
                                    i6 = MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                    if (z2) {
                                        i8 = mode;
                                        childAt2.measure(MeasureSpec.makeMeasureSpec(i7 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i5))) / f)), ErrorDialogData.SUPPRESSED), i6);
                                        mode2++;
                                        mode = i8;
                                        i6 = 8;
                                    } else {
                                        ...
                                        i8 = mode;
                                        mode = MeasureSpec.makeMeasureSpec(i9, ErrorDialogData.SUPPRESSED);
                                        if (i7 != i9) {
                                    ...
                                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(i3, ErrorDialogData.SUPPRESSED);
                                } else {
                                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(layoutParams2.height, ErrorDialogData.SUPPRESSED);
                                }
                                i6 = makeMeasureSpec;
                                if (z2) {
                                    i8 = mode;
                            ...
                            if (obj == null) {
                                ...
                                i9 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), ErrorDialogData.SUPPRESSED);
                            } else if (layoutParams2.height == -2) {
                                i9 = MeasureSpec.makeMeasureSpec(i3, Integer.MIN_VALUE);
                                i10 = ErrorDialogData.SUPPRESSED;
                            } else if (layoutParams2.height == -1) {
                                i10 = ErrorDialogData.SUPPRESSED;
                                i9 = MeasureSpec.makeMeasureSpec(i3, ErrorDialogData.SUPPRESSED);
                            } else {
                                i10 = ErrorDialogData.SUPPRESSED;
                                i9 = MeasureSpec.makeMeasureSpec(layoutParams2.height, ErrorDialogData.SUPPRESSED);
                            }
