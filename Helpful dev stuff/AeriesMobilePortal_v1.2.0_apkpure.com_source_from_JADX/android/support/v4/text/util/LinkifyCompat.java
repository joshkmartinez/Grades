...
public final class LinkifyCompat {
    private static final Comparator<LinkSpec> COMPARATOR = new C01881();
    private static final String[] EMPTY_STRING = new String[0];

    static class C01881 implements Comparator<LinkSpec> {
        C01881() {
        }
    ...
    public static final boolean addLinks(@NonNull Spannable spannable, int i) {
        ...
        if ((i & 2) != 0) {
            ...
            gatherLinks(arrayList2, spannable2, PatternsCompat.AUTOLINK_EMAIL_ADDRESS, new String[]{"mailto:"}, null, null);
        }
        if ((i & 8) != 0) {
