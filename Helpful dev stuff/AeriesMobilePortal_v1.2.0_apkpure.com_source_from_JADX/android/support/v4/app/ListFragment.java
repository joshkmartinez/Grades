...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C01142();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C01131();
    ...
    class C01142 implements OnItemClickListener {
        C01142() {
        }
