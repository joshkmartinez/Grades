...
*/
    ...
    public static final class QueueItem implements Parcelable {
        public static final Creator<QueueItem> CREATOR = new C01581();
        public static final int UNKNOWN_ID = -1;
        private final MediaDescriptionCompat mDescription;
        private final long mId;
        private Object mItem;

        static class C01581 implements Creator<QueueItem> {
            C01581() {
            }
    ...
    static final class ResultReceiverWrapper implements Parcelable {
        public static final Creator<ResultReceiverWrapper> CREATOR = new C01591();
        private ResultReceiver mResultReceiver;

        static class C01591 implements Creator<ResultReceiverWrapper> {
            C01591() {
            }
    ...
    public static final class Token implements Parcelable {
        public static final Creator<Token> CREATOR = new C01601();
        private final IMediaSession mExtraBinder;
        private final Object mInner;

        static class C01601 implements Creator<Token> {
            C01601() {
            }
    ...
    class C05661 extends Callback {
        C05661() {
        }
    }

    class C05672 extends Callback {
        C05672() {
        }
    }
...
*/
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        final String mTag;
        private final Token mToken;
        private android.support.v4.media.VolumeProviderCompat.Callback mVolumeCallback = new C05681();
        ...
        class C05681 extends android.support.v4.media.VolumeProviderCompat.Callback {
            C05681() {
            }
...
*/
    ...
    static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        class C01561 implements OnPlaybackPositionUpdateListener {
            C01561() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setPlaybackPositionUpdateListener(new C01561());
        }
...
*/
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        class C01571 implements OnMetadataUpdateListener {
            C01571() {
            }
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new C01571());
        }
