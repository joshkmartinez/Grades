...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C01621();
    ...
    static class C01621 implements Creator<PlaybackStateCompat> {
        C01621() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C01631();
        ...
        static class C01631 implements Creator<CustomAction> {
            C01631() {
            }
