...
import android.support.mediacompat.C0057R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        RemoteViews generateContentView() {
            ...
            applyStandardTemplate.removeAllViews(C0057R.id.media_actions);
            if (i > 0) {
                int i2 = 0;
                while (i2 < i) {
                    if (i2 < size) {
                        applyStandardTemplate.addView(C0057R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i2])));
                        i2++;
                    } else {
            ...
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0057R.id.end_padder, 8);
                applyStandardTemplate.setViewVisibility(C0057R.id.cancel_action, 0);
                applyStandardTemplate.setOnClickPendingIntent(C0057R.id.cancel_action, this.mCancelButtonIntent);
                applyStandardTemplate.setInt(C0057R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0057R.integer.cancel_button_image_alpha));
            } else {
                applyStandardTemplate.setViewVisibility(C0057R.id.end_padder, 0);
                applyStandardTemplate.setViewVisibility(C0057R.id.cancel_action, 8);
            }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0057R.layout.notification_media_action);
            remoteViews.setImageViewResource(C0057R.id.action0, action.getIcon());
            if (obj == null) {
                remoteViews.setOnClickPendingIntent(C0057R.id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0057R.id.action0, action.getTitle());
            }
            return remoteViews;
        }

        int getContentViewLayoutResource() {
            return C0057R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (min > 0) {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0057R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                applyStandardTemplate.setViewVisibility(C0057R.id.cancel_action, 0);
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0057R.layout.notification_template_big_media_narrow : C0057R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0057R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int i) {
            return i <= 3 ? C0057R.layout.notification_template_big_media_narrow_custom : C0057R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews remoteViews) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0057R.color.notification_material_background_media_default_color);
            }
            remoteViews.setInt(C0057R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
