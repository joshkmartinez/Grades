...
abstract class ParameterHandler<T> {
    ...
    class C10951 extends ParameterHandler<Iterable<T>> {
        C10951() {
        }
    ...
    class C10962 extends ParameterHandler<Object> {
        C10962() {
        }
    ...
    static final class RawPart extends ParameterHandler<okhttp3.MultipartBody.Part> {
        ...
        void apply(RequestBuilder requestBuilder, @Nullable okhttp3.MultipartBody.Part part) {
            if (part != null) {
