            ...
            if (slashCount < 2 && httpUrl2 != null) {
                if (httpUrl2.scheme.equals(builder.scheme)) {
                    ...
                    if (delimiterOffset < skipTrailingAsciiWhitespace || str2.charAt(delimiterOffset) != '?') {
                        ...
                        builder.encodedQueryNamesAndValues = HttpUrl.queryStringToNamesAndValues(HttpUrl.canonicalize(str, delimiterOffset + 1, i, HttpUrl.QUERY_ENCODE_SET, true, false, true, true, null));
                    }
                    if (i < skipTrailingAsciiWhitespace && str2.charAt(i) == '#') {
                        builder.encodedFragment = HttpUrl.canonicalize(str, i + 1, skipTrailingAsciiWhitespace, "", true, false, false, false, null);
                    }
                    ...
                    switch (charAt) {
                        ...
                        case '@':
                            if (i3 == 0) {
                                ...
                                String canonicalize = HttpUrl.canonicalize(str, slashCount, delimiterOffset2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                if (i4 != 0) {
                                    StringBuilder stringBuilder = new StringBuilder();
                                ...
                                if (i5 != i2) {
                                    builder.encodedPassword = HttpUrl.canonicalize(str, i5 + 1, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null);
                                    i3 = 1;
                                }
                                i4 = 1;
                            } else {
                                ...
                                stringBuilder2.append(HttpUrl.canonicalize(str, slashCount, i2, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true, null));
