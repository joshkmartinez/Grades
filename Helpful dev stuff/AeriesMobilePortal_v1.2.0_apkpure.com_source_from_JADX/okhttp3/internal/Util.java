...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C10191();
    ...
    class C10191 implements Comparator<String> {
        C10191() {
        }
    ...
    class C10202 implements ThreadFactory {
        final /* synthetic */ boolean val$daemon;
        final /* synthetic */ String val$name;

        C10202(String str, boolean z) {
            this.val$name = str;
            this.val$daemon = z;
        }
