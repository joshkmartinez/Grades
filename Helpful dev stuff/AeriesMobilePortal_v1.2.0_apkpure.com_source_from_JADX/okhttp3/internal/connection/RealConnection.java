...
public final class RealConnection extends Listener implements Connection {
    ...
    private Request createTunnel(int i, int i2, Request request, HttpUrl httpUrl) throws IOException {
        ...
        if (this.source.buffer().exhausted() != 0 && this.sink.buffer().exhausted() != 0) {
            return null;
        }
...
*/
    ...
    public String toString() {
        ...
        stringBuilder.append(this.handshake != null ? this.handshake.cipherSuite() : SchedulerSupport.NONE);
