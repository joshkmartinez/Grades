...
public class TableQuery implements NativeObject {
    ...
    public TableQuery equalTo(long[] jArr, long[] jArr2, String str, Case caseR) {
    ...
    public TableQuery notEqualTo(long[] jArr, long[] jArr2, String str, Case caseR) {
        nativeNotEqual(this.nativePtr, jArr, jArr2, str, caseR.getValue());
        this.queryValidated = null;
        return this;
    }
    ...
    public TableQuery beginsWith(long[] jArr, long[] jArr2, String str, Case caseR) {
        nativeBeginsWith(this.nativePtr, jArr, jArr2, str, caseR.getValue());
        this.queryValidated = null;
        return this;
    }
    ...
    public TableQuery endsWith(long[] jArr, long[] jArr2, String str, Case caseR) {
        nativeEndsWith(this.nativePtr, jArr, jArr2, str, caseR.getValue());
        this.queryValidated = null;
        return this;
    }
    ...
    public TableQuery like(long[] jArr, long[] jArr2, String str, Case caseR) {
        nativeLike(this.nativePtr, jArr, jArr2, str, caseR.getValue());
        this.queryValidated = null;
        return this;
    }
    ...
    public TableQuery contains(long[] jArr, long[] jArr2, String str, Case caseR) {
        nativeContains(this.nativePtr, jArr, jArr2, str, caseR.getValue());
        this.queryValidated = null;
        return this;
    }
    ...
    public Date maximumDate(long j, long j2, long j3, long j4) {
        ...
        return nativeMaximumTimestamp != null ? new Date(nativeMaximumTimestamp.longValue()) : null;
    }

    public Date maximumDate(long j) {
        validateQuery();
        j = nativeMaximumTimestamp(this.nativePtr, j, 0, -1, -1);
        return j != null ? new Date(j.longValue()) : 0;
    }
    ...
    public Date minimumDate(long j, long j2, long j3, long j4) {
        ...
        return nativeMinimumTimestamp != null ? new Date(nativeMinimumTimestamp.longValue() * 1000) : null;
    }

    public Date minimumDate(long j) {
        validateQuery();
        j = nativeMinimumTimestamp(this.nativePtr, j, 0, -1, -1);
        return j != null ? new Date(j.longValue()) : 0;
    }
