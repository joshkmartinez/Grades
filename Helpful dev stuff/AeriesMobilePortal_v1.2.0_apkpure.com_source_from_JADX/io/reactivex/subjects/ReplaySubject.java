...
public final class ReplaySubject<T> extends Subject<T> {
        ...
        int size(TimedNode<Object> timedNode) {
            ...
            while (i != Integer.MAX_VALUE) {
                ...
                if (timedNode2 == null) {
                    ...
                    return (NotificationLite.isComplete(timedNode) || NotificationLite.isError(timedNode) != null) ? i - 1 : i;
                } else {
                    i++;
                    timedNode = timedNode2;
                }
    ...
    protected void subscribeActual(Observer<? super T> observer) {
        ...
        if (replayDisposable.cancelled == null) {
            if (add(replayDisposable) == null || replayDisposable.cancelled == null) {
    ...
    public void onError(Throwable th) {
        ...
        ReplayBuffer replayBuffer = this.buffer;
        replayBuffer.addFinal(th);
        for (ReplayDisposable replay : terminate(th)) {
            replayBuffer.replay(replay);
        }
    }
    ...
    ReplayDisposable<T>[] terminate(Object obj) {
        if (this.buffer.compareAndSet(null, obj) != null) {
