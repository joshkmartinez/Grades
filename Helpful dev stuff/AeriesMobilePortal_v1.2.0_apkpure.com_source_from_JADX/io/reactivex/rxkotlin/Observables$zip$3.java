...
public final class Observables$zip$3<T1, T2, T3, T4, R> implements Function4<T1, T2, T3, T4, R> {
    final /* synthetic */ kotlin.jvm.functions.Function4 $combineFunction;

    public Observables$zip$3(kotlin.jvm.functions.Function4 function4) {
