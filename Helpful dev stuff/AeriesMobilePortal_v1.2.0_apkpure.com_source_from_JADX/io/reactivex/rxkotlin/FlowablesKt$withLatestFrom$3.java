...
public final class FlowablesKt$withLatestFrom$3<T1, T2, T3, T4, R> implements Function4<T, T1, T2, T3, R> {
    final /* synthetic */ kotlin.jvm.functions.Function4 $combiner;

    public FlowablesKt$withLatestFrom$3(kotlin.jvm.functions.Function4 function4) {
