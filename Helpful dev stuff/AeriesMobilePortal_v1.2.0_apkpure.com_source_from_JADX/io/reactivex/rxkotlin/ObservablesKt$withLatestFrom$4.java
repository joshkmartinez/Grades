...
public final class ObservablesKt$withLatestFrom$4<T1, T2, T3, T4, T5, R> implements Function5<T, T1, T2, T3, T4, R> {
    final /* synthetic */ kotlin.jvm.functions.Function5 $combiner;

    public ObservablesKt$withLatestFrom$4(kotlin.jvm.functions.Function5 function5) {
