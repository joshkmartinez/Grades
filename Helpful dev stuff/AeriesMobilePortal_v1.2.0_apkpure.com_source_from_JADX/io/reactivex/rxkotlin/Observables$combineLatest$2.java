...
public final class Observables$combineLatest$2<T1, T2, T3, R> implements Function3<T1, T2, T3, R> {
    final /* synthetic */ kotlin.jvm.functions.Function3 $combineFunction;

    public Observables$combineLatest$2(kotlin.jvm.functions.Function3 function3) {
