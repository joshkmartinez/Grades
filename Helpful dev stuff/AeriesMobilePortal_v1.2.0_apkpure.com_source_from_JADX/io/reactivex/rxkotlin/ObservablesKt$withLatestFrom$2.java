...
public final class ObservablesKt$withLatestFrom$2<T1, T2, T3, R> implements Function3<T, T1, T2, R> {
    final /* synthetic */ kotlin.jvm.functions.Function3 $combiner;

    public ObservablesKt$withLatestFrom$2(kotlin.jvm.functions.Function3 function3) {
