...
public final class Functions {
    ...
    static final class Array2Func<T1, T2, R> implements Function<Object[], R> {
        final BiFunction<? super T1, ? super T2, ? extends R> f46f;

        Array2Func(BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
            this.f46f = biFunction;
        }

        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 2) {
                return this.f46f.apply(objArr[0], objArr[1]);
            }
    ...
    static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        final Function3<T1, T2, T3, R> f47f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 3) {
                return this.f47f.apply(objArr[0], objArr[1], objArr[2]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        final Function4<T1, T2, T3, T4, R> f48f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
                return this.f48f.apply(objArr[0], objArr[1], objArr[2], objArr[3]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        private final Function5<T1, T2, T3, T4, T5, R> f49f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
                return this.f49f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        final Function6<T1, T2, T3, T4, T5, T6, R> f50f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
                return this.f50f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        final Function7<T1, T2, T3, T4, T5, T6, T7, R> f51f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
                return this.f51f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        final Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f52f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
                return this.f52f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        final Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> f53f;
        ...
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
                return this.f53f.apply(objArr[0], objArr[1], objArr[2], objArr[3], objArr[4], objArr[5], objArr[6], objArr[7], objArr[8]);
            }
            StringBuilder stringBuilder = new StringBuilder();
    ...
    static final class BooleanSupplierPredicateReverse<T> implements Predicate<T> {
        ...
        public boolean test(T t) throws Exception {
            return this.supplier.getAsBoolean() ^ 1;
        }
    }
