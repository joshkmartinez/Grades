...
public final class CompletableResumeNext extends Completable {
    ...
    final class ResumeNext implements CompletableObserver {
        final CompletableObserver f70s;
        ...
        final class OnErrorObserver implements CompletableObserver {
            ...
            public void onComplete() {
                ResumeNext.this.f70s.onComplete();
            }

            public void onError(Throwable th) {
                ResumeNext.this.f70s.onError(th);
            }
        ...
        ResumeNext(CompletableObserver completableObserver, SequentialDisposable sequentialDisposable) {
            this.f70s = completableObserver;
            this.sd = sequentialDisposable;
        }

        public void onComplete() {
            this.f70s.onComplete();
        }
        ...
        public void onError(Throwable th) {
            ...
            try {
                ...
                if (completableSource == null) {
                    ...
                    this.f70s.onError(nullPointerException);
                    return;
                }
                ...
                this.f70s.onError(new CompositeException(nullPointerException2, th));
            }
        }
