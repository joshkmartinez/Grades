...
public final class CompletableUsing<R> extends Completable {
    ...
    static final class UsingObserver<R> extends AtomicReference<Object> implements CompletableObserver, Disposable {
        ...
        public void dispose() {
            this.f72d.dispose();
            this.f72d = DisposableHelper.DISPOSED;
        ...
        public boolean isDisposed() {
            return this.f72d.isDisposed();
        }

        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f72d, disposable)) {
                this.f72d = disposable;
    ...
    protected void subscribeActual(CompletableObserver completableObserver) {
        try {
            ...
            try {
                ...
                Exceptions.throwIfFatal(completableObserver2);
                RxJavaPlugins.onError(completableObserver2);
            }
        } catch (Throwable th) {
            Exceptions.throwIfFatal(th);
            EmptyDisposable.error(th, completableObserver2);
        }
    }
}
