    ...
    static final class FlatMapBiMainObserver<T, U, R> implements MaybeObserver<T>, Disposable {
        ...
        static final class InnerObserver<T, U, R> extends AtomicReference<Disposable> implements MaybeObserver<U> {
            ...
            public void onSuccess(U u) {
                ...
                this.value = null;
                try {
                    this.actual.onSuccess(ObjectHelper.requireNonNull(this.resultSelector.apply(obj, u), "The resultSelector returned a null value"));
                } catch (U u2) {
                    Exceptions.throwIfFatal(u2);
                    this.actual.onError(u2);
                }
            }
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.setOnce(this.inner, disposable) != null) {
