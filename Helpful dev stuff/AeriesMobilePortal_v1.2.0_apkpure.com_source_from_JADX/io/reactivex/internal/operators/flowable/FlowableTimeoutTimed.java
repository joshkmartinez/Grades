...
public final class FlowableTimeoutTimed<T> extends AbstractFlowableWithUpstream<T, T> {
    ...
    static final class TimeoutFallbackSubscriber<T> extends SubscriptionArbiter implements FlowableSubscriber<T>, TimeoutSupport {
        ...
        public void onTimeout(long j) {
            if (this.index.compareAndSet(j, LongCompanionObject.MAX_VALUE) != null) {
                ...
                j = this.fallback;
                this.fallback = null;
                j.subscribe(new FallbackSubscriber(this.actual, this));
                this.worker.dispose();
            }
        }
    ...
    static final class TimeoutSubscriber<T> extends AtomicLong implements FlowableSubscriber<T>, Subscription, TimeoutSupport {
        ...
        public void onTimeout(long j) {
            if (compareAndSet(j, LongCompanionObject.MAX_VALUE) != null) {
                SubscriptionHelper.cancel(this.upstream);
    ...
    protected void subscribeActual(Subscriber<? super T> subscriber) {
        if (this.other == null) {
            FlowableSubscriber timeoutSubscriber = new TimeoutSubscriber(subscriber, this.timeout, this.unit, this.scheduler.createWorker());
