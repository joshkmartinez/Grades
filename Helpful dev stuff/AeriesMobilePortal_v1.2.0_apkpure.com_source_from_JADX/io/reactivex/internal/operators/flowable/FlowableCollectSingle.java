...
public final class FlowableCollectSingle<T, U> extends Single<U> implements FuseToFlowable<U> {
    ...
    static final class CollectSubscriber<T, U> implements FlowableSubscriber<T>, Disposable {
        ...
        public void onSubscribe(Subscription subscription) {
            if (SubscriptionHelper.validate(this.f225s, subscription)) {
                this.f225s = subscription;
        ...
        public void onNext(T t) {
            if (!this.done) {
                try {
                    this.collector.accept(this.f226u, t);
                } catch (T t2) {
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.f225s = SubscriptionHelper.CANCELLED;
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                this.f225s = SubscriptionHelper.CANCELLED;
                this.actual.onSuccess(this.f226u);
            }
        }
        ...
        public boolean isDisposed() {
            return this.f225s == SubscriptionHelper.CANCELLED;
        }
    }
