...
public final class ObservableDebounce<T, U> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class DebounceObserver<T, U> implements Observer<T>, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f118s, disposable)) {
                this.f118s = disposable;
        ...
        public void onNext(T t) {
            if (!this.done) {
                ...
                try {
                    ...
                    if (this.debouncer.compareAndSet(disposable, debounceInnerObserver) != null) {
