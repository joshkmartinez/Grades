...
public final class ObservableConcatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class ConcatMapDelayErrorObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        static final class DelayErrorInnerObserver<R> extends AtomicReference<Disposable> implements Observer<R> {
            ...
            public void onError(Throwable th) {
                ...
                if (concatMapDelayErrorObserver.error.addThrowable(th)) {
                    if (concatMapDelayErrorObserver.tillTheEnd == null) {
                        concatMapDelayErrorObserver.f112d.dispose();
                    }
                    concatMapDelayErrorObserver.active = null;
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f112d, disposable)) {
                this.f112d = disposable;
        ...
        void drain() {
            if (getAndIncrement() == 0) {
                ...
                this.cancelled = true;
                Throwable th32 = atomicThrowable.terminate();
                if (th32 != null) {
    ...
    static final class SourceObserver<T, U> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f113s, disposable)) {
                this.f113s = disposable;
                if (disposable instanceof QueueDisposable) {
                    QueueDisposable queueDisposable = (QueueDisposable) disposable;
                    int requestFusion = queueDisposable.requestFusion(3);
                    if (requestFusion == 1) {
