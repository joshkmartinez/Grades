...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractObservableWithUpstream<TLeft, R> {
                    ...
                    if (z && z2) {
                        ...
                        if (num == LEFT_VALUE) {
                            ...
                            try {
                                ...
                                Object leftRightEndObserver = new LeftRightEndObserver(this, true, i2);
                            ...
                            try {
                                ...
                                Object leftRightEndObserver2 = new LeftRightEndObserver(this, false, i3);
                            ...
                            this.lefts.remove(Integer.valueOf(r4.index));
                            this.disposables.remove(r4);
                        } else {
                            r4 = (LeftRightEndObserver) poll;
                            this.rights.remove(Integer.valueOf(r4.index));
                            this.disposables.remove(r4);
                        }
                    }
                }
    ...
    protected void subscribeActual(Observer<? super R> observer) {
        ...
        joinDisposable.disposables.add(observer);
