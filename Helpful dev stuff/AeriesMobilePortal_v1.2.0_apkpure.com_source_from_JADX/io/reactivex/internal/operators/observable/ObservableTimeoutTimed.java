...
public final class ObservableTimeoutTimed<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    static final class TimeoutTimedObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        final class TimeoutTask implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedObserver.this.index) {
                    ...
                    TimeoutTimedObserver.this.f173s.dispose();
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f173s, disposable)) {
                this.f173s = disposable;
    ...
    static final class TimeoutTimedOtherObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        final class SubscribeNext implements Runnable {
            ...
            public void run() {
                if (this.idx == TimeoutTimedOtherObserver.this.index) {
                    ...
                    TimeoutTimedOtherObserver.this.f174s.dispose();
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f174s, disposable)) {
                this.f174s = disposable;
                if (this.arbiter.setDisposable(disposable) != null) {
        ...
        public void onNext(T t) {
            if (!this.done) {
                long j = this.index + 1;
                this.index = j;
                if (this.arbiter.onNext(t, this.f174s) != null) {
                    scheduleTimeout(j);
                }
            }
        }
        ...
        public void onError(Throwable th) {
            ...
            this.done = true;
            this.arbiter.onError(th, this.f174s);
            this.worker.dispose();
        }
        ...
        public void onComplete() {
            if (!this.done) {
                this.done = true;
                this.arbiter.onComplete(this.f174s);
                this.worker.dispose();
            }
        }
