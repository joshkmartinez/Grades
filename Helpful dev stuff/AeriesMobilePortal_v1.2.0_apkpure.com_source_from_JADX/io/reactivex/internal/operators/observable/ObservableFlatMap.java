...
public final class ObservableFlatMap<T, U> extends AbstractObservableWithUpstream<T, U> {
    ...
    static final class InnerObserver<T, U> extends AtomicReference<Disposable> implements Observer<U> {
        ...
        public void onError(Throwable th) {
            if (this.parent.errors.addThrowable(th)) {
                if (this.parent.delayErrors == null) {
    ...
    static final class MergeObserver<T, U> extends AtomicInteger implements Disposable, Observer<T> {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f128s, disposable)) {
                this.f128s = disposable;
        ...
        void tryEmitScalar(Callable<? extends U> callable) {
            try {
                ...
                Exceptions.throwIfFatal(callable2);
                this.errors.addThrowable(callable2);
                drain();
            }
        }
