...
public final class ObservableZip<T, R> extends Observable<R> {
    ...
    static final class ZipCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        public void subscribe(ObservableSource<? extends T>[] observableSourceArr, int i) {
            ...
            while (i2 < length && this.cancelled == 0) {
        ...
        public void drain() {
            ...
            if (getAndIncrement() == 0) {
                ...
                Observer observer = zipCoordinator.actual;
                Object obj = zipCoordinator.row;
                boolean z = zipCoordinator.delayError;
                int i = 1;
                while (true) {
                    int length = zipObserverArr.length;
                    int i2 = 0;
                    ...
                    if (i4 != 0) {
                        ...
                        try {
                            observer.onNext(ObjectHelper.requireNonNull(zipCoordinator.zipper.apply(obj.clone()), "The zipper returned a null value"));
    ...
    static final class ZipObserver<T, R> implements Observer<T> {
        ...
        final AtomicReference<Disposable> f183s = new AtomicReference();
        ...
        public void onSubscribe(Disposable disposable) {
            DisposableHelper.setOnce(this.f183s, disposable);
        }
        ...
        public void dispose() {
            DisposableHelper.dispose(this.f183s);
        }
    }
