...
public final class IoScheduler extends Scheduler {
    ...
    static final class CachedWorkerPool implements Runnable {
        ...
        CachedWorkerPool(long j, TimeUnit timeUnit, ThreadFactory threadFactory) {
            ...
            j = null;
            if (timeUnit != null) {
                j = Executors.newScheduledThreadPool(1, IoScheduler.EVICTOR_THREAD_FACTORY);
                scheduleWithFixedDelay = j.scheduleWithFixedDelay(this, this.keepAliveTime, this.keepAliveTime, TimeUnit.NANOSECONDS);
            } else {
                scheduleWithFixedDelay = null;
            }
            this.evictorService = j;
