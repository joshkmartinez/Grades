...
public abstract class Completable implements CompletableSource {
    ...
    public final void subscribe(CompletableObserver completableObserver) {
        ...
        try {
            ...
            Exceptions.throwIfFatal(completableObserver22);
            RxJavaPlugins.onError(completableObserver22);
            completableObserver22 = toNpe(completableObserver22);
        }
    }
    ...
    public final <U> U to(Function<? super Completable, U> function) {
        ...
        } catch (Function<? super Completable, U> function2) {
