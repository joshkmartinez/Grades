...
class DefaultSettingsJsonTransform implements SettingsJsonTransform {
    ...
    private AppSettingsData buildAppDataFrom(JSONObject jSONObject) throws JSONException {
        ...
        jSONObject = (jSONObject.has(SettingsJsonConstants.APP_ICON_KEY) && jSONObject.getJSONObject(SettingsJsonConstants.APP_ICON_KEY).has(SettingsJsonConstants.ICON_HASH_KEY)) ? buildIconDataFrom(jSONObject.getJSONObject(SettingsJsonConstants.APP_ICON_KEY)) : null;
        return new AppSettingsData(string, string2, string3, string4, string5, optBoolean, jSONObject);
    }
