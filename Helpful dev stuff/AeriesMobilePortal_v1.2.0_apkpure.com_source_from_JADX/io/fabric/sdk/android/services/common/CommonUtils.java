...
public class CommonUtils {
    ...
    public static final Comparator<File> FILE_MODIFIED_COMPARATOR = new C05031();
    ...
    static class C05031 implements Comparator<File> {
        C05031() {
        }
    ...
    enum Architecture {
        ...
        static Architecture getValue() {
            ...
            if (TextUtils.isEmpty(obj)) {
                Fabric.getLogger().mo2301d(Fabric.TAG, "Architecture#getValue()::Build.CPU_ABI returned null or empty");
                return UNKNOWN;
            }
        ...
        if (file.exists()) {
            ...
            try {
                ...
                try {
                    ...
                    logger.mo2304e(str3, stringBuilder.toString(), str);
            ...
            if (totalRamInBytes == -1) {
                ...
                if (!TextUtils.isEmpty(extractFieldFromSystemFile)) {
                    ...
                    try {
                        ...
                        logger2.mo2304e(str2, stringBuilder2.toString(), e);
                    }
                }
                totalRamInBytes = j;
            }
    ...
    private static String hash(InputStream inputStream, String str) {
        try {
            ...
            Fabric.getLogger().mo2304e(Fabric.TAG, "Could not calculate hash for app icon.", inputStream2);
            return "";
        }
    }
    ...
    private static String hash(byte[] bArr, String str) {
        try {
            ...
            logger.mo2304e(str2, stringBuilder.toString(), bArr2);
            return "";
        }
    }
    ...
    public static void logControlled(Context context, String str) {
        if (isClsTrace(context) != null) {
            Fabric.getLogger().mo2301d(Fabric.TAG, str);
        }
    }

    public static void logControlledError(Context context, String str, Throwable th) {
        if (isClsTrace(context) != null) {
            Fabric.getLogger().mo2303e(Fabric.TAG, str);
        }
    }
    ...
    public static void closeOrLog(Closeable closeable, String str) {
        if (closeable != null) {
            try {
                ...
                Fabric.getLogger().mo2304e(Fabric.TAG, str, closeable2);
            }
        }
    }
    ...
    public static void flushOrLog(Flushable flushable, String str) {
        if (flushable != null) {
            try {
                ...
                Fabric.getLogger().mo2304e(Fabric.TAG, str, flushable2);
            }
        }
    }
    ...
    public static String getAppIconHashOrNull(Context context) {
        ...
        try {
            ...
            try {
                ...
                e = e2;
                try {
                    Fabric.getLogger().mo2304e(Fabric.TAG, "Could not calculate hash for app icon.", e);
                    closeOrLog(context, "Failed to close icon input stream.");
                    return null;
                } catch (Throwable th2) {
                    th = th2;
...
*/
    ...
    public static void logOrThrowIllegalStateException(String str, String str2) {
        ...
        Fabric.getLogger().mo2314w(str, str2);
    }
