...
public abstract class AbstractSpiCall {
    ...
    protected HttpRequest getHttpRequest(Map<String, String> map) {
        ...
        return this.requestFactory.buildHttpRequest(this.method, getUrl(), map).useCaches(false).connectTimeout(DEFAULT_TIMEOUT).header("User-Agent", stringBuilder.toString()).header(HEADER_DEVELOPER_TOKEN, "470fa2b4ae81cd56ecbcda9735803434cec591fa");
    }
