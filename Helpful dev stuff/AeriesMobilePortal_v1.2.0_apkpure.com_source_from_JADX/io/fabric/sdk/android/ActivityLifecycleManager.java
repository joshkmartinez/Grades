...
public class ActivityLifecycleManager {
    ...
    private static class ActivityLifecycleCallbacksWrapper {
        ...
        private boolean registerLifecycleCallbacks(final Callbacks callbacks) {
            ...
            ActivityLifecycleCallbacks c04991 = new ActivityLifecycleCallbacks() {
            ...
            this.application.registerActivityLifecycleCallbacks(c04991);
            this.registeredCallbacks.add(c04991);
            return true;
        }
    }
    ...
    public boolean registerCallbacks(Callbacks callbacks) {
        return (this.callbacksWrapper == null || this.callbacksWrapper.registerLifecycleCallbacks(callbacks) == null) ? null : true;
    }
