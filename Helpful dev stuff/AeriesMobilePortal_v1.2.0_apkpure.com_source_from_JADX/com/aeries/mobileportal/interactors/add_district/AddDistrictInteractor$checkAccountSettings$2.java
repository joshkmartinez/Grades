...
final class AddDistrictInteractor$checkAccountSettings$2<T> implements Consumer<Throwable> {
    final /* synthetic */ AddDistrictCallback $callback;

    AddDistrictInteractor$checkAccountSettings$2(AddDistrictCallback addDistrictCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        addDistrictCallback.onPermissionsError(th);
    }
}
