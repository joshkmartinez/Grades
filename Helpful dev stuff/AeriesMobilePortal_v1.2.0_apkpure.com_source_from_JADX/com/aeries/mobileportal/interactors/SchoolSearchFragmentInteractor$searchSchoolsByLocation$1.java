...
final class SchoolSearchFragmentInteractor$searchSchoolsByLocation$1<T> implements Consumer<List<School>> {
    final /* synthetic */ SchoolSearchFragmentCallback $callback;

    SchoolSearchFragmentInteractor$searchSchoolsByLocation$1(SchoolSearchFragmentCallback schoolSearchFragmentCallback) {
    ...
    public final void accept(@Nullable List<School> list) {
        ...
        schoolSearchFragmentCallback.onSchoolsRetreivedLocation(list);
    }
}
