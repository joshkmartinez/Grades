...
public final class C0358x4666eee8<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(DateUtils.Companion.getMillis(((AttendanceDetail) t2).getAttendanceDate()), DateUtils.Companion.getMillis(((AttendanceDetail) t).getAttendanceDate()));
    }
}
