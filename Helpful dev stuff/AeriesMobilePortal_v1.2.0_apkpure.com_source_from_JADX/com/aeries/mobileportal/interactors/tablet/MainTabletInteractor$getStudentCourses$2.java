...
final class MainTabletInteractor$getStudentCourses$2<T> implements Consumer<Throwable> {
    final /* synthetic */ MainTabletCallback $callback;

    MainTabletInteractor$getStudentCourses$2(MainTabletCallback mainTabletCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        mainTabletCallback.onCoursesError(th);
        th.printStackTrace();
    }
}
