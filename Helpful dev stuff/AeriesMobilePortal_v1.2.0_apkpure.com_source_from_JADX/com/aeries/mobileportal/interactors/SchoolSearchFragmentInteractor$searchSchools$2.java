...
final class SchoolSearchFragmentInteractor$searchSchools$2<T> implements Consumer<Throwable> {
    final /* synthetic */ SchoolSearchFragmentCallback $callback;

    SchoolSearchFragmentInteractor$searchSchools$2(SchoolSearchFragmentCallback schoolSearchFragmentCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        schoolSearchFragmentCallback.onSchoolsError(th);
    }
}
