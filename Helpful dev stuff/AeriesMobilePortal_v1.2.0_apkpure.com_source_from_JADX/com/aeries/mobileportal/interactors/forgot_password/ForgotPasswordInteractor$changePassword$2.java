...
final class ForgotPasswordInteractor$changePassword$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ForgotPasswordCallback $callback;

    ForgotPasswordInteractor$changePassword$2(ForgotPasswordCallback forgotPasswordCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        forgotPasswordCallback.onChangePasswordError(th);
        th.printStackTrace();
    }
}
