...
final class ForgotPasswordInteractor$requestForgotPassword$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ForgotPasswordCallback $callback;

    ForgotPasswordInteractor$requestForgotPassword$2(ForgotPasswordCallback forgotPasswordCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        forgotPasswordCallback.onForgotPasswordError(th);
        th.printStackTrace();
    }
}
