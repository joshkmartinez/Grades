...
final class ChangeDistrictInteractor$checkSchoolAvailability$2<T> implements Consumer<Throwable> {
    final /* synthetic */ ChangeDistrictCallback $callback;

    ChangeDistrictInteractor$checkSchoolAvailability$2(ChangeDistrictCallback changeDistrictCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        changeDistrictCallback.onAppAvailableError(th);
    }
}
