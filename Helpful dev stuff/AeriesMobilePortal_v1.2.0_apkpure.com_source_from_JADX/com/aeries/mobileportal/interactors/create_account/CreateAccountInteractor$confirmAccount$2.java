...
final class CreateAccountInteractor$confirmAccount$2<T> implements Consumer<Throwable> {
    final /* synthetic */ CreateAccountCallback $callback;

    CreateAccountInteractor$confirmAccount$2(CreateAccountCallback createAccountCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        createAccountCallback.onAccountConfirmedError(th);
    }
}
