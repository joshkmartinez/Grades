...
final class CreateAccountInteractor$createAccount$2<T> implements Consumer<Throwable> {
    final /* synthetic */ CreateAccountCallback $callback;

    CreateAccountInteractor$createAccount$2(CreateAccountCallback createAccountCallback) {
    ...
    public final void accept(Throwable th) {
        ...
        createAccountCallback.onAccountCreatedError(th);
    }
}
