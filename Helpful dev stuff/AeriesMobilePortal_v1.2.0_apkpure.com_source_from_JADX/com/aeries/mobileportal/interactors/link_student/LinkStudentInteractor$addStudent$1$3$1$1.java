...
final class LinkStudentInteractor$addStudent$1$3$1$1 extends Lambda implements Function1<ViewPermission, Boolean> {
    public static final LinkStudentInteractor$addStudent$1$3$1$1 INSTANCE = new LinkStudentInteractor$addStudent$1$3$1$1();

    LinkStudentInteractor$addStudent$1$3$1$1() {
        super(1);
    }
