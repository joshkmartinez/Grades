...
final class ContactDetailFragment$setupViews$6 implements OnClickListener {
    final /* synthetic */ ContactDetailFragment this$0;

    ContactDetailFragment$setupViews$6(ContactDetailFragment contactDetailFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (view != null) {
            ...
            view.onPhonePressed(access$getMContact$p != null ? access$getMContact$p.getHomePhone() : null);
        }
    }
}
