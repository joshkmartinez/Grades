...
final class ContactDetailFragment$setupViews$7 implements OnClickListener {
    final /* synthetic */ ContactDetailFragment this$0;

    ContactDetailFragment$setupViews$7(ContactDetailFragment contactDetailFragment) {
    ...
    public final void onClick(View view) {
        ...
        if (view != null) {
            ...
            view.onAddressPressed(companion.getMapsFormattedAddress(access$getMContact$p != null ? access$getMContact$p.getAddress() : null));
        }
    }
}
