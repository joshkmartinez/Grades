...
final class ReportCardsAdapter$ReportCardHolder$bindView$2 implements OnClickListener {
    final /* synthetic */ ReportCard $report;
    final /* synthetic */ ReportCardHolder this$0;

    ReportCardsAdapter$ReportCardHolder$bindView$2(ReportCardHolder reportCardHolder, ReportCard reportCard) {
        this.this$0 = reportCardHolder;
        this.$report = reportCard;
    }

    public final void onClick(View view) {
        if (this.$report.getCorrespondenceReport() != null) {
            this.this$0.this$0.getListener().onReportCardSelected(this.$report, false);
        }
    }
}
