...
final class AttendanceAdapter$AttendanceHolderPeriod$bindView$1 implements OnClickListener {
    final /* synthetic */ AttendanceDetail $attendance;
    final /* synthetic */ AttendanceHolderPeriod this$0;

    AttendanceAdapter$AttendanceHolderPeriod$bindView$1(AttendanceHolderPeriod attendanceHolderPeriod, AttendanceDetail attendanceDetail) {
        this.this$0 = attendanceHolderPeriod;
        this.$attendance = attendanceDetail;
    }

    public final void onClick(View view) {
        this.this$0.this$0.getListener().onAttendanceSelected(this.$attendance);
    }
}
