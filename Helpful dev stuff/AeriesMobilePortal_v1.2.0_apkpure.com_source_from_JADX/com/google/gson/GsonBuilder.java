...
public final class GsonBuilder {
    ...
    private void addTypeAdaptersForDate(String str, int i, int i2, List<TypeAdapterFactory> list) {
        if (str != null && !"".equals(str.trim())) {
            str = new DefaultDateTypeAdapter(str);
        } else if (i != 2 && i2 != 2) {
            str = new DefaultDateTypeAdapter(i, i2);
        } else {
            return;
        }
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(Date.class), str));
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(Timestamp.class), str));
        list.add(TreeTypeAdapter.newFactory(TypeToken.get(java.sql.Date.class), str));
    }
}
