...
public final class LinkedTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C04721();
    ...
    static class C04721 implements Comparator<Comparable> {
        C04721() {
        }
    ...
    class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C08961 extends LinkedTreeMapIterator<Entry<K, V>> {
            C08961() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C08971 extends LinkedTreeMapIterator<K> {
            C08971() {
                super();
            }
