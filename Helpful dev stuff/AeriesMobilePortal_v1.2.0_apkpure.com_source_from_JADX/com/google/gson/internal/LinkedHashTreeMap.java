...
public final class LinkedHashTreeMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    private static final Comparator<Comparable> NATURAL_ORDER = new C04711();
    ...
    static class C04711 implements Comparator<Comparable> {
        C04711() {
        }
    ...
    final class EntrySet extends AbstractSet<Entry<K, V>> {
        ...
        class C08941 extends LinkedTreeMapIterator<Entry<K, V>> {
            C08941() {
                super();
            }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        class C08951 extends LinkedTreeMapIterator<K> {
            C08951() {
                super();
            }
