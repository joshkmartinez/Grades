...
public final class Tasks {
        ...
        private final void zzdu() {
            if ((this.zzagm + this.zzagn) + this.zzago == this.zzagl) {
                if (this.zzagh != null) {
                    ...
                    com_google_android_gms_tasks_zzu.setException(new ExecutionException(stringBuilder.toString(), this.zzagh));
                } else if (this.zzagp) {
                    this.zzafh.zzdp();
                } else {
    ...
    private static void zza(Task<?> task, zzb com_google_android_gms_tasks_Tasks_zzb) {
        task.addOnSuccessListener(TaskExecutors.zzagd, (OnSuccessListener) com_google_android_gms_tasks_Tasks_zzb);
        task.addOnFailureListener(TaskExecutors.zzagd, (OnFailureListener) com_google_android_gms_tasks_Tasks_zzb);
        task.addOnCanceledListener(TaskExecutors.zzagd, (OnCanceledListener) com_google_android_gms_tasks_Tasks_zzb);
    }
