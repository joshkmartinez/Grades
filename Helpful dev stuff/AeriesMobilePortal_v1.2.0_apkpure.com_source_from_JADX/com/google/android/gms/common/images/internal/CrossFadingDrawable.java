...
public final class CrossFadingDrawable extends Drawable implements Callback {
    ...
    public CrossFadingDrawable(Drawable drawable, Drawable drawable2) {
        ...
        com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.zzql = drawable.getChangingConfigurations() | com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb.zzql;
        if (drawable2 == null) {
            drawable2 = zza.zzqj;
        }
        this.zzqe = drawable2;
        drawable2.setCallback(this);
        zzb com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb2 = this.zzqc;
        com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb2.zzql = drawable2.getChangingConfigurations() | com_google_android_gms_common_images_internal_CrossFadingDrawable_zzb2.zzql;
    }
