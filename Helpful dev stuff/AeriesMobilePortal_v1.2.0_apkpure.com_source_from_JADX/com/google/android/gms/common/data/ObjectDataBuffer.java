...
public final class ObjectDataBuffer<T> extends AbstractDataBuffer<T> implements Observable, ObjectExclusionFilterable<T> {
    ...
    public final void add(T t) {
        ...
        if (this.zzof.hasObservers()) {
            Asserts.checkState(this.zzoe.contains(Integer.valueOf(size)) ^ true);
            int size2 = this.zzob.size();
            boolean z = false;
            Asserts.checkState(size2 > 0);
            size2--;
            if (((Integer) this.zzob.get(size2)).intValue() == size) {
                z = true;
            }
            Asserts.checkState(z);
            this.zzof.onDataRangeInserted(size2, 1);
        }
    }
        ...
        while (i < size) {
            if (!this.zzoe.contains(Integer.valueOf(i))) {
                ...
                if (t.equals(this.zzog.get(i))) {
                    ...
                    zzcl();
                    this.zzof.onDataRangeRemoved(i4, i5);
                    i3 -= i5;
                    i2 = 0;
                    i4 = -1;
                    i5 = i4;
    ...
    public final boolean setRaw(int i, T t) {
        this.zzog.set(i, t);
        boolean contains = this.zzoe.contains(Integer.valueOf(i)) ^ true;
        if (contains && this.zzof.hasObservers()) {
            int size = this.zzob.size();
