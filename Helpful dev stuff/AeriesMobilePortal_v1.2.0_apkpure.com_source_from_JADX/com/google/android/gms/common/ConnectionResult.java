...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzam)).add("resolution", this.zzan).add(SettingsJsonConstants.PROMPT_MESSAGE_KEY, this.zzao).toString();
    }
