        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0452R.drawable.common_full_open_on_phone, resources.getString(C0452R.string.common_open_on_phone), pendingIntent);
                } else {
