...
public class SSLCertificateSocketFactory extends SSLSocketFactory {
    ...
    private static void zza(Socket socket, int i) {
        ...
        if (socket != null) {
            try {
                ...
                stringBuilder = new StringBuilder(46 + String.valueOf(valueOf).length());
    ...
    private static void zza(Socket socket, PrivateKey privateKey) {
        ...
        if (socket != null) {
            try {
                ...
                valueOf = String.valueOf(socket.getClass());
                stringBuilder = new StringBuilder(43 + String.valueOf(valueOf).length());
                stringBuilder.append("Failed to invoke setChannelIdPrivateKey on ");
                stringBuilder.append(valueOf);
                throw new RuntimeException(stringBuilder.toString(), e);
            } catch (Throwable e2) {
                valueOf = String.valueOf(socket.getClass());
                stringBuilder = new StringBuilder(42 + String.valueOf(valueOf).length());
                stringBuilder.append(valueOf);
    ...
    private static void zza(Socket socket, byte[] bArr) {
        ...
        if (socket != null) {
            try {
                ...
                valueOf = String.valueOf(socket.getClass());
                stringBuilder = new StringBuilder(36 + String.valueOf(valueOf).length());
                stringBuilder.append("Failed to invoke setNpnProtocols on ");
                stringBuilder.append(valueOf);
                throw new RuntimeException(stringBuilder.toString(), e);
            } catch (Throwable e2) {
                valueOf = String.valueOf(socket.getClass());
                stringBuilder = new StringBuilder(35 + String.valueOf(valueOf).length());
                stringBuilder.append(valueOf);
    ...
    private static void zzb(Socket socket, byte[] bArr) {
        ...
        if (socket != null) {
            try {
                ...
                valueOf = String.valueOf(socket.getClass());
                stringBuilder = new StringBuilder(37 + String.valueOf(valueOf).length());
    ...
    public void setHostname(Socket socket, String str) {
        ...
        try {
            ...
            valueOf = String.valueOf(socket.getClass());
            stringBuilder = new StringBuilder(32 + String.valueOf(valueOf).length());
    ...
    public void setUseSessionTickets(Socket socket, boolean z) {
        ...
        try {
            ...
            valueOf = String.valueOf(socket.getClass());
            stringBuilder = new StringBuilder(41 + String.valueOf(valueOf).length());
            stringBuilder.append("Failed to invoke setUseSessionTickets on ");
            stringBuilder.append(valueOf);
            throw new RuntimeException(stringBuilder.toString(), e);
        } catch (Throwable e2) {
            valueOf = String.valueOf(socket.getClass());
            stringBuilder = new StringBuilder(40 + String.valueOf(valueOf).length());
            stringBuilder.append(valueOf);
