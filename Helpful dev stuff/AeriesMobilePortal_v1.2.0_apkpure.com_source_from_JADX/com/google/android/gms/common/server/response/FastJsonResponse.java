...
*/
    ...
    private static <O> boolean zzb(String str, O o) {
        ...
        if (Log.isLoggable("FastJsonResponse", 6)) {
            StringBuilder stringBuilder = new StringBuilder(58 + String.valueOf(str).length());
    ...
    protected Object getFieldValue(Field field) {
        ...
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder(4 + String.valueOf(outputFieldName).length());
