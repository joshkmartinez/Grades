...
import com.google.android.gms.base.C0452R;
import com.google.android.gms.common.C0454R;
...
*/
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C0452R.string.common_google_play_services_notification_channel_name);
    }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        switch (i) {
            case 1:
                i = C0452R.string.common_google_play_services_install_button;
                break;
            case 2:
                i = C0452R.string.common_google_play_services_update_button;
                break;
            case 3:
                i = C0452R.string.common_google_play_services_enable_button;
                break;
            default:
                i = 17039370;
                break;
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 9) {
            return resources.getString(C0452R.string.common_google_play_services_unsupported_text, new Object[]{appName});
        } else if (i == 20) {
            return zza(context, "common_google_play_services_restricted_profile_text", appName);
        } else {
            switch (i) {
                case 1:
                    return resources.getString(C0452R.string.common_google_play_services_install_text, new Object[]{appName});
                case 2:
                    if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                        return resources.getString(C0452R.string.common_google_play_services_wear_update_text);
                    }
                    return resources.getString(C0452R.string.common_google_play_services_update_text, new Object[]{appName});
                case 3:
                    return resources.getString(C0452R.string.common_google_play_services_enable_text, new Object[]{appName});
                default:
                    switch (i) {
                        case 16:
                        ...
                        case 18:
                            return resources.getString(C0452R.string.common_google_play_services_updating_text, new Object[]{appName});
                        default:
                            return resources.getString(C0454R.string.common_google_play_services_unknown_issue, new Object[]{appName});
                    }
            }
        }
    }
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return zzb == null ? context.getResources().getString(C0452R.string.common_google_play_services_notification_ticker) : zzb;
    }
    ...
    L_0x006b:
        return r1;
    L_0x006c:
        r3 = com.google.android.gms.base.C0452R.string.common_google_play_services_enable_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x0073:
        r3 = com.google.android.gms.base.C0452R.string.common_google_play_services_update_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x007a:
        r3 = com.google.android.gms.base.C0452R.string.common_google_play_services_install_title;
        r3 = r0.getString(r3);
        return r3;
    L_0x0081:
        r4 = "GoogleApiAvailability";
    ...
    private static String zza(Context context, String str, String str2) {
        ...
        if (zzb == null) {
            zzb = resources.getString(C0454R.string.common_google_play_services_unknown_issue);
        }
