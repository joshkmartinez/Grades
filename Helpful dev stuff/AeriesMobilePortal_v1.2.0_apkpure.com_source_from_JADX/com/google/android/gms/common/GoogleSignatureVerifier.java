...
public class GoogleSignatureVerifier {
    ...
    private final zzg zza(PackageInfo packageInfo) {
        ...
        if (packageInfo == null) {
            ...
            zzg zza = GoogleCertificates.zza(str2, com_google_android_gms_common_zzb, honorsDebugCertificates);
            if (!zza.zzbl || packageInfo.applicationInfo == null || (packageInfo.applicationInfo.flags & 2) == 0 || (honorsDebugCertificates && !GoogleCertificates.zza(str2, com_google_android_gms_common_zzb, false).zzbl)) {
                return zza;
            }
