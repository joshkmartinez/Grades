    ...
    public static zzcc zza(FragmentActivity fragmentActivity) {
        ...
        try {
            ...
            if (com_google_android_gms_common_api_internal_zzcc == null || com_google_android_gms_common_api_internal_zzcc.isRemoving()) {
                ...
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) com_google_android_gms_common_api_internal_zzcc, "SupportLifecycleFragmentImpl").commitAllowingStateLoss();
            }
