    ...
    private static void zza(SQLiteDatabase sQLiteDatabase, String str, String... strArr) {
            ...
            if (!"trigger".equals(str)) {
                ...
                while (query.moveToNext()) {
                    ...
                    if (!of.contains(string)) {
                        StringBuilder stringBuilder = new StringBuilder((8 + String.valueOf(str).length()) + String.valueOf(string).length());
        ...
        try {
            ...
            while (query.moveToNext()) {
                string = query.getString(0);
                if (!of.contains(string)) {
                    StringBuilder stringBuilder2 = new StringBuilder((8 + String.valueOf(str).length()) + String.valueOf(string).length());
