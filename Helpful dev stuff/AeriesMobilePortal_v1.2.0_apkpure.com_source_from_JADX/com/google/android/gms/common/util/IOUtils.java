...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.IOUtils.closeQuietly(android.os.ParcelFileDescriptor):void");
    }
...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.IOUtils.closeQuietly(java.io.Closeable):void");
    }

    public static void closeQuietly(@javax.annotation.Nullable java.net.ServerSocket r0) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.IOUtils.closeQuietly(java.net.ServerSocket):void");
    }

    public static void closeQuietly(@javax.annotation.Nullable java.net.Socket r0) {
        /* JADX: method processing error */
/*
Error: java.lang.NullPointerException
	at jadx.core.dex.visitors.regions.ProcessTryCatchRegions.searchTryCatchDominators(ProcessTryCatchRegions.java:75)
...
*/
    ...
    L_0x0005:
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.util.IOUtils.closeQuietly(java.net.Socket):void");
    }
...
*/
    ...
    L_0x0006:
        r0 = 0;
        r1 = new java.io.RandomAccessFile;	 Catch:{ all -> 0x002f }
        r2 = "rw";	 Catch:{ all -> 0x002f }
        r1.<init>(r5, r2);	 Catch:{ all -> 0x002f }
        r5 = r1.getChannel();	 Catch:{ all -> 0x002d }
        r2 = r5.lock();	 Catch:{ all -> 0x002d }
        r3 = 0;
        r5.truncate(r3);	 Catch:{ all -> 0x002a }
        if (r2 == 0) goto L_0x0026;
    L_0x001d:
        r5 = r2.isValid();
        if (r5 == 0) goto L_0x0026;
    L_0x0023:
        r2.release();	 Catch:{ IOException -> 0x0026 }
    L_0x0026:
        closeQuietly(r1);
        return;
    L_0x002a:
    ...
    L_0x0039:
        r0.release();	 Catch:{ IOException -> 0x003c }
    L_0x003c:
    ...
    private static byte[] zza(InputStream inputStream, long j) throws IOException {
        if (j > 2147483647L) {
            ...
            com_google_android_gms_common_util_IOUtils_zza.write(i);
