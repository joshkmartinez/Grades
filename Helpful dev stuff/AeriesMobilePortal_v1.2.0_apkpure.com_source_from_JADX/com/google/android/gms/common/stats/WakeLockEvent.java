...
public final class WakeLockEvent extends StatsEvent {
    ...
    public final String getSpecificString() {
        ...
        StringBuilder stringBuilder = new StringBuilder(((((45 + String.valueOf(wakeLockName).length()) + String.valueOf(join).length()) + String.valueOf(secondaryWakeLockName).length()) + String.valueOf(hostPackage).length()) + String.valueOf(codePackage).length());
