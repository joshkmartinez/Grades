...
public final class zzkq extends zzaby<zzkq> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzacc.equals(this.zzati, com_google_android_gms_internal_measurement_zzkq.zzati) || !zzacc.equals(this.zzatj, com_google_android_gms_internal_measurement_zzkq.zzatj)) {
            return false;
        }
        if (this.zzatk == null) {
        ...
        if (this.zzbww != null) {
            if (!this.zzbww.isEmpty()) {
                return this.zzbww.equals(com_google_android_gms_internal_measurement_zzkq.zzbww);
            }
        }
        if (com_google_android_gms_internal_measurement_zzkq.zzbww != null) {
            if (!com_google_android_gms_internal_measurement_zzkq.zzbww.isEmpty()) {
                return false;
            }
        }
        return true;
        ...
        while (true) {
            ...
            switch (zzuw) {
                ...
                case 18:
                    ...
                    length = this.zzati == null ? 0 : this.zzati.length;
                    obj = new zzkn[(zzuw + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzati, 0, obj, 0, length);
                    }
                ...
                case 26:
                    ...
                    length = this.zzatj == null ? 0 : this.zzatj.length;
                    obj = new zzks[(zzuw + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzatj, 0, obj, 0, length);
                    }
                    while (length < obj.length - 1) {
                        obj[length] = new zzks();
                        com_google_android_gms_internal_measurement_zzabv.zza(obj[length]);
                ...
                case 224:
                    ...
                    break;
                case 234:
                    zzuw = zzach.zzb(com_google_android_gms_internal_measurement_zzabv, 234);
                    length = this.zzaua == null ? 0 : this.zzaua.length;
                    obj = new zzkm[(zzuw + length)];
                    if (length != 0) {
                        System.arraycopy(this.zzaua, 0, obj, 0, length);
                    }
                    while (length < obj.length - 1) {
                        obj[length] = new zzkm();
                        com_google_android_gms_internal_measurement_zzabv.zza(obj[length]);
