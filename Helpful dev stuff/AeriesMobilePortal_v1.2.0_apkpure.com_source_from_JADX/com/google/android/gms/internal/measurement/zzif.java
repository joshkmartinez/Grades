...
public final class zzif extends zzhh {
    ...
    public static void zza(zzie com_google_android_gms_internal_measurement_zzie, Bundle bundle, boolean z) {
        if (bundle == null || com_google_android_gms_internal_measurement_zzie == null || (bundle.containsKey("_sc") && !z)) {
            if (bundle != null && com_google_android_gms_internal_measurement_zzie == null && z) {
                bundle.remove("_sn");
                bundle.remove("_sc");
                bundle.remove("_si");
            }
    ...
    private final zzie zze(@NonNull Activity activity) {
        ...
        zzie com_google_android_gms_internal_measurement_zzie2 = new zzie(null, zzca(activity.getClass().getCanonicalName()), zzgb().zzlb());
        this.zzaop.put(activity, com_google_android_gms_internal_measurement_zzie2);
        return com_google_android_gms_internal_measurement_zzie2;
    }
    ...
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        if (bundle != null) {
            ...
            if (bundle != null) {
                this.zzaop.put(activity, new zzie(bundle.getString("name"), bundle.getString("referrer_name"), bundle.getLong("id")));
            }
        }
    }
