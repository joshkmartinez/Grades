...
public final class zzach {
    ...
    public static final int zzb(zzabv com_google_android_gms_internal_measurement_zzabv, int i) throws IOException {
        int position = com_google_android_gms_internal_measurement_zzabv.getPosition();
        com_google_android_gms_internal_measurement_zzabv.zzak(i);
        int i2 = 1;
        while (com_google_android_gms_internal_measurement_zzabv.zzuw() == i) {
            com_google_android_gms_internal_measurement_zzabv.zzak(i);
            i2++;
        }
        com_google_android_gms_internal_measurement_zzabv.zzd(position, i);
        return i2;
    }
}
