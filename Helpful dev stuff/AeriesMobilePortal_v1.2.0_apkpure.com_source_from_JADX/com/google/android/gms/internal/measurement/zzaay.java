...
class zzaay<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    ...
    private final int zza(K k) {
        ...
        while (compareTo <= size) {
            ...
            int compareTo2 = k.compareTo((Comparable) ((zzabd) this.zzbty.get(i)).getKey());
            if (compareTo2 < 0) {
                size = i - 1;
    ...
    public boolean containsKey(Object obj) {
        ...
        if (zza(comparable) < 0) {
            if (!this.zzbtz.containsKey(comparable)) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode() {
        ...
        int i2 = 0;
        while (i < zzuj()) {
            i2 += ((zzabd) this.zzbty.get(i)).hashCode();
            i++;
        }
        return this.zzbtz.size() > 0 ? i2 + this.zzbtz.hashCode() : i2;
    }
    ...
    public final V zza(K k, V v) {
        ...
        this.zzbty.add(zza, new zzabd(this, k, v));
        return null;
    }
