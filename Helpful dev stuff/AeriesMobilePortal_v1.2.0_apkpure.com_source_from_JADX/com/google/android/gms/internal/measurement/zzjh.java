...
public final class zzjh extends zzhh {
    ...
    private final void zzaf(long j) {
        ...
        if (zzgf().zzakk.get()) {
            com_google_android_gms_internal_measurement_zzem = this.zzapv;
            j2 = zzgf().zzaki.get();
        } else {
            com_google_android_gms_internal_measurement_zzem = this.zzapw;
            j2 = 3600000;
        }
        com_google_android_gms_internal_measurement_zzem.zzh(Math.max(0, j2 - zzgf().zzakm.get()));
    }
