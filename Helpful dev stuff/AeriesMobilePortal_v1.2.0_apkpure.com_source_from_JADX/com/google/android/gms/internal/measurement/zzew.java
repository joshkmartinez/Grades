...
public final class zzew {
    ...
    public static zzex<Integer> zzagv = zzex.zzc("measurement.upload.max_conversions_per_day", HttpStatus.HTTP_INTERNAL_SERVER_ERROR, HttpStatus.HTTP_INTERNAL_SERVER_ERROR);
    ...
    static {
        ...
        str = "---";
        zzahq = zzex.zzd("measurement.test.string_flag", str, str);
    }
}
