...
public final class zzha extends zzfu<zzha> implements Cloneable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzbjf != com_google_android_gms_internal_clearcut_zzha.zzbjf || this.zzbjg != com_google_android_gms_internal_clearcut_zzha.zzbjg) {
            return false;
        }
        if (this.tag == null) {
        ...
        if (!zzfy.equals(this.zzbjm, com_google_android_gms_internal_clearcut_zzha.zzbjm) || !Arrays.equals(this.zzbjn, com_google_android_gms_internal_clearcut_zzha.zzbjn)) {
            return false;
        }
        if (this.zzbjo == null) {
        ...
        if (this.zzbkc != com_google_android_gms_internal_clearcut_zzha.zzbkc) {
            return false;
        }
        if (this.zzrj != null) {
            if (!this.zzrj.isEmpty()) {
                return this.zzrj.equals(com_google_android_gms_internal_clearcut_zzha.zzrj);
            }
        }
        if (com_google_android_gms_internal_clearcut_zzha.zzrj != null) {
            if (!com_google_android_gms_internal_clearcut_zzha.zzrj.isEmpty()) {
                return false;
            }
        }
        return true;
    ...
    public final int hashCode() {
        ...
        hashCode = (((((((hashCode * 31) + (com_google_android_gms_internal_clearcut_zzcg == null ? 0 : com_google_android_gms_internal_clearcut_zzcg.hashCode())) * 31) + Arrays.hashCode(this.zzbjp)) * 31) + (this.zzbjq == null ? 0 : this.zzbjq.hashCode())) * 31) + (this.zzbjr == null ? 0 : this.zzbjr.hashCode());
        zzgy com_google_android_gms_internal_clearcut_zzgy = this.zzbjs;
        hashCode = (((((hashCode * 31) + (com_google_android_gms_internal_clearcut_zzgy == null ? 0 : com_google_android_gms_internal_clearcut_zzgy.hashCode())) * 31) + (this.zzbjt == null ? 0 : this.zzbjt.hashCode())) * 31) + ((int) (this.zzbju ^ (this.zzbju >>> 32)));
        zzgz com_google_android_gms_internal_clearcut_zzgz = this.zzbjv;
        hashCode = (((((((((hashCode * 31) + (com_google_android_gms_internal_clearcut_zzgz == null ? 0 : com_google_android_gms_internal_clearcut_zzgz.hashCode())) * 31) + Arrays.hashCode(this.zzbjw)) * 31) + (this.zzbjx == null ? 0 : this.zzbjx.hashCode())) * 31) * 31) + zzfy.hashCode(this.zzbjz)) * 31;
        zzcg com_google_android_gms_internal_clearcut_zzcg2 = this.zzbkb;
        hashCode = ((hashCode * 31) + (com_google_android_gms_internal_clearcut_zzcg2 == null ? 0 : com_google_android_gms_internal_clearcut_zzcg2.hashCode())) * 31;
        if (this.zzbkc) {
            i2 = 1231;
        }
