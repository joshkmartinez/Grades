...
final class zzax {
        ...
        if ((i >>> 3) != 0) {
            ...
            switch (i4) {
                ...
                case 3:
                    ...
                    i4 = 0;
                    while (i2 < i3) {
                        i2 = zza(bArr, i2, com_google_android_gms_internal_clearcut_zzay);
                        i4 = com_google_android_gms_internal_clearcut_zzay.zzfd;
                        if (i4 != i) {
                            i2 = zza(i4, bArr, i2, i3, com_google_android_gms_internal_clearcut_zzay);
                        } else if (i2 > i3 && r0 == i) {
                            return i2;
                        } else {
                            throw zzco.zzbo();
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzcn<?> com_google_android_gms_internal_clearcut_zzcn_, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        while (true) {
            ...
            i2 = zza(bArr, zza, com_google_android_gms_internal_clearcut_zzay);
        }
        return i2;
    }
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzey com_google_android_gms_internal_clearcut_zzey, zzay com_google_android_gms_internal_clearcut_zzay) throws IOException {
        if ((i >>> 3) != 0) {
            ...
            if (i4 != 5) {
                switch (i4) {
                    case 0:
                        int zzb = zzb(bArr, i2, com_google_android_gms_internal_clearcut_zzay);
                    ...
                    case 2:
                        ...
                        com_google_android_gms_internal_clearcut_zzey.zzb(i, i3 == 0 ? zzbb.zzfi : zzbb.zzb(bArr, i2, i3));
                        return i2 + i3;
                    case 3:
                        zzey zzeb = zzey.zzeb();
                        int i5 = (i & -8) | 4;
                        ...
                        while (i2 < i3) {
                            int zza = zza(bArr, i2, com_google_android_gms_internal_clearcut_zzay);
                            i2 = com_google_android_gms_internal_clearcut_zzay.zzfd;
                            if (i2 != i5) {
                                i4 = i2;
                                i2 = zza(i2, bArr, zza, i3, zzeb, com_google_android_gms_internal_clearcut_zzay);
                            } else {
                                i4 = i2;
                                i2 = zza;
                                if (i2 <= i3 || r0 != i5) {
    ...
    static int zza(int i, byte[] bArr, int i2, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        if (b >= (byte) 0) {
                ...
                if (b >= (byte) 0) {
                    ...
                    if (b2 >= (byte) 0) {
                        ...
                        while (true) {
                            i4 = i2 + 1;
                            if (bArr[i2] >= (byte) 0) {
                                com_google_android_gms_internal_clearcut_zzay.zzfd = i;
                                return i4;
                            }
                            i2 = i4;
                        }
            ...
            com_google_android_gms_internal_clearcut_zzay.zzfd = i | i3;
            return i2;
        }
        com_google_android_gms_internal_clearcut_zzay.zzfd = i | i3;
        return i4;
    ...
    static int zza(byte[] bArr, int i, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        i = bArr[i];
        if (i < (byte) 0) {
            return zza(i, bArr, i2, com_google_android_gms_internal_clearcut_zzay);
        }
        com_google_android_gms_internal_clearcut_zzay.zzfd = i;
        return i2;
    }
    ...
    static int zza(byte[] bArr, int i, zzcn<?> com_google_android_gms_internal_clearcut_zzcn_, zzay com_google_android_gms_internal_clearcut_zzay) throws IOException {
        zzch com_google_android_gms_internal_clearcut_zzch = (zzch) com_google_android_gms_internal_clearcut_zzcn_;
        i = zza(bArr, i, com_google_android_gms_internal_clearcut_zzay);
        int i2 = com_google_android_gms_internal_clearcut_zzay.zzfd + i;
        while (i < i2) {
            i = zza(bArr, i, com_google_android_gms_internal_clearcut_zzay);
            com_google_android_gms_internal_clearcut_zzch.zzac(com_google_android_gms_internal_clearcut_zzay.zzfd);
        }
    ...
    static int zzb(byte[] bArr, int i, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        com_google_android_gms_internal_clearcut_zzay.zzfe = j3;
        return i;
    }
    ...
    static int zzc(byte[] bArr, int i, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        com_google_android_gms_internal_clearcut_zzay.zzff = new String(bArr, i, i2, zzci.UTF_8);
        return i + i2;
    }
    ...
    static int zze(byte[] bArr, int i, zzay com_google_android_gms_internal_clearcut_zzay) {
        ...
        com_google_android_gms_internal_clearcut_zzay.zzff = zzbb.zzb(bArr, i, i2);
        return i + i2;
    }
