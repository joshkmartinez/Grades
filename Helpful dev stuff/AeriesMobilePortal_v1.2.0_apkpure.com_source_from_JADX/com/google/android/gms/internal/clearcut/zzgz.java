...
public final class zzgz extends zzfu<zzgz> implements Cloneable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (!zzfy.zza(this.zzbjd, com_google_android_gms_internal_clearcut_zzgz.zzbjd)) {
            return false;
        }
        if (this.zzrj != null) {
            if (!this.zzrj.isEmpty()) {
                return this.zzrj.equals(com_google_android_gms_internal_clearcut_zzgz.zzrj);
            }
        }
        if (com_google_android_gms_internal_clearcut_zzgz.zzrj != null) {
            if (!com_google_android_gms_internal_clearcut_zzgz.zzrj.isEmpty()) {
                return false;
            }
        }
        return true;
