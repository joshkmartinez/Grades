    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzrj != null) {
            if (!this.zzrj.isEmpty()) {
                return this.zzrj.equals(com_google_android_gms_internal_clearcut_zzhb.zzrj);
            }
        }
        if (com_google_android_gms_internal_clearcut_zzhb.zzrj != null) {
            if (!com_google_android_gms_internal_clearcut_zzhb.zzrj.isEmpty()) {
                return false;
            }
        }
        return true;
