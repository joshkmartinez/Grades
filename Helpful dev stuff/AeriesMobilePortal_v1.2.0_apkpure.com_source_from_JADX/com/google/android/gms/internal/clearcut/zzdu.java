...
final class zzdu<T> implements zzef<T> {
    ...
    public final void zza(T t, zzfr com_google_android_gms_internal_clearcut_zzfr) throws IOException {
        ...
        while (it.hasNext()) {
            ...
            if (entry instanceof zzct) {
                zzc = com_google_android_gms_internal_clearcut_zzca.zzc();
                zzr = ((zzct) entry).zzbs().zzr();
            } else {
                zzc = com_google_android_gms_internal_clearcut_zzca.zzc();
                zzr = entry.getValue();
            }
            com_google_android_gms_internal_clearcut_zzfr.zza(zzc, zzr);
        }
    ...
    public final int zzm(T t) {
        zzex com_google_android_gms_internal_clearcut_zzex = this.zzmx;
        int zzr = 0 + com_google_android_gms_internal_clearcut_zzex.zzr(com_google_android_gms_internal_clearcut_zzex.zzq(t));
