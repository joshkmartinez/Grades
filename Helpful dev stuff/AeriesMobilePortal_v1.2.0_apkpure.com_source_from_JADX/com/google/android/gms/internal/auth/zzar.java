...
final class zzar extends zzav<Status> {
    ...
    zzar(zzao com_google_android_gms_internal_auth_zzao, GoogleApiClient googleApiClient, Credential credential) {
    ...
    protected final void zzd(Context context, zzbc com_google_android_gms_internal_auth_zzbc) throws RemoteException {
        com_google_android_gms_internal_auth_zzbc.zzd(new zzau(this), new zzbe(this.zzdt));
    }
}
