...
public final class ClearcutLogger {
    ...
    public class LogEventBuilder {
        ...
        private LogEventBuilder(ClearcutLogger clearcutLogger, byte[] bArr, zzb com_google_android_gms_clearcut_ClearcutLogger_zzb) {
        ...
        public void log() {
            ...
            this.zzab = true;
            zze com_google_android_gms_clearcut_zze = new zze(new zzr(this.zzac.packageName, this.zzac.zzi, this.zzk, this.zzj, this.zzl, this.zzm, this.zzac.zzn, this.zzo), this.zzaa, null, null, ClearcutLogger.zza(null), null, ClearcutLogger.zza(null), null, null, this.zzz);
            if (this.zzac.zzs.zza(com_google_android_gms_clearcut_zze)) {
                this.zzac.zzp.zzb(com_google_android_gms_clearcut_zze);
            } else {
    ...
    public interface zza {
        boolean zza(zze com_google_android_gms_clearcut_zze);
    }
