...
public final class zze extends AbstractSafeParcelable {
    ...
    public zze(zzr com_google_android_gms_internal_clearcut_zzr, zzha com_google_android_gms_internal_clearcut_zzha, zzb com_google_android_gms_clearcut_ClearcutLogger_zzb, zzb com_google_android_gms_clearcut_ClearcutLogger_zzb2, int[] iArr, String[] strArr, int[] iArr2, byte[][] bArr, ExperimentTokens[] experimentTokensArr, boolean z) {
        this.zzag = com_google_android_gms_internal_clearcut_zzr;
        this.zzaa = com_google_android_gms_internal_clearcut_zzha;
        this.zzt = com_google_android_gms_clearcut_ClearcutLogger_zzb;
        this.zzan = null;
        this.zzai = iArr;
        this.zzaj = null;
        this.zzak = iArr2;
    ...
    public final String toString() {
        ...
        stringBuilder.append(this.zzah == null ? null : new String(this.zzah));
