...
public class zzg {
    ...
    private static <T> T zzd(Context context, ComponentName componentName, zzm<T> com_google_android_gms_auth_zzm_T) throws IOException, GoogleAuthException {
        ...
        if (instance.bindService(componentName, blockingServiceConnection, "GoogleAuthUtil")) {
            try {
                T zze = com_google_android_gms_auth_zzm_T.zze(blockingServiceConnection.getService());
                instance.unbindService(componentName, blockingServiceConnection, "GoogleAuthUtil");
                return zze;
            } catch (Throwable e) {
                zzq.m49i("GoogleAuthUtil", "Error on service connection.", e);
    ...
    private static <T> T zzd(T t) throws IOException {
        ...
        zzq.m53w("GoogleAuthUtil", "Binder call returned null.");
        throw new IOException("Service unavailable.");
    }

    public static TokenData zze(Context context, Account account, String str, Bundle bundle) throws IOException, UserRecoverableAuthException, GoogleAuthException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
        ...
        return (TokenData) zzd(context, zzp, new zzh(account, str, bundle));
    }
