...
*/
    ...
    L_0x0037:
        r9 = move-exception;
    L_0x0038:
        r4 = io.fabric.sdk.android.Fabric.getLogger();	 Catch:{ all -> 0x0035 }
        r5 = "Beta";	 Catch:{ all -> 0x0035 }
        r6 = "Failed to read the APK file";	 Catch:{ all -> 0x0035 }
        r4.mo2304e(r5, r6, r9);	 Catch:{ all -> 0x0035 }
    ...
    L_0x0057:
        ...
        goto L_0x0078;
    L_0x005b:
        r9 = io.fabric.sdk.android.Fabric.getLogger();	 Catch:{ all -> 0x0035 }
        r4 = "Beta";	 Catch:{ all -> 0x0035 }
        r5 = "Beta by Crashlytics app is not installed";	 Catch:{ all -> 0x0035 }
        r9.mo2301d(r4, r5);	 Catch:{ all -> 0x0035 }
        if (r3 == 0) goto L_0x0078;
    L_0x0068:
        r3.close();	 Catch:{ IOException -> 0x006c }
        goto L_0x0078;
    ...
    L_0x0078:
        ...
        r0 = r0 / r3;
        r9 = io.fabric.sdk.android.Fabric.getLogger();
        r3 = "Beta";
