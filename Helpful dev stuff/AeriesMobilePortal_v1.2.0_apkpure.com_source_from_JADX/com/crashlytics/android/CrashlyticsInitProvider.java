...
*/
    ...
    L_0x0015:
        ...
        io.fabric.sdk.android.Fabric.with(r0, r3);	 Catch:{ IllegalStateException -> 0x002e }
        r0 = io.fabric.sdk.android.Fabric.getLogger();	 Catch:{ IllegalStateException -> 0x002e }
        ...
        r0.mo2306i(r3, r4);	 Catch:{ IllegalStateException -> 0x002e }
        goto L_0x003a;
    L_0x002e:
    ...
    boolean shouldInitializeFabric(Context context, FirebaseInfo firebaseInfo, EnabledCheckStrategy enabledCheckStrategy) {
        return (firebaseInfo.isFirebaseCrashlyticsEnabled(context) == null || enabledCheckStrategy.isCrashlyticsEnabled(context) == null) ? null : true;
    }
}
