...
class BackgroundManager {
    ...
    public void onActivityPaused() {
        if (this.flushOnBackground && !this.inBackground) {
            ...
            try {
                this.backgroundFutureRef.compareAndSet(null, this.executorService.schedule(new C03701(), 5000, TimeUnit.MILLISECONDS));
            } catch (Throwable e) {
                Fabric.getLogger().mo2302d(Answers.TAG, "Failed to schedule background detector", e);
            }
        }
    }
}
