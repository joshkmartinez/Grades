...
public class Crashlytics extends Kit<Void> implements KitGroup {
    ...
    public void setDebugMode(boolean z) {
        Fabric.getLogger().mo2314w(TAG, "Use of Crashlytics.setDebugMode is deprecated.");
    }

    @Deprecated
    public boolean getDebugMode() {
        Fabric.getLogger().mo2314w(TAG, "Use of Crashlytics.getDebugMode is deprecated.");
        getFabric();
    ...
    public static void setPinningInfoProvider(PinningInfoProvider pinningInfoProvider) {
        Fabric.getLogger().mo2314w(TAG, "Use of Crashlytics.setPinningInfoProvider is deprecated");
    }
