...
class CrashlyticsUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable th) {
        ...
        try {
            ...
            Fabric.getLogger().mo2304e(CrashlyticsCore.TAG, "An error occurred in the uncaught exception handler", e);
        } catch (Throwable th2) {
            Fabric.getLogger().mo2301d(CrashlyticsCore.TAG, "Crashlytics completed exception processing. Invoking default exception handler.");
