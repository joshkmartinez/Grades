...
class AppData {
    ...
    public static AppData create(Context context, IdManager idManager, String str, String str2) throws NameNotFoundException {
        ...
        return new AppData(str, str2, installerPackageName, packageName, Integer.toString(context.versionCode), context.versionName == null ? IdManager.DEFAULT_VERSION_NAME : context.versionName);
    }
