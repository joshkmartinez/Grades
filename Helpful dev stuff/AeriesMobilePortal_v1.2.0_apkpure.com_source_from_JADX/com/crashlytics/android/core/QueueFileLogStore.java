...
class QueueFileLogStore implements FileLogStore {
    ...
    private LogBytes getLogBytes() {
        ...
        try {
            ...
            Fabric.getLogger().mo2304e(CrashlyticsCore.TAG, "A problem occurred while reading the Crashlytics log file.", e);
        }
    ...
    private void doWriteToLog(long j, String str) {
        if (this.logFile != null) {
            ...
            try {
                ...
                Fabric.getLogger().mo2304e(CrashlyticsCore.TAG, "There was a problem writing to the Crashlytics log.", j2);
            }
        }
    }
}
