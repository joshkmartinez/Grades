...
*/
        ...
        L_0x000f:
            ...
            com.facebook.stetho.common.LogUtil.m30w(r1, r2);	 Catch:{ all -> 0x000d }
            goto L_0x0007;
        L_0x001c:
            return;
        L_0x001d:
...
*/
        ...
        r0.append(r4);
        r0 = r0.toString();
        com.facebook.stetho.common.LogUtil.m21i(r0);
    L_0x001a:
    ...
    L_0x0059:
        ...
        com.facebook.stetho.common.LogUtil.m31w(r0, r1);
        goto L_0x006e;
    L_0x0060:
        r0 = move-exception;
    ...
    L_0x006e:
        ...
        r0.append(r4);
        r4 = r0.toString();
        com.facebook.stetho.common.LogUtil.m21i(r4);
        return;
        */
    ...
    private static LocalServerSocket bindToSocket(String str) throws IOException {
        ...
        while (true) {
            try {
                ...
                LogUtil.m31w(e, "Binding error, sleep 1000 ms...");
                if (th == null) {
                    th = e;
                }
        ...
        if (LogUtil.isLoggable(3)) {
            ...
            LogUtil.m13d(stringBuilder.toString());
        }
