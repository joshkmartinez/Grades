...
public class DOM implements ChromeDevtoolsDomain {
    ...
    private static class RGBAColor {
        ...
        public int getColor() {
            ...
            if (this.f16a != null) {
                byte b;
                long round = Math.round(this.f16a.doubleValue() * 255.0d);
                if (round < 0) {
                    b = (byte) 0;
                } else if (round < 255) {
                    b = (byte) ((int) round);
            ...
            return Color.argb(i, this.f19r, this.f18g, this.f17b);
        }
    }
    ...
    class C08651 implements UncheckedCallable<Node> {
        C08651() {
        }
    ...
    private final class DocumentUpdateListener implements UpdateListener {
        ...
        public void onInspectRequested(Object obj) {
            ...
            if (nodeIdForElement == null) {
                LogUtil.m14d("DocumentProvider.Listener.onInspectRequested() called for a non-mapped node: element=%s", obj);
                return;
            }
    ...
    public JsonRpcResult getDocument(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        jsonRpcPeer.root = (Node) this.mDocument.postAndWait(new C08651());
        return jsonRpcPeer;
    }
    ...
    public void highlightNode(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (highlightNodeRequest.nodeId == null) {
            LogUtil.m29w("DOM.highlightNode was not given a nodeId; JS objectId is not supported");
            return;
        }
        jSONObject = highlightNodeRequest.highlightConfig.contentColor;
        if (jSONObject == null) {
            LogUtil.m29w("DOM.highlightNode was not given a color to highlight with");
        } else {
    ...
    public void hideHighlight(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        this.mDocument.postAndWait((Runnable) new C04313());
    }
    ...
    public GetSearchResultsResponse getSearchResults(JsonRpcPeer jsonRpcPeer, JSONObject jSONObject) {
        ...
        if (getSearchResultsRequest.searchId == null) {
            LogUtil.m29w("searchId may not be null");
            return null;
        }
        ...
        if (list == null) {
            ...
            LogUtil.m29w(jSONObject.toString());
            return null;
        }
