...
public class ChromeDevtoolsServer implements SimpleEndpoint {
    ...
    static /* synthetic */ class C04121 {
        static final /* synthetic */ int[] f15x978b462 = new int[ErrorCode.values().length];
...
*/
            ...
            r0 = new int[r0];
            f15x978b462 = r0;
            r0 = f15x978b462;	 Catch:{ NoSuchFieldError -> 0x0014 }
    ...
    public void onClose(SimpleSession simpleSession, int i, String str) {
        ...
        LogRedirector.m3d(str2, stringBuilder.toString());
    ...
    public void onMessage(SimpleSession simpleSession, byte[] bArr, int i) {
        ...
        bArr.append(i);
        LogRedirector.m3d(simpleSession, bArr.toString());
    }
    ...
    public void onMessage(SimpleSession simpleSession, String str) {
        ...
        if (LogRedirector.isLoggable(TAG, 2)) {
            ...
            stringBuilder.append(str);
            LogRedirector.m9v(str3, stringBuilder.toString());
        }
        try {
            ...
            if (LogRedirector.isLoggable(TAG, 2)) {
                ...
                LogRedirector.m9v(str2, stringBuilder.toString());
            }
            closeSafely(simpleSession, 1011, str4.getClass().getSimpleName());
        } catch (String str42) {
            str2 = TAG;
            stringBuilder = new StringBuilder();
            stringBuilder.append("Message could not be processed by implementation: ");
            stringBuilder.append(str42);
            LogRedirector.m7i(str2, stringBuilder.toString());
            closeSafely(simpleSession, 1011, str42.getClass().getSimpleName());
        } catch (String str422) {
            LogRedirector.m10v(TAG, "Unexpected JSON exception processing message", str422);
            closeSafely(simpleSession, 1011, str422.getClass().getSimpleName());
        }
    }
    ...
    private static void logDispatchException(JsonRpcException jsonRpcException) {
        ...
        if (C04121.f15x978b462[errorMessage.code.ordinal()] != 1) {
            LogRedirector.m12w(TAG, "Error processing remote message", jsonRpcException);
            return;
        }
        ...
        LogRedirector.m3d(jsonRpcException, stringBuilder.toString());
    }
    ...
    public void onError(SimpleSession simpleSession, Throwable th) {
        ...
        LogRedirector.m5e(simpleSession, stringBuilder.toString());
    }
}
