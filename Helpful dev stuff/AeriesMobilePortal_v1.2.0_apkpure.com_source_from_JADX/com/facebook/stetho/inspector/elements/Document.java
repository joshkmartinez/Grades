...
public final class Document extends ThreadBoundProxy {
    ...
    private void init() {
        ...
        this.mDocumentProvider.postAndWait(new C04151());
    }

    private void cleanUp() {
        this.mDocumentProvider.postAndWait(new C04162());
            ...
            while (!this.mCachedUpdateQueue.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    if (obj != null) {
                        ...
                        LogUtil.m18e("%s.getChildren() emitted a null child at position %s for element %s", nodeDescriptor.getClass().getName(), Integer.toString(i), remove);
    ...
    private void applyDocumentUpdate(final Update update) {
        ...
        update.getChangedElements(new Accumulator<Object>() {
            private Accumulator<Object> insertedElements = new C08531();
            private final HashSet<Object> listenerInsertedElements = new HashSet();

            class C08531 implements Accumulator<Object> {
                C08531() {
                }

                public void store(Object obj) {
                    if (update.isElementChanged(obj)) {
                        C08545.this.listenerInsertedElements.add(obj);
                    }
                }
            }
