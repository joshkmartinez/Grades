...
public class DOMStoragePeerManager extends ChromePeerManager {
    ...
    private final PeerRegistrationListener mPeerListener = new C09661();
    ...
    private class DevToolsSharedPreferencesListener implements OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
            ...
            if (containsKey && containsKey2) {
                ...
                LogUtil.m22i("Detected rapid put/remove of %s", str);
            }
        }
    }

    class C09661 extends PeersRegisteredListener {
