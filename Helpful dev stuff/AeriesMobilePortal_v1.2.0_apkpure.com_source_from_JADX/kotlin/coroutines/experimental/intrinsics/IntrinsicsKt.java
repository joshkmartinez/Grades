...
import kotlin.coroutines.experimental.intrinsics.IntrinsicsKt$createCoroutineUnchecked$.inlined.buildContinuationByInvokeCall.1;
import kotlin.coroutines.experimental.intrinsics.IntrinsicsKt$createCoroutineUnchecked$.inlined.buildContinuationByInvokeCall.2;
...
public final class IntrinsicsKt {
    ...
    public static final <T> Continuation<Unit> createCoroutineUnchecked(@NotNull Function1<? super Continuation<? super T>, ? extends Object> function1, @NotNull Continuation<? super T> continuation) {
        ...
        return CoroutineIntrinsics.interceptContinuationIfNeeded(continuation.getContext(), new 1(continuation, function1, continuation));
    }
    ...
    public static final <R, T> Continuation<Unit> createCoroutineUnchecked(@NotNull Function2<? super R, ? super Continuation<? super T>, ? extends Object> function2, R r, @NotNull Continuation<? super T> continuation) {
        ...
        return CoroutineIntrinsics.interceptContinuationIfNeeded(continuation.getContext(), new 2(continuation, function2, r, continuation));
    }
    ...
    private static final <T> Continuation<Unit> buildContinuationByInvokeCall(Continuation<? super T> continuation, Function0<? extends Object> function0) {
        return CoroutineIntrinsics.interceptContinuationIfNeeded(continuation.getContext(), new 1(continuation, function0));
    }
}
