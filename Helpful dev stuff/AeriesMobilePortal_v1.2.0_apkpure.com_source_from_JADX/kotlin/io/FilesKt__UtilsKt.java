...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String getInvariantSeparatorsPath(@NotNull File file) {
        ...
        if (File.separatorChar != '/') {
            ...
            return StringsKt.replace$default(path, File.separatorChar, '/', false, 4, null);
        }
        file = file.getPath();
    ...
    public static final String getNameWithoutExtension(@NotNull File file) {
        ...
        file = file.getName();
        Intrinsics.checkExpressionValueIsNotNull(file, "name");
        return StringsKt.substringBeforeLast$default(file, ".", null, 2, null);
    }

    @NotNull
    public static final String toRelativeString(@NotNull File file, @NotNull File file2) {
        Intrinsics.checkParameterIsNotNull(file, "$receiver");
        Intrinsics.checkParameterIsNotNull(file2, BuildConfig.FLAVOR);
...
*/
    ...
    L_0x0089:
        r4 = r1;	 Catch:{ TerminateException -> 0x00e7 }
    ...
    L_0x0098:
        r4 = r2;	 Catch:{ TerminateException -> 0x00e7 }
        goto L_0x00a1;	 Catch:{ TerminateException -> 0x00e7 }
    L_0x009a:
    ...
    L_0x00bf:
        ...
        r8 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1));	 Catch:{ TerminateException -> 0x00e7 }
        if (r8 == 0) goto L_0x0043;	 Catch:{ TerminateException -> 0x00e7 }
    L_0x00d4:
    ...
    public static final File resolve(@NotNull File file, @NotNull File file2) {
        ...
        if (!(charSequence.length() == 0)) {
            if (!StringsKt.endsWith$default(charSequence, File.separatorChar, false, 2, null)) {
