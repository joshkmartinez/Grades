...
class FilesKt__FilePathComponentsKt {
    private static final int getRootLength$FilesKt__FilePathComponentsKt(@NotNull String str) {
        ...
        int indexOf$default = StringsKt.indexOf$default(charSequence, File.separatorChar, 0, false, 4, null);
        if (indexOf$default == 0) {
            if (str.length() > 1 && str.charAt(1) == File.separatorChar) {
                indexOf$default = StringsKt.indexOf$default(charSequence, File.separatorChar, 2, false, 4, null);
                if (indexOf$default >= 0) {
                    int i = indexOf$default + 1;
                    indexOf$default = StringsKt.indexOf$default(charSequence, File.separatorChar, i, false, 4, null);
                    if (indexOf$default >= 0) {
            ...
            if (indexOf$default == -1 && StringsKt.endsWith$default(charSequence, ':', false, 2, null)) {
                return str.length();
            }
            return 0;
        }
    ...
    public static final FilePathComponents toComponents(@NotNull File file) {
        ...
        if ((charSequence.length() == null ? 1 : null) != null) {
            ...
            Iterable<String> split$default = StringsKt.split$default(charSequence, new char[]{File.separatorChar}, false, 0, 6, null);
