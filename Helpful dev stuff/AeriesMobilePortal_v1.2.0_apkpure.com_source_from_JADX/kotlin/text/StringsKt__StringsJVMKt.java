...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(@NotNull String str, char c, char c2, boolean z) {
        ...
        if (z) {
            return SequencesKt.joinToString$default(StringsKt.splitToSequence$default(str2, new char[]{c}, z, 0, 4, null), String.valueOf(c2), null, null, 0, null, null, 62, null);
        }
    ...
    public static final String replace(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        ...
        return SequencesKt.joinToString$default(StringsKt.splitToSequence$default(str4, new String[]{str5}, z, 0, 4, null), str6, null, null, 0, null, null, 62, null);
    }
    ...
    public static final String replaceFirst(@NotNull String str, char c, char c2, boolean z) {
        ...
        c = StringsKt.indexOf$default(charSequence, c, 0, z, 2, null);
        return c < '\u0000' ? str : StringsKt.replaceRange(charSequence, c, c + 1, String.valueOf(c2)).toString();
    }
    ...
    public static final String replaceFirst(@NotNull String str, @NotNull String str2, @NotNull String str3, boolean z) {
        ...
        CharSequence charSequence = str;
        z = StringsKt.indexOf$default(charSequence, str2, 0, z, 2, null);
        return z >= false ? str : StringsKt.replaceRange(charSequence, z, str2.length() + z, str3).toString();
    }
    ...
    public static final List<String> split(@NotNull CharSequence charSequence, @NotNull Pattern pattern, int i) {
        ...
        if ((i >= 0 ? 1 : null) != null) {
            ...
            return ArraysKt.asList(charSequence);
        }
