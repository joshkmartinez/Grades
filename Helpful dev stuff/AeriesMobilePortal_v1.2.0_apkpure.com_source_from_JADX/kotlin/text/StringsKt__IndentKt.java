...
class StringsKt__IndentKt {
        ...
        if ((StringsKt.isBlank(str5) ^ 1) != 0) {
            ...
            for (Object obj : lines) {
                ...
                if ((i == 0 || i == lastIndex) && StringsKt.isBlank((CharSequence) obj2)) {
                    ...
                    if (i3 != -1) {
                        int i5 = i3;
                        if (StringsKt.startsWith$default(obj2, str3, i3, false, 4, null)) {
                            i3 = i5 + str3.length();
                            if (obj2 != null) {
    ...
    public static final String prependIndent(@NotNull String str, @NotNull String str2) {
        ...
        return SequencesKt.joinToString$default(SequencesKt.map(StringsKt.lineSequence(str), new 1(str2)), "\n", null, null, 0, null, null, 62, null);
    }
