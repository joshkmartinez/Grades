...
class StringsKt__StringsKt extends StringsKt__StringsJVMKt {
    ...
    public static final String padStart(@NotNull String str, int i, char c) {
        Intrinsics.checkParameterIsNotNull(str, "$receiver");
        return StringsKt.padStart(str, i, c).toString();
    }
    ...
    public static final String padEnd(@NotNull String str, int i, char c) {
        Intrinsics.checkParameterIsNotNull(str, "$receiver");
        return StringsKt.padEnd(str, i, c).toString();
    }
    ...
    private static final boolean isNotBlank(@NotNull CharSequence charSequence) {
        return StringsKt.isBlank(charSequence) ^ 1;
    }
    ...
    public static final String substringBefore(@NotNull String str, char c, @NotNull String str2) {
        ...
        c = StringsKt.indexOf$default(str, c, 0, false, 6, null);
        if (c == '￿') {
            return str2;
        }
    ...
    public static final String substringBefore(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        ...
        str2 = StringsKt.indexOf$default(str, str2, 0, false, 6, null);
        if (str2 == -1) {
            return str3;
        }
    ...
    public static final String substringAfter(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        ...
        Intrinsics.checkParameterIsNotNull(str2, "delimiter");
        Intrinsics.checkParameterIsNotNull(str3, "missingDelimiterValue");
        int indexOf$default = StringsKt.indexOf$default(str, str2, 0, false, 6, null);
    ...
    public static final String substringBeforeLast(@NotNull String str, char c, @NotNull String str2) {
        Intrinsics.checkParameterIsNotNull(str, "$receiver");
        Intrinsics.checkParameterIsNotNull(str2, "missingDelimiterValue");
        c = StringsKt.lastIndexOf$default(str, c, 0, false, 6, null);
        if (c == '￿') {
            return str2;
        }
        str2 = str.substring(null, c);
    ...
    public static final String substringBeforeLast(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        ...
        Intrinsics.checkParameterIsNotNull(str2, "delimiter");
        Intrinsics.checkParameterIsNotNull(str3, "missingDelimiterValue");
        str2 = StringsKt.lastIndexOf$default(str, str2, 0, false, 6, null);
        if (str2 == -1) {
            return str3;
        }
        str3 = str.substring(null, str2);
    ...
    public static final String substringAfterLast(@NotNull String str, @NotNull String str2, @NotNull String str3) {
        ...
        Intrinsics.checkParameterIsNotNull(str2, "delimiter");
        Intrinsics.checkParameterIsNotNull(str3, "missingDelimiterValue");
        int lastIndexOf$default = StringsKt.lastIndexOf$default(str, str2, 0, false, 6, null);
    ...
    public static final String removePrefix(@NotNull String str, @NotNull CharSequence charSequence) {
        ...
        if (!StringsKt.startsWith$default(str, charSequence, false, 2, null)) {
            return str;
        }
    ...
    public static final String removeSuffix(@NotNull String str, @NotNull CharSequence charSequence) {
        ...
        if (!StringsKt.endsWith$default(str, charSequence, false, 2, null)) {
            return str;
        }
    ...
    public static final String removeSurrounding(@NotNull String str, @NotNull CharSequence charSequence, @NotNull CharSequence charSequence2) {
        ...
        if (str.length() >= charSequence.length() + charSequence2.length()) {
            ...
            if (StringsKt.startsWith$default(charSequence3, charSequence, false, 2, null) && StringsKt.endsWith$default(charSequence3, charSequence2, false, 2, null)) {
    ...
    public static final String replaceBefore(@NotNull String str, char c, @NotNull String str2, @NotNull String str3) {
        ...
        Intrinsics.checkParameterIsNotNull(str3, "missingDelimiterValue");
        CharSequence charSequence = str;
        c = StringsKt.indexOf$default(charSequence, c, 0, false, 6, null);
        return c == '￿' ? str3 : StringsKt.replaceRange(charSequence, null, c, str2).toString();
    }
    ...
    public static final String replaceBefore(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4) {
        ...
        CharSequence charSequence = str;
        str2 = StringsKt.indexOf$default(charSequence, str2, 0, false, 6, null);
        return str2 == -1 ? str4 : StringsKt.replaceRange(charSequence, null, str2, str3).toString();
    }
    ...
    public static final String replaceAfter(@NotNull String str, char c, @NotNull String str2, @NotNull String str3) {
        ...
        CharSequence charSequence = str;
        c = StringsKt.indexOf$default(charSequence, c, 0, false, 6, null);
        return c == '￿' ? str3 : StringsKt.replaceRange(charSequence, c + 1, str.length(), str2).toString();
    }
    ...
    public static final String replaceAfter(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4) {
        ...
        Intrinsics.checkParameterIsNotNull(str4, "missingDelimiterValue");
        CharSequence charSequence = str;
        int indexOf$default = StringsKt.indexOf$default(charSequence, str2, 0, false, 6, null);
    ...
    public static final String replaceAfterLast(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4) {
        ...
        Intrinsics.checkParameterIsNotNull(str4, "missingDelimiterValue");
        CharSequence charSequence = str;
        int lastIndexOf$default = StringsKt.lastIndexOf$default(charSequence, str2, 0, false, 6, null);
    ...
    public static final String replaceAfterLast(@NotNull String str, char c, @NotNull String str2, @NotNull String str3) {
        ...
        Intrinsics.checkParameterIsNotNull(str3, "missingDelimiterValue");
        CharSequence charSequence = str;
        c = StringsKt.lastIndexOf$default(charSequence, c, 0, false, 6, null);
        return c == '￿' ? str3 : StringsKt.replaceRange(charSequence, c + 1, str.length(), str2).toString();
    }
    ...
    public static final String replaceBeforeLast(@NotNull String str, @NotNull String str2, @NotNull String str3, @NotNull String str4) {
        ...
        Intrinsics.checkParameterIsNotNull(str4, "missingDelimiterValue");
        CharSequence charSequence = str;
        str2 = StringsKt.lastIndexOf$default(charSequence, str2, 0, false, 6, null);
        return str2 == -1 ? str4 : StringsKt.replaceRange(charSequence, null, str2, str3).toString();
    }
    ...
    public static final boolean startsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkParameterIsNotNull(charSequence, "$receiver");
        return charSequence.length() > 0 && CharsKt.equals(charSequence.charAt(0), c, z) != null;
    }
    ...
    public static final boolean endsWith(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkParameterIsNotNull(charSequence, "$receiver");
        return (charSequence.length() <= 0 || CharsKt.equals(charSequence.charAt(StringsKt.getLastIndex(charSequence)), c, z) == null) ? null : true;
    }
    ...
    public static final String commonPrefixWith(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, boolean z) {
        ...
        z = i - 1;
        if (StringsKt.hasSurrogatePairAt(charSequence, z) || StringsKt.hasSurrogatePairAt(charSequence2, z) != null) {
            i--;
        }
    ...
    public static final String commonSuffixWith(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, boolean z) {
        ...
        if (StringsKt.hasSurrogatePairAt(charSequence, (length - i) - 1) || StringsKt.hasSurrogatePairAt(charSequence2, (length2 - i) - 1) != null) {
            i--;
        }
    ...
    L_0x0003:
        r8 = kotlin.ranges.RangesKt.coerceAtLeast(r8, r0);
        r11 = new kotlin.ranges.IntRange;
        r0 = r6.length();
        r9 = kotlin.ranges.RangesKt.coerceAtMost(r9, r0);
        r11.<init>(r8, r9);
        r11 = (kotlin.ranges.IntProgression) r11;
        goto L_0x0027;
    L_0x0017:
        r11 = kotlin.text.StringsKt.getLastIndex(r6);
        r8 = kotlin.ranges.RangesKt.coerceAtMost(r8, r11);
        r9 = kotlin.ranges.RangesKt.coerceAtLeast(r9, r0);
        r11 = kotlin.ranges.RangesKt.downTo(r8, r9);
    L_0x0027:
    ...
    L_0x000a:
        ...
        r11 = kotlin.collections.CollectionsKt.single(r11);
    ...
    L_0x0014:
        ...
        r2 = r11;
        r3 = r12;
        r10 = kotlin.text.StringsKt.indexOf$default(r1, r2, r3, r4, r5, r6);
        goto L_0x0029;
    L_0x001f:
        r4 = 0;
        r5 = 4;
        ...
        r2 = r11;
        r3 = r12;
        r10 = kotlin.text.StringsKt.lastIndexOf$default(r1, r2, r3, r4, r5, r6);
    L_0x0029:
    ...
    L_0x0038:
        r12 = kotlin.ranges.RangesKt.coerceAtLeast(r12, r1);
        ...
        goto L_0x0054;
    L_0x0048:
        r14 = kotlin.text.StringsKt.getLastIndex(r10);
        r12 = kotlin.ranges.RangesKt.coerceAtMost(r12, r14);
        r14 = kotlin.ranges.RangesKt.downTo(r12, r1);
    L_0x0054:
    ...
    L_0x0078:
        ...
        r5 = r12;
        r7 = r13;
        r2 = kotlin.text.StringsKt.regionMatches(r2, r3, r4, r5, r6, r7);
    ...
    L_0x00c2:
        ...
        r5 = r12;
        r7 = r13;
        r2 = kotlin.text.StringsKt.regionMatchesImpl(r2, r3, r4, r5, r6, r7);
    ...
    public static final boolean contains(@NotNull CharSequence charSequence, @NotNull CharSequence charSequence2, boolean z) {
        ...
        if (charSequence2 instanceof String) {
            if (StringsKt.indexOf$default(charSequence, (String) charSequence2, 0, z, 2, null) < null) {
                return false;
            }
        }
    ...
    public static final boolean contains(@NotNull CharSequence charSequence, char c, boolean z) {
        Intrinsics.checkParameterIsNotNull(charSequence, "$receiver");
        return StringsKt.indexOf$default(charSequence, c, 0, z, 2, null) >= null ? true : null;
    }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, char[] cArr, int i, boolean z, int i2) {
        if ((i2 >= 0 ? 1 : null) != null) {
            return new DelimitedRangesSequence(charSequence, i, i2, new 2(cArr, z));
        }
    ...
    private static final Sequence<IntRange> rangesDelimitedBy$StringsKt__StringsKt(@NotNull CharSequence charSequence, String[] strArr, int i, boolean z, int i2) {
        if ((i2 >= 0 ? 1 : null) != null) {
            return new DelimitedRangesSequence(charSequence, i, i2, new 4(ArraysKt.asList(strArr), z));
        }
        charSequence = new StringBuilder();
        charSequence.append("Limit must be non-negative, but was ");
        charSequence.append(i2);
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull String[] strArr, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, strArr, 0, z, i, 2, null), (Function1) new 1(charSequence));
    }
...
*/
    ...
    L_0x0023:
        ...
        r8 = kotlin.sequences.SequencesKt.asIterable(r8);
        r9 = new java.util.ArrayList;
        r10 = 10;
        r10 = kotlin.collections.CollectionsKt.collectionSizeOrDefault(r8, r10);
        r9.<init>(r10);
    ...
    L_0x0049:
        ...
        r10 = kotlin.text.StringsKt.substring(r7, r10);
        r9.add(r10);
        goto L_0x0043;
    L_0x0057:
    ...
    public static final Sequence<String> splitToSequence(@NotNull CharSequence charSequence, @NotNull char[] cArr, boolean z, int i) {
        ...
        return SequencesKt.map(rangesDelimitedBy$StringsKt__StringsKt$default(charSequence, cArr, 0, z, i, 2, null), (Function1) new 2(charSequence));
    }
...
*/
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence, @NotNull char... cArr) {
        ...
        int i2 = 0;
        while (i <= length) {
            boolean contains = ArraysKt.contains(cArr, charSequence.charAt(i2 == 0 ? i : length));
            if (i2 == 0) {
                if (contains) {
                    i++;
                } else {
    ...
    public static final CharSequence trim(@NotNull CharSequence charSequence) {
        ...
        int i2 = 0;
        while (i <= length) {
            boolean isWhitespace = CharsKt.isWhitespace(charSequence.charAt(i2 == 0 ? i : length));
            if (i2 == 0) {
                if (isWhitespace) {
                    i++;
                } else {
