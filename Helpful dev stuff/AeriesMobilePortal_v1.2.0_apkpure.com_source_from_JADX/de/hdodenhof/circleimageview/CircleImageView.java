...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mBorderWidth = 0;
        this.mFillColor = 0;
        context = context.obtainStyledAttributes(attributeSet, C0498R.styleable.CircleImageView, i, 0);
        this.mBorderWidth = context.getDimensionPixelSize(C0498R.styleable.CircleImageView_civ_border_width, 0);
        this.mBorderColor = context.getColor(C0498R.styleable.CircleImageView_civ_border_color, -16777216);
        this.mBorderOverlay = context.getBoolean(C0498R.styleable.CircleImageView_civ_border_overlay, false);
        this.mFillColor = context.getColor(C0498R.styleable.CircleImageView_civ_fill_color, 0);
        context.recycle();
        init();
    }
