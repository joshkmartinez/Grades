...
public final class SparseArraySequence<T> implements Sequence<T> {
    private final SparseArray<T> f370a;
    ...
    private final class SparseArrayIterator implements Iterator<T>, KMappedMarker {
        ...
        public SparseArrayIterator() {
            this.size = SparseArraySequence.this.f370a.size();
        }
        ...
        public T next() {
            if (SparseArraySequence.this.f370a.size() == this.size) {
                SparseArray access$getA$p = SparseArraySequence.this.f370a;
                int i = this.index;
                this.index = i + 1;
