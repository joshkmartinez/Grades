...
public final class SparseIntArraySequence implements Sequence<Integer> {
    private final SparseIntArray f372a;
    ...
    private final class SparseIntArrayIterator implements Iterator<Integer>, KMappedMarker {
        ...
        public SparseIntArrayIterator() {
            this.size = SparseIntArraySequence.this.f372a.size();
        }
        ...
        @NotNull
        public Integer next() {
            if (SparseIntArraySequence.this.f372a.size() == this.size) {
                SparseIntArray access$getA$p = SparseIntArraySequence.this.f372a;
                int i = this.index;
                this.index = i + 1;
