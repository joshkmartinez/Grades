...
public final class __AbsListView_OnScrollListener implements OnScrollListener {
    ...
    public void onScrollStateChanged(@Nullable AbsListView absListView, int i) {
        ...
        if (function4 != null) {
            BuildersKt.launch$default(this.context, null, new __AbsListView_OnScrollListener$onScrollStateChanged$1(function4, absListView, i, null), 2, null);
        }
    }
    ...
    public void onScroll(@Nullable AbsListView absListView, int i, int i2, int i3) {
        ...
        if (function6 != null) {
            BuildersKt.launch$default(this.context, null, new __AbsListView_OnScrollListener$onScroll$1(function6, absListView, i, i2, i3, null), 2, null);
        }
    }
