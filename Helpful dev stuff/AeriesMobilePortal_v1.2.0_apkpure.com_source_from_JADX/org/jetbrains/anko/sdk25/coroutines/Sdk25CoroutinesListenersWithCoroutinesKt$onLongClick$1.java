...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onLongClick$1 implements OnLongClickListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function3 $handler;
    final /* synthetic */ boolean $returnValue;

    Sdk25CoroutinesListenersWithCoroutinesKt$onLongClick$1(CoroutineContext coroutineContext, Function3 function3, boolean z) {
    ...
    public final boolean onLongClick(final View view) {
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11381 = /* anonymous class already generated */;
                c11381.p$ = coroutineScope;
                return c11381;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11381) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
