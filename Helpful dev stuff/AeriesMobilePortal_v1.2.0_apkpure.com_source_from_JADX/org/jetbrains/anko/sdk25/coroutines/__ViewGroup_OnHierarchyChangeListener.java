...
public final class __ViewGroup_OnHierarchyChangeListener implements OnHierarchyChangeListener {
    ...
    public void onChildViewAdded(@Nullable View view, @Nullable View view2) {
        ...
        if (function4 != null) {
            BuildersKt.launch$default(this.context, null, new __ViewGroup_OnHierarchyChangeListener$onChildViewAdded$1(function4, view, view2, null), 2, null);
        }
    }
    ...
    public void onChildViewRemoved(@Nullable View view, @Nullable View view2) {
        ...
        if (function4 != null) {
            BuildersKt.launch$default(this.context, null, new __ViewGroup_OnHierarchyChangeListener$onChildViewRemoved$1(function4, view, view2, null), 2, null);
        }
    }
