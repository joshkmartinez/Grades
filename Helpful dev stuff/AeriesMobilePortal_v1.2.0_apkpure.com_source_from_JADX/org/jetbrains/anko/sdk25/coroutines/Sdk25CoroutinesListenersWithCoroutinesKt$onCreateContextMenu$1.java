...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onCreateContextMenu$1 implements OnCreateContextMenuListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function5 $handler;

    Sdk25CoroutinesListenersWithCoroutinesKt$onCreateContextMenu$1(CoroutineContext coroutineContext, Function5 function5) {
        this.$context = coroutineContext;
        this.$handler = function5;
    }

    public final void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenuInfo contextMenuInfo) {
        final Sdk25CoroutinesListenersWithCoroutinesKt$onCreateContextMenu$1 sdk25CoroutinesListenersWithCoroutinesKt$onCreateContextMenu$1 = this;
        ...
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11201 = /* anonymous class already generated */;
                c11201.p$ = coroutineScope;
                return c11201;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11201) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            Function5 function5 = sdk25CoroutinesListenersWithCoroutinesKt$onCreateContextMenu$1.$handler;
