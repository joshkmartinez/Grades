...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onItemLongClick$1 implements OnItemLongClickListener {
    ...
    public final boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long j) {
        final Sdk25CoroutinesListenersWithCoroutinesKt$onItemLongClick$1 sdk25CoroutinesListenersWithCoroutinesKt$onItemLongClick$1 = this;
        ...
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11351 = /* anonymous class already generated */;
                c11351.p$ = coroutineScope;
                return c11351;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11351) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            Function6 function6 = sdk25CoroutinesListenersWithCoroutinesKt$onItemLongClick$1.$handler;
