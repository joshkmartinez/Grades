...
public final class __GestureOverlayView_OnGesturingListener implements OnGesturingListener {
    ...
    public void onGesturingStarted(@Nullable GestureOverlayView gestureOverlayView) {
        ...
        if (function3 != null) {
            BuildersKt.launch$default(this.context, null, new __GestureOverlayView_OnGesturingListener$onGesturingStarted$1(function3, gestureOverlayView, null), 2, null);
        }
    }
    ...
    public void onGesturingEnded(@Nullable GestureOverlayView gestureOverlayView) {
        ...
        if (function3 != null) {
            BuildersKt.launch$default(this.context, null, new __GestureOverlayView_OnGesturingListener$onGesturingEnded$1(function3, gestureOverlayView, null), 2, null);
        }
    }
