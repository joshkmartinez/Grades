...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onCheckedChange$2 implements OnCheckedChangeListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function4 $handler;

    Sdk25CoroutinesListenersWithCoroutinesKt$onCheckedChange$2(CoroutineContext coroutineContext, Function4 function4) {
    ...
    public final void onCheckedChanged(final RadioGroup radioGroup, final int i) {
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11141 = /* anonymous class already generated */;
                c11141.p$ = coroutineScope;
                return c11141;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11141) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            this.label = 1;
                            if (function4.invoke(th, radioGroup, valueOf, this) == coroutine_suspended) {
