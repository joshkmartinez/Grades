...
final class __TextWatcher$afterTextChanged$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Continuation org_jetbrains_anko_sdk25_coroutines___TextWatcher_afterTextChanged_1 = new __TextWatcher$afterTextChanged$1(this.$handler, this.$s, continuation);
        org_jetbrains_anko_sdk25_coroutines___TextWatcher_afterTextChanged_1.p$ = coroutineScope;
        return org_jetbrains_anko_sdk25_coroutines___TextWatcher_afterTextChanged_1;
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__TextWatcher$afterTextChanged$1) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
    }
        ...
        switch (this.label) {
            case 0:
                if (th == null) {
                    ...
                    this.label = 1;
                    if (function3.invoke(th, editable, this) == coroutine_suspended) {
