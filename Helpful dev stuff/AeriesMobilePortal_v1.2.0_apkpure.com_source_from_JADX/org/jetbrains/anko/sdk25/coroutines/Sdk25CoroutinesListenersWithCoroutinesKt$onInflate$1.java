...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onInflate$1 implements OnInflateListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function4 $handler;

    Sdk25CoroutinesListenersWithCoroutinesKt$onInflate$1(CoroutineContext coroutineContext, Function4 function4) {
    ...
    public final void onInflate(final ViewStub viewStub, final View view) {
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11321 = /* anonymous class already generated */;
                c11321.p$ = coroutineScope;
                return c11321;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11321) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            View view = view;
                            this.label = 1;
                            if (function4.invoke(th, viewStub, view, this) == coroutine_suspended) {
