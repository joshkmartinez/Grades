...
final class __GestureOverlayView_OnGestureListener$onGestureStarted$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Continuation org_jetbrains_anko_sdk25_coroutines___GestureOverlayView_OnGestureListener_onGestureStarted_1 = new __GestureOverlayView_OnGestureListener$onGestureStarted$1(this.$handler, this.$overlay, this.$event, continuation);
        org_jetbrains_anko_sdk25_coroutines___GestureOverlayView_OnGestureListener_onGestureStarted_1.p$ = coroutineScope;
        return org_jetbrains_anko_sdk25_coroutines___GestureOverlayView_OnGestureListener_onGestureStarted_1;
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__GestureOverlayView_OnGestureListener$onGestureStarted$1) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
    }
