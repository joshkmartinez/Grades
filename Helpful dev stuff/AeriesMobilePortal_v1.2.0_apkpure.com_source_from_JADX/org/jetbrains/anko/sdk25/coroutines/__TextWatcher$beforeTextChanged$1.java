...
final class __TextWatcher$beforeTextChanged$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Continuation org_jetbrains_anko_sdk25_coroutines___TextWatcher_beforeTextChanged_1 = new __TextWatcher$beforeTextChanged$1(this.$handler, this.$s, this.$start, this.$count, this.$after, continuation);
        org_jetbrains_anko_sdk25_coroutines___TextWatcher_beforeTextChanged_1.p$ = coroutineScope;
        return org_jetbrains_anko_sdk25_coroutines___TextWatcher_beforeTextChanged_1;
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__TextWatcher$beforeTextChanged$1) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
    }
        ...
        switch (this.label) {
            case 0:
                if (th == null) {
                    ...
                    Integer valueOf3 = Integer.valueOf(this.$after);
                    this.label = 1;
