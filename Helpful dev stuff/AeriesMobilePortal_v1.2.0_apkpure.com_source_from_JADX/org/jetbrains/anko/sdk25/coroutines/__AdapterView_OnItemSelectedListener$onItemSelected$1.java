...
final class __AdapterView_OnItemSelectedListener$onItemSelected$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Continuation org_jetbrains_anko_sdk25_coroutines___AdapterView_OnItemSelectedListener_onItemSelected_1 = new __AdapterView_OnItemSelectedListener$onItemSelected$1(this.$handler, this.$p0, this.$p1, this.$p2, this.$p3, continuation);
        org_jetbrains_anko_sdk25_coroutines___AdapterView_OnItemSelectedListener_onItemSelected_1.p$ = coroutineScope;
        return org_jetbrains_anko_sdk25_coroutines___AdapterView_OnItemSelectedListener_onItemSelected_1;
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__AdapterView_OnItemSelectedListener$onItemSelected$1) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
    }
