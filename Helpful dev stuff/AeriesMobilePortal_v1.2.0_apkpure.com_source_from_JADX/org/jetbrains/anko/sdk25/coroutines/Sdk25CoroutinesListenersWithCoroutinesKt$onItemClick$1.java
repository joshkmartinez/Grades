...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onItemClick$1 implements OnItemClickListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function6 $handler;

    Sdk25CoroutinesListenersWithCoroutinesKt$onItemClick$1(CoroutineContext coroutineContext, Function6 function6) {
        this.$context = coroutineContext;
        this.$handler = function6;
    }

    public final void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
        final Sdk25CoroutinesListenersWithCoroutinesKt$onItemClick$1 sdk25CoroutinesListenersWithCoroutinesKt$onItemClick$1 = this;
        ...
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11341 = /* anonymous class already generated */;
                c11341.p$ = coroutineScope;
                return c11341;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11341) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            Function6 function6 = sdk25CoroutinesListenersWithCoroutinesKt$onItemClick$1.$handler;
