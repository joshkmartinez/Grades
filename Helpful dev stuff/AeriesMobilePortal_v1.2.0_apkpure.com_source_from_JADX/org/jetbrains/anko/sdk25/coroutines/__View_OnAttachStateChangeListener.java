...
public final class __View_OnAttachStateChangeListener implements OnAttachStateChangeListener {
    ...
    public void onViewAttachedToWindow(@NotNull View view) {
        ...
        if (function3 != null) {
            BuildersKt.launch$default(this.context, null, new __View_OnAttachStateChangeListener$onViewAttachedToWindow$1(function3, view, null), 2, null);
        }
    }
    ...
    public void onViewDetachedFromWindow(@NotNull View view) {
        ...
        if (function3 != null) {
            BuildersKt.launch$default(this.context, null, new __View_OnAttachStateChangeListener$onViewDetachedFromWindow$1(function3, view, null), 2, null);
        }
    }
