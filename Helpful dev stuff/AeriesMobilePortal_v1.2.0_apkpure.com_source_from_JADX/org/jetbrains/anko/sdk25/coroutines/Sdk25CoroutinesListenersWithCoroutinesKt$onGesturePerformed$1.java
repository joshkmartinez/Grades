...
final class Sdk25CoroutinesListenersWithCoroutinesKt$onGesturePerformed$1 implements OnGesturePerformedListener {
    final /* synthetic */ CoroutineContext $context;
    final /* synthetic */ Function4 $handler;

    Sdk25CoroutinesListenersWithCoroutinesKt$onGesturePerformed$1(CoroutineContext coroutineContext, Function4 function4) {
    ...
    public final void onGesturePerformed(final GestureOverlayView gestureOverlayView, final Gesture gesture) {
        BuildersKt.launch$default(this.$context, null, new Function2<CoroutineScope, Continuation<? super Unit>, Object>(null) {
            ...
            public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                ...
                Continuation c11271 = /* anonymous class already generated */;
                c11271.p$ = coroutineScope;
                return c11271;
            }
            ...
            public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
                Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
                Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
                return ((C11271) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
            }
                ...
                switch (this.label) {
                    case 0:
                        if (th == null) {
                            ...
                            this.label = 1;
                            if (function4.invoke(th, gestureOverlayView, gesture, this) == coroutine_suspended) {
