...
final class __SearchView_OnQueryTextListener$onQueryTextSubmit$1 extends CoroutineImpl implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Continuation<Unit> create(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Continuation org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnQueryTextListener_onQueryTextSubmit_1 = new __SearchView_OnQueryTextListener$onQueryTextSubmit$1(this.$handler, this.$query, continuation);
        org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnQueryTextListener_onQueryTextSubmit_1.p$ = coroutineScope;
        return org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnQueryTextListener_onQueryTextSubmit_1;
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @NotNull Continuation<? super Unit> continuation) {
        Intrinsics.checkParameterIsNotNull(coroutineScope, "$receiver");
        Intrinsics.checkParameterIsNotNull(continuation, "$continuation");
        return ((__SearchView_OnQueryTextListener$onQueryTextSubmit$1) create(coroutineScope, (Continuation) continuation)).doResume(Unit.INSTANCE, null);
    }
