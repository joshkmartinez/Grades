...
public final class __SearchView_OnSuggestionListener implements OnSuggestionListener {
    ...
    public static /* bridge */ /* synthetic */ void onSuggestionSelect$default(__SearchView_OnSuggestionListener org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnSuggestionListener, boolean z, Function3 function3, int i, Object obj) {
        if ((i & 1) != 0) {
            z = false;
        }
        org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnSuggestionListener.onSuggestionSelect(z, function3);
    }
    ...
    public static /* bridge */ /* synthetic */ void onSuggestionClick$default(__SearchView_OnSuggestionListener org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnSuggestionListener, boolean z, Function3 function3, int i, Object obj) {
        if ((i & 1) != 0) {
            z = false;
        }
        org_jetbrains_anko_appcompat_v7_coroutines___SearchView_OnSuggestionListener.onSuggestionClick(z, function3);
    }
